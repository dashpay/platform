...
describe('Identities', function () {
  ...
  it.skip('creditTransfer() executes when secrets provided (skipped by default)', async function () {
    if (!TEST_SECRETS.identityId || !TEST_SECRETS.privateKeyWif) this.skip();
