...
use crate::version::drive_versions::{
    ...
    DriveCreditPoolStorageFeeDistributionPoolMethodVersions, DriveDataContractOperationsVersion,
    ...
    DriveOperationsVersion, DrivePlatformSystemMethodVersions, DriveProtocolUpgradeVersions,
    DriveProveMethodVersions, DriveStructureVersion, DriveSystemEstimationCostsMethodVersions,
...
pub(super) const PLATFORM_V1: PlatformVersion = PlatformVersion {
    ...
    drive: DriveVersion {
        ...
        operations: DriveOperationsVersion {
            finalization_tasks: 0,
            contracts: DriveDataContractOperationsVersion {
                finalization_tasks: 0,
            },
        },
    },
