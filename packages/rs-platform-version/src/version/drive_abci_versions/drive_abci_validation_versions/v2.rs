...
pub const DRIVE_ABCI_VALIDATION_VERSIONS_V2: DriveAbciValidationVersions =
    DriveAbciValidationVersions {
        state_transitions: DriveAbciStateTransitionValidationVersions {
            ...
            identity_create_from_addresses_state_transition: DriveAbciStateTransitionValidationVersion {
                basic_structure: Some(0),
                advanced_structure: None,
                identity_signatures: Some(0),
                advanced_minimum_balance_pre_check: None,
            ...
            identity_top_up_from_addresses_state_transition: DriveAbciStateTransitionValidationVersion {
                basic_structure: Some(0),
                advanced_structure: None,
                identity_signatures: None,
                advanced_minimum_balance_pre_check: None,
