    ...
    DriveAbciValidationVersions {
        state_transitions: DriveAbciStateTransitionValidationVersions {
            ...
            batch_state_transition: DriveAbciDocumentsStateTransitionValidationVersions {
                ...
                // PROTOCOL_VERSION_12 (v3.1 hard fork): structure validator
                // now rejects deletes against `documentsKeepHistory: true`
                // doctypes as invalid (paid) consensus errors. Pre-v12 the
                // delete reached `force_delete_document_for_contract_operations_v0`,
                ...
                // invalid-paid). Gated here so PROTOCOL_VERSION_11 chain
                // history stays bit-for-bit reproducible. See issue #3927.
