...
// Fix for validate_identity_public_key_contract_bounds where DECRYPTION case was incorrectly
// calling requires_identity_encryption_bounded_key() instead of requires_identity_decryption_bounded_key()
    ...
    DriveAbciValidationVersions {
        state_transitions: DriveAbciStateTransitionValidationVersions {
            common_validation_methods: DriveAbciStateTransitionCommonValidationVersions {
                ...
                validate_identity_public_key_contract_bounds: 1, // Changed from 0 to 1 to fix decryption bounded key bug
