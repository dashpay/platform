...
/// Drive ABCI method versions 11. Introduced in protocol v15 with token shielded pools: turns
/// on `record_token_shielded_pool_anchors` (`Some(0)`), the block-end step that records and
/// prunes the anchors of every token pool the block touched.
