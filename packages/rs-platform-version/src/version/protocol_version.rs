...
use crate::version::dashvm_versions::DashVmVersion;
...
pub struct PlatformVersion {
    ...
    /// The DashVM table: engine profile, preparation and metering generations, limits and
    /// weights. `None` on every protocol version that predates smart contracts.
