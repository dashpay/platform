...
// There were no fees for these things before Protocol version 9 (version 2.0)
pub const FEE_DATA_CONTRACT_REGISTRATION_VERSION1: FeeDataContractRegistrationVersion =
