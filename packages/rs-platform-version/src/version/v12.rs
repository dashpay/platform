...
/// This version fixes validate_identity_public_key_contract_bounds for DECRYPTION case
/// where it was incorrectly calling requires_identity_encryption_bounded_key()
/// instead of requires_identity_decryption_bounded_key()
pub const PLATFORM_V12: PlatformVersion = PlatformVersion {
    ...
    drive_abci: DriveAbciVersion {
        ...
        validation_and_processing: DRIVE_ABCI_VALIDATION_VERSIONS_V8, // Changed to V8 for validate_identity_public_key_contract_bounds fix
