...
/// Drive version 10.
/// Introduced in protocol v15, carrying the delta-based data contract update:
///
/// * `prove.prove_state_transition` 0 -> 1: a delta-based (V1) update embeds
///   no contract, so generation 1 reads the stored contract to learn whether
///   it keeps history before choosing the contract proof layout.
/// * `verify: DRIVE_VERIFY_METHOD_VERSIONS_V3`, whose
///   `verify_state_transition_was_executed_with_proof` generation 1
///   materializes the delta on the pre-update contract the known-contracts
///   provider supplies and compares the whole result with the proven
///   contract.
///
...
pub const DRIVE_VERSION_V10: DriveVersion = DriveVersion {
    ...
    methods: DriveMethodVersions {
        ...
        prove: DriveProveMethodVersions {
            ...
            prove_state_transition: 1, // changed in v10: a delta-based contract update reads the stored contract for the proof layout
        },
        ...
        document: DRIVE_DOCUMENT_METHOD_VERSIONS_V4,
        vote: DRIVE_VOTE_METHOD_VERSIONS_V2,
        contract: DRIVE_CONTRACT_METHOD_VERSIONS_V4,
        ...
        verify: DRIVE_VERIFY_METHOD_VERSIONS_V3, // changed in v10: execution-proof verification of a delta-based contract update
        identity: DRIVE_IDENTITY_METHOD_VERSIONS_V2,
