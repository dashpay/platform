use crate::version::drive_versions::drive_credit_pool_method_versions::{DriveCreditPoolEpochsMethodVersions, DriveCreditPoolMethodVersions, DriveCreditPoolPendingEpochRefundsMethodVersions, DriveCreditPoolStorageFeeDistributionPoolMethodVersions, DriveCreditPoolUnpaidEpochMethodVersions};

pub const CREDIT_POOL_METHOD_VERSIONS_V1: DriveCreditPoolMethodVersions = DriveCreditPoolMethodVersions {
