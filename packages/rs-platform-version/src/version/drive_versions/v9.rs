...
pub const DRIVE_VERSION_V9: DriveVersion = DriveVersion {
    ...
    methods: DriveMethodVersions {
        ...
        batch_operations: DriveBatchOperationsMethodVersion {
            ...
            apply_drive_operations: 1, // changed: a batch carrying a storage refund forfeiture (a moderator's document deletion) refunds nobody; every write of one identity balance or fee pot in a batch is merged into one
        },
