...
/// Keep-history document types store their revisions in a per-type history
/// tree; everything else matches `DRIVE_STRUCTURE_V1`.
pub const DRIVE_STRUCTURE_V2: DriveStructureVersion = DriveStructureVersion {
