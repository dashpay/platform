...
pub const DRIVE_GROVE_METHOD_VERSIONS_V1: DriveGroveMethodVersions = DriveGroveMethodVersions {
    ...
    batch: DriveGroveBatchMethodVersions {
        ...
        batch_insert_empty_provable_count_indexed_tree: 0,
        batch_insert_empty_provable_sum_indexed_tree: 0,
        batch_insert_empty_provable_count_provable_sum_indexed_tree: 0,
        batch_move: 0,
