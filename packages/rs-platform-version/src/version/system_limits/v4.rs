...
///   `maxItems`, at most 1024 elements (`max_document_array_items`, backfilled into the
...
pub const SYSTEM_LIMITS_V4: SystemLimits = SystemLimits {
    ...
    max_document_array_items: 1024, // typed array properties (new in v14): full validation requires maxItems and caps it here
