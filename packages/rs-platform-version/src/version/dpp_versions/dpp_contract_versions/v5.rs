...
// Introduced in protocol version 13. Uses the v2 document meta-schema, which
// accepts the keepsTransferHistory, keepsPurchaseHistory and
// keepsPricingHistory document type configuration flags. v4 (meta-schema v1)
// remains for protocol version 12 so pre-activation validation is unchanged.
pub const CONTRACT_VERSIONS_V5: DPPContractVersions = DPPContractVersions {
    ...
    document_type_versions: DocumentTypeVersions {
        ...
        schema: DocumentTypeSchemaVersions {
            document_type_schema: 2, // changed: v2 document meta-schema accepts the keeps*History flags
