...
pub const CONTRACT_VERSIONS_V6: DPPContractVersions = DPPContractVersions {
    ...
    document_type_versions: DocumentTypeVersions {
        ...
        schema: DocumentTypeSchemaVersions {
            ...
            apply_property_reference: Some(1), // changed: the meta-schema v3 `refersTo` keyword is folded into the parsed property type (generation 1 also parses the owner gate on contract references); None before this version means the keyword is ignored, as it was before it existed
