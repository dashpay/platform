//! V3 (PV14): identical to V2 except `document_delete_state_transition`
//! admits max_version 1 — the indexOnly delete-by-values variant
//! (`DocumentDeleteTransitionV1`). The default stays 0: stored document
//! types keep producing V0 deletes, and only indexOnly flows opt into V1.
