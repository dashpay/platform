...
use crate::version::dpp_versions::dpp_state_transition_serialization_versions::{DocumentFeatureVersionBounds, DPPStateTransitionSerializationVersions};

pub const STATE_TRANSITION_SERIALIZATION_VERSIONS_V1: DPPStateTransitionSerializationVersions = DPPStateTransitionSerializationVersions {
