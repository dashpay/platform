...
/// (`SystemLimits::daily_withdrawal_limit_percent`). `shielded_extra_sighash_data` 0 → 1
/// binds contract-scoped authentication keys in shielded identity creation. Everything else matches V2.
