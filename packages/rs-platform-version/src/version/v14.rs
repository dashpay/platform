...
pub const PLATFORM_V14: PlatformVersion = PlatformVersion {
    ...
    drive_abci: DriveAbciVersion {
        ...
        methods: DRIVE_ABCI_METHOD_VERSIONS_V10, // changed: process_raw_state_transitions v1 — per-transition savepoint; dropped transitions no longer leak writes into the app hash
