...
///
/// 25. **Typed scalar arrays in document schemas**: an array property may be
///     declared by an `items` schema instead of `byteArray: true` (meta-schema
///     v3, `parse_typed_array` 0, `DocumentPropertyType::TypedArray`): a list
