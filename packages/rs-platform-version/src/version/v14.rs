...
///
/// 18. **Document deletion by moderators**: a document type of a contract
...
///     history, is indexOnly or restricts creation, and never the target of a
///     permanentDocument reference). A moderation declaration may then keep
