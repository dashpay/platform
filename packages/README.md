...
| Package | Version | Description |
|---------|---------|-------------|
| [`dash`](/packages/js-dash-sdk-original) | [![npm](https://img.shields.io/npm/v/dash.svg?maxAge=3600)](https://www.npmjs.com/package/dash) | JavaScript SDK and light client (original) |
