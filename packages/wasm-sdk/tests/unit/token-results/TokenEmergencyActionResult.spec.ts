...
describe('TokenEmergencyActionResult', () => {
  ...
  describe('toObject()', () => {
    ...
    it('should produce output matching expected Object fixture', () => {
      const result = sdk.TokenEmergencyActionResult.fromObject(expectedObject);
      const obj = result.toObject();
  ...
  describe('fromJSON()', () => {
    ...
    it('should create from JSON fixture and verify all fields via getters', () => {
      const result = sdk.TokenEmergencyActionResult.fromJSON(expectedJSON);
  ...
  describe('document serialization', () => {
    ...
    it('should round-trip document through toJSON/fromJSON', () => {
      ...
      const result = sdk.TokenEmergencyActionResult.fromJSON(data);
      const json = result.toJSON();
      const restored = sdk.TokenEmergencyActionResult.fromJSON(json);
    ...
    it('should round-trip document through toObject/fromObject', () => {
      ...
      const result = sdk.TokenEmergencyActionResult.fromJSON(data);
      const obj = result.toObject();
      const restored = sdk.TokenEmergencyActionResult.fromObject(obj);
