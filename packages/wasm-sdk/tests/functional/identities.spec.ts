...
describe('Identities', function describeIdentities() {
  ...
  describe('getIdentityWithProofInfo()', () => {
  ...
  describe('getIdentityContractNonce()', () => {
    it('should get contract nonce', async () => {
  ...
  describe('getIdentityBalanceAndRevision()', () => {
    it('should get identity balance and revision', async () => {
  ...
  describe('getIdentitiesContractKeysWithProofInfo()', () => {
  ...
  describe('getIdentityTokenBalances()', () => {
    it('should get token balances for identity', async () => {
  ...
  describe('getIdentitiesTokenBalances()', () => {
    it('should get token balances for multiple identities', async () => {
      const TOKEN_CONTRACT = tokenContracts[0].contractId;
      const tokenId = sdk.WasmSdk.calculateTokenIdFromContract(TOKEN_CONTRACT, 1);
  ...
  describe('getIdentityTokenInfos()', () => {
    it('should get token infos for identity', async () => {
      const TOKEN_CONTRACT = tokenContracts[0].contractId;
      const tokenId = sdk.WasmSdk.calculateTokenIdFromContract(TOKEN_CONTRACT, 1);
  ...
  describe('getIdentitiesTokenInfos()', () => {
    it('should get token infos for multiple identities', async () => {
