...
describe('Platform Address Queries', function describePlatformAddressQueries() {
  ...
  describe('getAddressInfo()', () => {
    it('should return address info for funded address', async () => {
  ...
  describe('getAddressInfoWithProofInfo()', () => {
    it('should return proof info for address query', async () => {
      const testAddress = sdk.PlatformAddress.fromP2pkhHash(testHash1);
  ...
  describe('getAddressesInfos()', () => {
    it('should return map of address infos', async () => {
  ...
  describe('getAddressesInfosWithProofInfo()', () => {
    it('should return proof info for multiple addresses', async () => {
      const testAddress1 = sdk.PlatformAddress.fromP2pkhHash(testHash1);
      const testAddress2 = sdk.PlatformAddress.fromP2shHash(testHash2);
      const testAddresses = [testAddress1, testAddress2];
