...
async fn test_batch_optimizer() {
    ...
    assert_eq!(
        js_sys::Reflect::get(&boundaries, &"start".into())
            .unwrap()
            .as_f64()
            .unwrap(),
        0.0
    ...
    assert_eq!(
        js_sys::Reflect::get(&boundaries, &"end".into())
            .unwrap()
            .as_f64()
            .unwrap(),
        25.0
    ...
    assert_eq!(
        js_sys::Reflect::get(&boundaries, &"size".into())
            .unwrap()
            .as_f64()
            .unwrap(),
        25.0
    ...
    assert_eq!(
        js_sys::Reflect::get(&last_batch, &"start".into())
            .unwrap()
            .as_f64()
            .unwrap(),
        75.0
    ...
    assert_eq!(
        js_sys::Reflect::get(&last_batch, &"end".into())
            .unwrap()
            .as_f64()
            .unwrap(),
        100.0
...
async fn test_optimization_recommendations() {
    ...
    assert!(recommendations_str
        .iter()
        .any(|r| r.contains("FeatureFlags")));
    assert!(recommendations_str
        .iter()
