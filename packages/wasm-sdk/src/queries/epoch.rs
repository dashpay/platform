...
impl WasmSdk {
    ...
    pub async fn get_finalized_epoch_infos_with_proof_info(
        ...
        let (epochs_result, metadata, proof) = dash_sdk::dpp::block::finalized_epoch_info::FinalizedEpochInfo::fetch_many_with_metadata_and_proof(
                self.as_ref(),
                query,
                None,
            )
    ...
    pub async fn get_evonodes_proposed_epoch_blocks_by_ids_with_proof_info(
        ...
        let _ = (self, epoch, pro_tx_hashes);
