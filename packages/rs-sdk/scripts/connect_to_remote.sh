...
echo -n Reading configuration from remote "$REMOTE" using \`dashmate config get\` command, this will take some time...
...
ssh -L "12367:127.0.0.1:${CORE_PORT}" "$REMOTE" -N ${SSH_ARGS}
