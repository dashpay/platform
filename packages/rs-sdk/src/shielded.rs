//! Shielded note trial decryption utilities.
//!
//! This module provides helpers for performing compact trial decryption on
//! [`ShieldedEncryptedNote`] structs returned by the platform query layer.
//!
//! The [`try_decrypt_note`] function is the primary entry point. It takes a
//! prepared incoming viewing key and a proof-verified encrypted note, and
//! returns the decrypted [`Note`] and recipient [`PaymentAddress`] if the
//! note belongs to the viewer.
