...
impl Default for TestConfig {
    fn default() -> Self {
        let contract = data_contracts::SystemDataContract::DPNS;
        let src = contract.source().expect("data contract source");

        Self {
            existing_identity_id: src.owner_id_bytes.into(),
            existing_data_contract_id: contract.id(),
            existing_document_type_name: "domain".to_string(),
            existing_document_id: DPNS_DASH_TLD_DOCUMENT_ID.into(),
        }
    }
}
