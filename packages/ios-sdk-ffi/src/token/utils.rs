...
use super::types::IOSSDKTokenDistributionType;
use crate::types::{IOSSDKPutSettings, IOSSDKStateTransitionCreationOptions};
...
pub fn convert_token_distribution_type(
    ffi_type: IOSSDKTokenDistributionType,
...
pub unsafe fn extract_user_fee_increase(put_settings: *const IOSSDKPutSettings) -> UserFeeIncrease {
