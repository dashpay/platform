...
#[no_mangle]
pub unsafe extern "C" fn ios_sdk_signer_create(
    sign_callback: IOSSignCallback,
    can_sign_callback: IOSCanSignCallback,
) -> *mut SignerHandle {
...
#[no_mangle]
pub unsafe extern "C" fn ios_sdk_signer_destroy(handle: *mut SignerHandle) {
    if !handle.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn ios_sdk_bytes_free(bytes: *mut u8) {
    if !bytes.is_null() {
