...
function setupRegularPresetTaskFactory(
  ...
  function setupRegularPresetTask() {
    ...
    Evolution fullnode          - Fullnode features, plus host a full copy of the 
                                  Platform blockchain (no collateral)
    Evolution masternode        - Masternode features, plus Platform services such as
                                  DAPI and Drive (4000 DASH collateral)\n`,
