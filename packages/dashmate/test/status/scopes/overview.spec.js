...
describe('determineStatus', () => {
  ...
  beforeEach(async () => {
    mockRpcClient = {mnsync: sinon.stub(), getBlockchainInfo: sinon.stub(), getNetworkInfo: sinon.stub()}
  ...
  it('should not retrieve masternode and platform data', async () => {
    ...
    mockRpcClient.getBlockchainInfo.returns({result: {size_on_disk: 1337, verificationprogress: 1}})
