...
import { selectDebBaseline, releaseLine } from '../../../scripts/deb-release-baseline.mjs';

const SCRIPT_PATH = fileURLToPath(new URL('../../../scripts/deb-release-baseline.mjs', import.meta.url));
...
describe('deb-release-baseline.mjs', () => {
