...
/// The latest embedded migration sets the supported schema version. V004
/// (`drop_undecodable_asset_locks`, #4133) lifted it from 3 to 4.
#[test]
...
#[test]
fn tc_b_030_fresh_store_migrates_to_version_four() {
