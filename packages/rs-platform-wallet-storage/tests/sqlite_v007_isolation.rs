...
//! Cross-wallet isolation + delete cascade for the new V007 tables
...
//! deleting one must leave the other's V007 rows intact.
...
/// collision, and deleting wallet A cascades away only A's V007 rows while
/// wallet B's survive intact.
#[test]
fn tc_b_006_v007_tables_isolate_and_cascade_per_wallet() {
