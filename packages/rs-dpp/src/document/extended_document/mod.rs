...
mod test {
    ...
    fn test_document_json_deserialize() -> Result<()> {
        ...
        println!(
            "{:?}",
            doc.properties()
                .get_at_path("records.dashIdentityId")
