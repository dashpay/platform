...
impl ErrorWithCode for BasicError {
    fn code(&self) -> u32 {
        match self {
            ...
            Self::FeeStrategyReduceWithdrawalNotLastError(_) => 10613,
            Self::InputBelowMinimumError(_) => 10614,
            Self::OutputBelowMinimumError(_) => 10615,
            Self::InputOutputBalanceMismatchError(_) => 10616,
            Self::OutputsNotGreaterThanInputsError(_) => 10617,
