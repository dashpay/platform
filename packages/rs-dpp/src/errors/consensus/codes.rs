...
impl ErrorWithCode for BasicError {
    fn code(&self) -> u32 {
        match self {
            ...
            Self::InvalidIdentityPublicKeySecurityLevelError(_) => 10518,
            Self::InvalidIdentityKeySignatureError { .. } => 10519,
            Self::InvalidIdentityCreditWithdrawalTransitionOutputScriptError(_) => 10520,
            Self::InvalidIdentityCreditWithdrawalTransitionCoreFeeError(_) => 10521,
            Self::NotImplementedIdentityCreditWithdrawalTransitionPoolingError(_) => 10522,
            Self::InvalidIdentityCreditTransferAmountError(_) => 10523,
            Self::InvalidIdentityCreditWithdrawalTransitionAmountError(_) => 10524,
            Self::InvalidIdentityUpdateTransitionEmptyError(_) => 10525,
            Self::InvalidIdentityUpdateTransitionDisableKeysError(_) => 10526,
            Self::IdentityCreditTransferToSelfError(_) => 10527,
            Self::MasterPublicKeyUpdateError(_) => 10528,
