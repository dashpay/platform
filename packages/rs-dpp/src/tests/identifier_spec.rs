...
pub fn from_string() {
    ...
    let buffer_id: [u8; 32] = [
        196, 72, 90, 197, 121, 84, 125, 235, 40, 10, 91, 100, 170, 33, 98, 93, 203, 213, 159, 81,
        146, 213, 142, 95, 74, 193, 29, 134, 81, 15, 181, 104,
    ];
    ...
    // Testing to_string
    let identifier2 =
        Identifier::from_string(&identifier.to_string(Encoding::Base58), Encoding::Base58).unwrap();
