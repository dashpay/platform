...
//! the proposal's two pure-data rules. No consensus path runs them yet: the reward split they
//! guard is first read by the claim that splits the moderators pot between a seated team.
