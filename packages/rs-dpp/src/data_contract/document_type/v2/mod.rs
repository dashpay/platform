...
pub struct DocumentTypeV2 {
    ...
    /// Optional group position for creation restriction
    pub(in crate::data_contract) creation_restriction_group: Option<GroupContractPosition>,
...
impl DocumentTypeV1Setters for DocumentTypeV2 {
...
impl From<DocumentTypeV1> for DocumentTypeV2 {
    fn from(value: DocumentTypeV1) -> Self {
        DocumentTypeV2 {
            ...
            creation_restriction_group: None,
