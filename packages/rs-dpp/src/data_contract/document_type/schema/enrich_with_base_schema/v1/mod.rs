...
pub const DATA_CONTRACT_SCHEMA_URI_V1: &str =
...
#[inline(always)]
pub(super) fn enrich_with_base_schema_v1(
    mut schema: Value,
    ...
    schema_map.insert_string_key_value(
        ...
        DATA_CONTRACT_SCHEMA_URI_V1.into(),
    );
    ...
    // Remove system-generated fields from required since they aren't part of
