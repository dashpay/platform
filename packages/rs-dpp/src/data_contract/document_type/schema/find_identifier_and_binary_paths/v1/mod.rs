//! Generation 1: generation 0 plus the typed array (protocol version 14),
//! whose identifier and byte array elements are registered as `path[]`
//! conversion paths, as the never-produced `Array` variant's always were.
