...
mod tests {
    ...
    mod polynomial {
        ...
        fn test_polynomial_fractional_power_rounding_boundary_is_deterministic() {
            ...
            assert_eq!(
                distribution
                    .evaluate(0, 125, &deterministic_version)
                    .unwrap(),
                5
            );
        }
    ...
    mod exp {
        ...
        fn test_exponential_deterministic_libm_path() {
            ...
            deterministic_version
                ...
                .token_versions
                .distribution_function_evaluate_version = 1;
            let v1_result = distribution.evaluate(0, 2, &deterministic_version).unwrap();
    ...
    mod inverted_log {
        ...
        fn test_inverted_logarithmic_deterministic_libm_path() {
            ...
            deterministic_version
                ...
                .token_versions
                .distribution_function_evaluate_version = 1;
            let v1_result = distribution.evaluate(0, 0, &deterministic_version).unwrap();
