        ...
        S: Serializer,
{
        ...
        let data_contract_in_serialization_format : DataContractInSerializationFormat = self.try_into_platform_versioned(current_version).map_err(|e : ProtocolError| serde::ser::Error::custom(e.to_string()))?;
...
impl<'de> Deserialize<'de> for DataContract {
            ...
            D: Deserializer<'de>,
    {
        ...
        DataContract::try_from_platform_versioned(serialization_format, true, current_version)
