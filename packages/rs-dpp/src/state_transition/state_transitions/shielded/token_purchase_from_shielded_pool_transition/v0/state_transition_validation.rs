...
impl StateTransitionStructureValidation for TokenPurchaseFromShieldedPoolTransitionV0 {
    ...
    fn validate_structure(
        ...
        if self.token_count == 0 || self.token_count > MAX_DISTRIBUTION_PARAM {
            return SimpleConsensusValidationResult::new_with_error(
        ...
        if self.total_agreed_price > self.credit_amount {
            return SimpleConsensusValidationResult::new_with_error(
...
mod tests {
    ...
    fn valid() -> TokenPurchaseFromShieldedPoolTransitionV0 {
