...
impl TokenPurchaseFromShieldedPoolTransitionMethodsV0
    for TokenPurchaseFromShieldedPoolTransitionV0
{
    #[cfg(feature = "state-transition-signing")]
    ...
    fn try_from_bundles(
        ...
        let transition = TokenPurchaseFromShieldedPoolTransitionV0 {
            data_contract_id,
