...
impl StateTransitionStructureValidation for TokenUnshieldWithShieldedFeeTransitionV0 {
    ...
    fn validate_structure(
        ...
        if self.amount == 0 || self.amount > MAX_DISTRIBUTION_PARAM {
            return SimpleConsensusValidationResult::new_with_error(
...
mod tests {
    ...
    fn valid() -> TokenUnshieldWithShieldedFeeTransitionV0 {
    ...
    #[test]
    fn should_reject_a_zero_token_amount() {
        let mut t = valid();
        t.amount = 0;
        let result = t.validate_structure(PlatformVersion::latest());
        assert_matches!(
