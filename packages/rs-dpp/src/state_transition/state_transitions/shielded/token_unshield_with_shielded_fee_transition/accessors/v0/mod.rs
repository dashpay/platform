...
/// Accessors for the fields of a `TokenUnshieldWithShieldedFeeTransition`.
pub trait TokenUnshieldWithShieldedFeeTransitionAccessorsV0 {
    ...
    /// Tokens leaving the pool into `recipient_id`'s balance: the token bundle's value balance.
