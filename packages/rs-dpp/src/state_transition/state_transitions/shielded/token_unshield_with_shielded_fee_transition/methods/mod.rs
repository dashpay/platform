...
use crate::{
    state_transition::{
        token_unshield_with_shielded_fee_transition::v0::TokenUnshieldWithShieldedFeeTransitionV0,
        StateTransition,
    },
    ProtocolError,
};
...
impl TokenUnshieldWithShieldedFeeTransitionMethodsV0 for TokenUnshieldWithShieldedFeeTransition {
    #[cfg(feature = "state-transition-signing")]
    fn try_from_bundles(
        ...
        {
            0 => TokenUnshieldWithShieldedFeeTransitionV0::try_from_bundles(
                data_contract_id,
            ...
            version => Err(ProtocolError::UnknownVersionMismatch {
                method: "TokenUnshieldWithShieldedFeeTransition::try_from_bundles".to_string(),
