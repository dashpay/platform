...
use crate::{
    ...
    state_transition::{utxo_transfer_transition::v0::UTXOTransferTransitionV0, StateTransition},
    ProtocolError,
};
#[cfg(feature = "state-transition-signing")]
use platform_version::version::{FeatureVersion, PlatformVersion};

impl UTXOTransferTransitionMethodsV0 for UTXOTransferTransition {
    #[cfg(feature = "state-transition-signing")]
    fn try_from_identity<S: Signer>(
        ...
        match version.unwrap_or(
            ...
            0 => Ok(UTXOTransferTransitionV0::try_from_identity(
                identity,
                to_recipient_keys,
                user_fee_increase,
                signer,
