...
use crate::state_transition::utxo_transfer_transition::methods::UTXOTransferTransitionMethodsV0;
...
impl UTXOTransferTransitionMethodsV0 for UTXOTransferTransitionV0 {
    #[cfg(feature = "state-transition-signing")]
    fn try_from_identity<S: Signer>(
        ...
        let mut transition: StateTransition = UTXOTransferTransitionV0 {
