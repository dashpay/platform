...
impl IdentityCreditWithdrawalTransitionMethodsV0 for IdentityCreditWithdrawalTransition {
    ...
    fn try_from_identity<S: Signer>(identity: &Identity, output_script: CoreScript, amount: u64, pooling: Pooling, core_fee_per_byte: u32, signer: S, platform_version: &PlatformVersion, version: Option<FeatureVersion>) -> Result<StateTransition, ProtocolError> {
        match version.unwrap_or(platform_version
            .dpp
