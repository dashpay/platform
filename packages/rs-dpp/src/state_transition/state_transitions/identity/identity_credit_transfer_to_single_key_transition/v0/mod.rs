...
#[derive(Default)]
pub struct IdentityCreditTransferToSingleKeyTransitionV0 {
    // Own ST fields
...
mod test {
    ...
    fn test_identity_credit_transfer_to_single_key_transition<
    ...
    #[test]
    fn test_identity_credit_transfer_to_single_key_transition1() {
        let mut rng = rand::thread_rng();
        let transition = IdentityCreditTransferToSingleKeyTransitionV0 {
        ...
        test_identity_credit_transfer_to_single_key_transition(transition);
    }
}
