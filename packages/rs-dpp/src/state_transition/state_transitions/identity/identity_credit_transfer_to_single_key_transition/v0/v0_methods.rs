...
use crate::state_transition::identity_credit_transfer_to_single_key_transition::methods::IdentityCreditTransferToSingleKeyTransitionMethodsV0;
...
impl IdentityCreditTransferToSingleKeyTransitionMethodsV0 for IdentityCreditTransferToSingleKeyTransitionV0 {
    #[cfg(feature = "state-transition-signing")]
    fn try_from_identity<S: Signer>(
        ...
        let mut transition: StateTransition = IdentityCreditTransferToSingleKeyTransitionV0 {
