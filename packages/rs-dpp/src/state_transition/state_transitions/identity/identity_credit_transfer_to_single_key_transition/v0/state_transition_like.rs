...
impl From<IdentityCreditTransferToSingleKeyTransitionV0> for StateTransition {
    fn from(value: IdentityCreditTransferToSingleKeyTransitionV0) -> Self {
        let identity_credit_transfer_to_single_key_transition: IdentityCreditTransferToSingleKeyTransition = value.into();
        identity_credit_transfer_to_single_key_transition.into()
    }
}
