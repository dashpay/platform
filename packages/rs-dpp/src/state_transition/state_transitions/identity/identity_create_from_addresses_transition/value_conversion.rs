...
impl ValueConvertible<'_> for IdentityCreateFromAddressesTransition {}
...
impl StateTransitionValueConvert<'_> for IdentityCreateFromAddressesTransition {
    ...
    fn from_object(
        ...
        match version {
            0 => Ok(IdentityCreateFromAddressesTransitionV0::from_object(
                raw_object,
                platform_version,
            )?
            .into()),
            n => Err(ProtocolError::UnknownVersionError(format!(
                "Unknown IdentityCreateFromAddressesTransition version {n}"
            ))),
        }
    }
    ...
    fn from_value_map(
        ...
        match version {
            0 => Ok(IdentityCreateFromAddressesTransitionV0::from_value_map(
                raw_value_map,
                platform_version,
            )?
            .into()),
    ...
    fn clean_value(value: &mut Value) -> Result<(), ProtocolError> {
        ...
        match version {
            0 => IdentityCreateFromAddressesTransitionV0::clean_value(value),
            n => Err(ProtocolError::UnknownVersionError(format!(
                "Unknown IdentityCreateFromAddressesTransition version {n}"
            ))),
        }
