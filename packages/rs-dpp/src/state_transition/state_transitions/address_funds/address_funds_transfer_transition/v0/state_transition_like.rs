...
mod tests {
    ...
    fn default_v0() -> AddressFundsTransferTransitionV0 {
    ...
    #[test]
    fn state_transition_type_is_address_funds_transfer() {
        let t = default_v0();
        assert_eq!(t.state_transition_type(), AddressFundsTransfer);
    }
