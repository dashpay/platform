...
use crate::state_transition::contract_fee_claim_transition::methods::ContractFeeClaimTransitionMethodsV0;
...
impl ContractFeeClaimTransitionMethodsV0 for ContractFeeClaimTransitionV0 {
    #[cfg(feature = "state-transition-signing")]
    async fn try_from_identity_with_signer<S: Signer<IdentityPublicKey>>(
        ...
        let mut state_transition: StateTransition = ContractFeeClaimTransitionV0 {
...
impl ContractFeeClaimTransitionAccessorsV0 for ContractFeeClaimTransitionV0 {
