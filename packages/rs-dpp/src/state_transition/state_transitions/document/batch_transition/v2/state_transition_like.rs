...
use crate::state_transition::batch_transition::{BatchTransition, BatchTransitionV2};
...
impl From<BatchTransitionV2> for StateTransition {
    fn from(value: BatchTransitionV2) -> Self {
        let document_batch_transition: BatchTransition = value.into();
        document_batch_transition.into()
    }
}

impl StateTransitionLike for BatchTransitionV2 {
    ...
    fn modified_data_ids(&self) -> Vec<Identifier> {
        self.transitions
            ...
            .filter_map(|t| match t {
                ...
                BatchedTransitionV1::Token(_) => None,
            })
            .collect()
    }
...
impl StateTransitionHasUserFeeIncrease for BatchTransitionV2 {
...
impl StateTransitionSingleSigned for BatchTransitionV2 {
...
impl StateTransitionOwned for BatchTransitionV2 {
    /// Get owner ID
