...
impl DocumentsBatchTransitionMethodsV1 for BatchTransitionV2 {
    #[cfg(feature = "state-transition-signing")]
    async fn new_token_mint_transition<S: Signer<IdentityPublicKey>>(
        ...
        let documents_batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(mint_transition.into())],
            user_fee_increase,
    ...
    async fn new_token_burn_transition<S: Signer<IdentityPublicKey>>(
        ...
        let documents_batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(burn_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_transfer_transition<S: Signer<IdentityPublicKey>>(
        ...
        let documents_batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(transfer_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_freeze_transition<S: Signer<IdentityPublicKey>>(
        ...
        let documents_batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(freeze_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_unfreeze_transition<S: Signer<IdentityPublicKey>>(
        ...
        let documents_batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(unfreeze_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_destroy_frozen_funds_transition<S: Signer<IdentityPublicKey>>(
        ...
        let batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(
    ...
    async fn new_token_emergency_action_transition<S: Signer<IdentityPublicKey>>(
        ...
        let batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(
                emergency_action_transition.into(),
            )],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
    ...
    async fn new_token_config_update_transition<S: Signer<IdentityPublicKey>>(
        ...
        let batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(config_update_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_claim_transition<S: Signer<IdentityPublicKey>>(
        ...
        let batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(claim_transition.into())],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
        }
    ...
    async fn new_token_direct_purchase_transition<S: Signer<IdentityPublicKey>>(
        ...
        let batch_transition: BatchTransition = BatchTransitionV2 {
            owner_id,
            transitions: vec![BatchedTransitionV1::Token(
                direct_purchase_transition.into(),
            )],
            user_fee_increase,
            signature_public_key_id: 0,
            signature: Default::default(),
