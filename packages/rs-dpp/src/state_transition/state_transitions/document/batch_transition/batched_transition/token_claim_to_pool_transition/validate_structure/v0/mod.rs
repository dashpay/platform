use crate::consensus::basic::token::{
    InvalidTokenNoteTooBigError, TokenNoteOnlyAllowedWhenProposerError,
};
...
pub(super) trait TokenClaimToPoolTransitionActionStructureValidationV0 {
...
impl TokenClaimToPoolTransitionActionStructureValidationV0 for TokenClaimToPoolTransition {
...
mod tests {
    ...
    use crate::state_transition::batch_transition::token_claim_to_pool_transition::v0::TokenClaimToPoolTransitionV0;
    ...
    fn make_transition(_amount: u64) -> TokenClaimToPoolTransition {
    ...
    fn empty_actions_are_rejected() {
        ...
        let TokenClaimToPoolTransition::V0(v0) = &mut transition;
        v0.actions.clear();
