...
/// The Identifier fields in [`TokenBurnFromPoolTransition`]
...
pub struct TokenBurnFromPoolTransitionV0 {
...
impl Default for TokenBurnFromPoolTransitionV0 {
    fn default() -> Self {
        Self {
...
impl fmt::Display for TokenBurnFromPoolTransitionV0 {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            f,
            "Token Burn From Pool, base: {}, amount: {}, actions: {}",
            self.base,
            self.amount,
            self.actions.len()
        )
