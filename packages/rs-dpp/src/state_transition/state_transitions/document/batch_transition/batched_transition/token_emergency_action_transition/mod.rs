...
mod json_convertible_tests {
    ...
    fn assert_v0_fields(t: &TokenEmergencyActionTransition) {
        let TokenEmergencyActionTransition::V0(rec) = t;
        ...
        assert_eq!(
            rec.emergency_action,
            crate::tokens::emergency_action::TokenEmergencyAction::Pause,
            "emergency_action"
        );
        assert_eq!(rec.public_note, Some("pause".to_string()), "public_note");
    }
