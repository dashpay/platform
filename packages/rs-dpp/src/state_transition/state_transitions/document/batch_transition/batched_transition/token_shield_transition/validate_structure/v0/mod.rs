...
pub(super) trait TokenShieldTransitionActionStructureValidationV0 {
...
impl TokenShieldTransitionActionStructureValidationV0 for TokenShieldTransition {
...
mod tests {
    ...
    use crate::state_transition::batch_transition::token_shield_transition::v0::TokenShieldTransitionV0;
    ...
    fn make_transition(amount: u64) -> TokenShieldTransition {
    ...
    fn empty_actions_are_rejected() {
        ...
        let TokenShieldTransition::V0(v0) = &mut transition;
        v0.actions.clear();
