...
use crate::state_transition::batch_transition::token_burn_from_pool_transition::TokenBurnFromPoolTransitionV0;
...
impl TokenBaseTransitionAccessors for TokenBurnFromPoolTransitionV0 {
...
pub trait TokenBurnFromPoolTransitionV0Methods: TokenBaseTransitionAccessors {
...
impl TokenBurnFromPoolTransitionV0Methods for TokenBurnFromPoolTransitionV0 {
    fn amount(&self) -> TokenAmount {
        self.amount
    }
    fn actions(&self) -> &[SerializedAction] {
...
impl AllowedAsMultiPartyAction for TokenBurnFromPoolTransitionV0 {
    fn calculate_action_id(
        ...
        Ok(
            TokenBurnFromPoolTransition::calculate_action_id_with_fields(
