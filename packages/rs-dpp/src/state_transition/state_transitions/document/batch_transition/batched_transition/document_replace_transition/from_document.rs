...
use crate::state_transition::batch_transition::batched_transition::document_replace_transition::validate_structure::DocumentReplaceTransitionStructureValidation;
...
impl DocumentReplaceTransition {
    ...
    pub fn from_document(
        ...
        match feature_version.unwrap_or(
            ...
            0 => {
                let transition: DocumentReplaceTransition =
                    DocumentReplaceTransitionV0::from_document(
                        document,
                        document_type,
                        token_payment_info,
