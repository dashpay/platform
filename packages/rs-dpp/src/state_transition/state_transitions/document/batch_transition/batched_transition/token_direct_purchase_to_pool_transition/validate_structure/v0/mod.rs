...
pub(super) trait TokenDirectPurchaseToPoolTransitionActionStructureValidationV0 {
...
impl TokenDirectPurchaseToPoolTransitionActionStructureValidationV0
...
mod tests {
    ...
    use crate::state_transition::batch_transition::token_direct_purchase_to_pool_transition::v0::TokenDirectPurchaseToPoolTransitionV0;
    ...
    fn make_transition(amount: u64) -> TokenDirectPurchaseToPoolTransition {
    ...
    fn empty_actions_are_rejected() {
        ...
        let TokenDirectPurchaseToPoolTransition::V0(v0) = &mut transition;
        v0.actions.clear();
