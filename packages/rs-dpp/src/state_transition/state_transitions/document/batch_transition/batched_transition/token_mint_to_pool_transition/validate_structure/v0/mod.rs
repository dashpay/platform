...
pub(super) trait TokenMintToPoolTransitionActionStructureValidationV0 {
...
impl TokenMintToPoolTransitionActionStructureValidationV0 for TokenMintToPoolTransition {
...
mod tests {
    ...
    use crate::state_transition::batch_transition::token_mint_to_pool_transition::v0::TokenMintToPoolTransitionV0;
    ...
    fn make_transition(amount: u64) -> TokenMintToPoolTransition {
    ...
    fn empty_actions_are_rejected() {
        ...
        let TokenMintToPoolTransition::V0(v0) = &mut transition;
        v0.actions.clear();
