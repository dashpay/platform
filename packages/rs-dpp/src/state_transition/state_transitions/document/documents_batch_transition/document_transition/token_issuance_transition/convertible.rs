...
impl DocumentTransitionObjectLike for TokenIssuanceTransition {
    #[cfg(feature = "state-transition-json-conversion")]
    fn from_json_object(
    ...
    fn from_value_map(
        ...
        match version.as_str() {
            "0" => Ok(TokenIssuanceTransition::V0(
                TokenIssuanceTransitionV0::from_value_map(map, data_contract)?,
            )),
