...
pub trait TokenIssuanceTransitionV0Methods {
    /// Returns a reference to the `base` field of the `TokenIssuanceTransitionV0`.
    fn base(&self) -> &DocumentBaseTransition;

    /// Returns a mut reference to the `base` field of the `TokenIssuanceTransitionV0`.
    fn base_mut(&mut self) -> &mut DocumentBaseTransition;

    /// Sets the value of the `base` field in the `TokenIssuanceTransitionV0`.
    ///
    /// # Arguments
    ///
    ...
    /// Returns a reference to the `entropy` field of the `TokenIssuanceTransitionV0`.
    fn entropy(&self) -> [u8; 32];

    /// Sets the value of the `entropy` field in the `TokenIssuanceTransitionV0`.
    ///
    /// # Arguments
    ///
    ...
    /// Returns an optional reference to the `data` field of the `TokenIssuanceTransitionV0`.
    fn data(&self) -> &BTreeMap<String, Value>;

    /// Returns an optional mutable reference to the `data` field of the `TokenIssuanceTransitionV0`.
    fn data_mut(&mut self) -> &mut BTreeMap<String, Value>;

    /// Sets the value of the `data` field in the `TokenIssuanceTransitionV0`.
    ///
    /// # Arguments
    ///
