...
mod test {
    ...
    #[test]
    fn should_return_invalid_result_if_owner_id_does_not_exist() {
        let bls = NativeBlsModule::default();
        let mut state_repository_mock = MockStateRepositoryLike::new();
        let raw_identity = identity_fixture_raw_object();
        let identity = Identity::from_object(raw_identity).unwrap();
    ...
    #[test]
    fn should_return_missing_public_key_error_if_identity_does_not_have_matching_public_key() {
        let bls = NativeBlsModule::default();
        let mut state_repository_mock = MockStateRepositoryLike::new();
        let raw_identity = identity_fixture_raw_object();
        let identity = Identity::from_object(raw_identity).unwrap();
    ...
    #[test]
    fn should_return_invalid_state_transition_signature_error_if_signature_is_invalid() {
        let bls = NativeBlsModule::default();
        let mut state_repository_mock = MockStateRepositoryLike::new();
        let raw_identity = identity_fixture_raw_object();
        let identity = Identity::from_object(raw_identity).unwrap();
    ...
    #[test]
    fn should_return_invalid_signature_public_key_security_level_error() {
        let bls = NativeBlsModule::default();
    ...
    #[test]
    fn should_return_public_key_security_level_not_met() {
        let bls = NativeBlsModule::default();
    ...
    #[test]
    fn should_return_public_key_is_disabled_error() {
        let bls = NativeBlsModule::default();
