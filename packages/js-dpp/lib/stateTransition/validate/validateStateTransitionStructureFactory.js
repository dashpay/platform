...
function validateStateTransitionStructureFactory(validator, typeExtensions) {
   ...
   * @param {RawDataContractStateTransition|DataContractStateTransition} stateTransition
   */
  function validateStateTransitionStructure(stateTransition) {
    ...
    result.merge(
      validationFunction(rawStateTransition),
    );
