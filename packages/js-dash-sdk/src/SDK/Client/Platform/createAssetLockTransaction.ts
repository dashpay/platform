...
export async function createAssetLockTransaction(
  ...
  // @ts-ignore
  const { dppModule } = platform;

  // TODO: sometimes key generated by dashcore-js is considered
  //  invalid by dashcore-rust's signature verification logic (1/20 attempts or so).
  //  Research why is this happening and return back line below
  // const assetLockOneTimePrivateKey = new PrivateKey();
  // @ts-ignore
  const assetLockOneTimePrivateKey = new PrivateKey(dppModule.generateTemporaryEcdsaPrivateKey());
