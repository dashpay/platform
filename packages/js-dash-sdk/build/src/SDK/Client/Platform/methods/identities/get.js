        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    (_a = _b.sent(), Metadata = _a.Metadata, Identifier = _a.Identifier);
                    identifier = Identifier.from(id);
                    _b.label = 3;
                case 3:
                    _b.trys.push([3, 5, , 6]);
                    return [4 /*yield*/, this.client.getDAPIClient().platform
                            .getIdentity(identifier)];
                case 4:
                    identityResponse = _b.sent();
                    return [3 /*break*/, 6];
                case 5:
                    e_1 = _b.sent();
                    ...
                    throw e_1;
                case 6:
                    identity = this.wasmDpp.identity.createFromBuffer(identityResponse.getIdentity());
