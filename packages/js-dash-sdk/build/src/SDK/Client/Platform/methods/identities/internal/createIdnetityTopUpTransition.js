...
function createIdentityTopUpTransition(assetLockProof, assetLockPrivateKey, identityId) {
    return __awaiter(this, void 0, void 0, function () {
        var platform, wasmDpp, identityTopUpTransition, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    identityTopUpTransition = wasmDpp.identity.createIdentityTopUpTransition(identityId, assetLockProof);
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, wasmDpp.stateTransition.validateBasic(identityTopUpTransition)];
                case 3:
                    result = _a.sent();
                    if (!result.isValid()) {
