...
describe('Storage - searchTransaction', () => {
  it('should find a transaction', () => {
    ...
    const existingTxID = faa430b0fe84a074d981e6fa3995a13363478415ca029a12f6432bf3d90dfa60.txid;
    const notExistingTxID = fd7c727155ef67fd5c1d54b73dea869e9690c439570063d6e96fec1d3bba450e.txid;
    const search = searchTransaction.call(self, existingTxID);

    expect(search.found).to.be.equal(true);
    expect(search.txid).to.be.equal(existingTxID);
    ...
    expect(search2.txid).to.be.equal(notExistingTxID);
  });
});
