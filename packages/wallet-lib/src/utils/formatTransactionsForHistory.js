...
const formatTransactionsForHistory = (account, transactions) => {
  ...
  each(sortedCategorizedTransactions, (categorizedTransaction) => {
    ...
    formattedTransactions.push(normalizedTransactionHistory);
  });

  // Sort by decreasing time.
  return formattedTransactions.sort(sortbyTimeDescending);
};

module.exports = formatTransactionsForHistory;
