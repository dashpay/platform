...
export const {
  ...
  UTXO_SELECTION_MAX_SINGLE_UTXO_FACTOR,
  UTXO_SELECTION_MIN_TX_AMOUNT_VS_UTXO_FACTOR,
  UTXO_SELECTION_MAX_FEE_VS_TX_AMOUNT_FACTOR,
  UTXO_SELECTION_MAX_FEE_VS_SINGLE_UTXO_FEE_FACTOR,
  MAX_STANDARD_TX_SIZE,
  MAX_P2SH_SIGOPS,
  COINBASE_MATURITY,
  UTXO_CHAINED_SPENDING_LIMIT_FOR_TX,
  FEES,
