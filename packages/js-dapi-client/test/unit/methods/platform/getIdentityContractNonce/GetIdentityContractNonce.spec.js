...
import GetIdentityContractNonceResponseClass from '../../../../../lib/methods/platform/getIdentityContractNonce/GetIdentityContractNonceResponse.js';
...
describe('GetIdentityContractNonceResponse', () => {
  ...
  it('should return proof', () => {
    ...
    expect(identityContractNonce).to.deep.equal(BigInt(0));
