...
describe('Insight-API - getBlockVersion', function() {
    it('should return the valid getBlockVersion from hash', function() {
        return SDK.Explorer.API.getBlockVersion(validBlockHash)
            .then(version => version.should.equal(536870912))

    });
    it('should return the valid getBlockVersion from height', async function() {
        return SDK.Explorer.API.getBlockVersion(validBlockHeight)
            .then(version => version.should.equal(536870912))
    });
});