...
describe('Util - mnemonic', function() {
    it('should generate a valid seed from a mnemonic', async function(){
    ...
    it('should generate a valid mnemonic and seed',async function (){
        let seedObj = mnemonic.generateMnemonicAndSeed();
