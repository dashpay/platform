...
#[wasm_bindgen]
pub struct VerifyTokenBalancesForIdentityIdResult {
    root_hash: Vec<u8>,
    balances: JsValue,
}

#[wasm_bindgen]
impl VerifyTokenBalancesForIdentityIdResult {
    #[wasm_bindgen(getter)]
...
// Vec variant - returns array of tuples [tokenId, balance]
#[wasm_bindgen(js_name = "verifyTokenBalancesForIdentityIdVec")]
pub fn verify_token_balances_for_identity_id_vec(
    proof: &Uint8Array,
    token_ids: &JsValue,
    identity_id: &Uint8Array,
    verify_subset_of_proof: bool,
    platform_version_number: u32,
) -> Result<VerifyTokenBalancesForIdentityIdResult, JsValue> {
    ...
    Ok(VerifyTokenBalancesForIdentityIdResult {
...
#[wasm_bindgen(js_name = "verifyTokenBalancesForIdentityIdMap")]
pub fn verify_token_balances_for_identity_id_map(
    proof: &Uint8Array,
    token_ids: &JsValue,
    identity_id: &Uint8Array,
    verify_subset_of_proof: bool,
