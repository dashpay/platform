...
impl DocumentTransferTransitionWasm {
    ...
    //         .with_js_error()?;
    //     let transition =
    //         DocumentTransferTransition::from_value_map(value, data_contract).with_js_error()?;
    //
    //     Ok(transition.into())
    // }
    //
    ...
    //     DocumentTransitionActionType::Transfer as u8;
    // }
    //
    ...
    //         identifier_paths
    //             .into_iter()
    //             .chain(document_transfer_transition::v0::IDENTIFIER_FIELDS),
    //         binary_paths,
    //     )
    // }
    //
