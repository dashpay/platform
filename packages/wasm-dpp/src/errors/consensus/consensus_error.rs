...
fn from_basic_error(basic_error: &BasicError) -> JsValue {
    match basic_error {
        ...
        BasicError::InvalidKeyPurposeKeyTypeError(e) => {
            generic_consensus_error!(InvalidKeyPurposeKeyTypeError, e).into()
        }
        BasicError::TooManyPublicKeysOfPurposeError(e) => {
            generic_consensus_error!(TooManyPublicKeysOfPurposeError, e).into()
        }
