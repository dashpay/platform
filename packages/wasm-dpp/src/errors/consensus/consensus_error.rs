...
fn from_basic_error(basic_error: &BasicError) -> JsValue {
    match basic_error {
        ...
        BasicError::DataContractUpdateTransitionOverlappingFieldsError(e) => {
            generic_consensus_error!(DataContractUpdateTransitionOverlappingFieldsError, e).into()
        }
        BasicError::DataContractUpdateTransitionConflictingKeywordError(e) => {
            generic_consensus_error!(DataContractUpdateTransitionConflictingKeywordError, e).into()
        }
    }
}
