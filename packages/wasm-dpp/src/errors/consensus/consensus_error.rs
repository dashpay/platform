...
fn from_basic_error(basic_error: &BasicError) -> JsValue {
    match basic_error {
        ...
        BasicError::ContestedIndexInvalidParametersError(e) => {
            generic_consensus_error!(ContestedIndexInvalidParametersError, e).into()
        }
    }
}
