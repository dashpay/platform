...
fn from_basic_error(basic_error: &BasicError) -> JsValue {
    match basic_error {
        ...
        BasicError::SerializedObjectParsingError(e) => SerializedObjectParsingErrorWasm::from(e).into(),
