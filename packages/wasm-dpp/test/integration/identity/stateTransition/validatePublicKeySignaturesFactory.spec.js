...
describe('validatePublicKeySignaturesFactory', () => {
  ...
  beforeEach(async () => {
    ...
    const identityPublicKey1 = new IdentityPublicKeyInCreation({
      id: 0,
    ...
    const identityPublicKey2 = new IdentityPublicKeyInCreation({
      id: 1,
    ...
    const identityPublicKey3 = new IdentityPublicKeyInCreation({
      id: 2,
