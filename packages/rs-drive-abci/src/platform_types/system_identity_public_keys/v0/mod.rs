...
pub trait SystemIdentityPublicKeysV0Getters {
    ...
    fn masternode_reward_shares_contract_owner(&self) -> &required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet;
    /// Returns the required public key set for feature flags contract owner identity
    fn feature_flags_contract_owner(&self) -> &required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet;
    /// Returns the required public key set for dpns contract owner identity
    fn dpns_contract_owner(&self) -> &required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet;
    /// Returns the required public key set for withdrawals contract owner identity
    fn withdrawals_contract_owner(&self) -> &required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet;
    /// Returns the required public key set for dashpay contract owner identity
    fn dashpay_contract_owner(&self) -> &required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet;
}
...
pub trait SystemIdentityPublicKeysV0Setters {
    ...
    fn set_masternode_reward_shares_contract_owner(&mut self, keys: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet);
    /// Sets the required public key set for feature flags contract owner identity
    fn set_feature_flags_contract_owner(&mut self, keys: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet);
    /// Sets the required public key set for dpns contract owner identity
    fn set_dpns_contract_owner(&mut self, keys: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet);
    /// Sets the required public key set for withdrawals contract owner identity
    fn set_withdrawals_contract_owner(&mut self, keys: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet);
    /// Sets the required public key set for dashpay contract owner identity
    fn set_dashpay_contract_owner(&mut self, keys: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet);
}
...
impl SystemIdentityPublicKeysV0Setters for SystemIdentityPublicKeysV0 {
    fn set_masternode_reward_shares_contract_owner(&mut self, owner: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet) {
        self.masternode_reward_shares_contract_owner = owner;
    }

    fn set_feature_flags_contract_owner(&mut self, owner: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet) {
        self.feature_flags_contract_owner = owner;
    }

    fn set_dpns_contract_owner(&mut self, owner: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet) {
        self.dpns_contract_owner = owner;
    }

    fn set_withdrawals_contract_owner(&mut self, owner: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet) {
        self.withdrawals_contract_owner = owner;
    }

    fn set_dashpay_contract_owner(&mut self, owner: required_identity_public_key_set::v0::RequiredIdentityPublicKeysSet) {
