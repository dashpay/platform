...
impl MasternodeAccessorsV0 for Masternode {
    fn node_type(&self) -> MasternodeType {
        match self {
            ...
            Masternode::V1(v1) => v1.node_type.clone(),
        }
    }
    ...
    fn pro_tx_hash(&self) -> ProTxHash {
        match self {
            ...
            Masternode::V1(v1) => v1.pro_tx_hash,
        }
    }
    ...
    fn collateral_hash(&self) -> Txid {
        match self {
            ...
            Masternode::V1(v1) => v1.collateral_hash,
        }
    }
    ...
    fn collateral_index(&self) -> u32 {
        match self {
            ...
            Masternode::V1(v1) => v1.collateral_index,
        }
    }
    ...
    fn collateral_address(&self) -> [u8; 20] {
        match self {
            ...
            Masternode::V1(v1) => v1.collateral_address,
        }
    }
    ...
    fn operator_reward(&self) -> f32 {
        match self {
            ...
            Masternode::V1(v1) => v1.operator_reward,
        }
    }
}
