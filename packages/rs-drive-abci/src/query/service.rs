...
impl PlatformService for QueryService {
    ...
    async fn get_current_quorums_info(&self, request: Request<GetCurrentQuorumsInfoRequest>) -> Result<Response<GetCurrentQuorumsInfoResponse>, Status> {
        self.handle_blocking_query(
            request,
