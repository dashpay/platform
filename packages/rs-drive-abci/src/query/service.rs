...
impl PlatformService for QueryService {
    ...
    async fn get_identities_keys(
        &self,
        request: Request<GetIdentitiesKeysRequest>,
    ) -> Result<Response<GetIdentitiesKeysResponse>, Status> {
        self.handle_blocking_query(
            request,
