...
mod clean_up_after_yes_no_vote_polls_end;
mod keep_record_of_finished_yes_no_vote_poll;
mod keep_record_of_vote_poll;
mod on_yes_no_vote_poll_finished;
...
mod tally_votes_for_yes_no_vote_poll;
