...
impl<C> Platform<C> {
    ...
    ///
    /// Generation 1 (protocol version 14) returns every reward share of the masternode.
    /// Generation 0 asked for one document, so a masternode's other shares were never paid.
    pub(super) fn fetch_reward_shares_list_for_masternode_v1(
        &self,
