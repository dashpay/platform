...
impl<C> Platform<C> {
    ...
    pub(super) fn add_distribute_fees_from_oldest_unpaid_epoch_pool_to_proposers_operations_v0(
        ...
        println!("add_distribute_fees_from_oldest_unpaid_epoch_pool_to_proposers_operations_v0 {}", current_epoch_index);
        ...
        println!("add_distribute_fees_from_oldest_unpaid_epoch_pool_to_proposers_operations_v0 end");
