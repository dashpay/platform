...
mod tests {
    ...
    fn test_mark_epoch_as_paid_and_update_next_update_epoch_index_if_all_proposers_paid() {
        ...
        unpaid_epoch.add_init_current_operations(platform_version.fee_version.uses_version_fee_multiplier_permille.expect("expected a fee multiplier"), 1, 1, 1, &mut batch);
