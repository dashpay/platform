...
mod tests {
    ...
    mod add_epoch_pool_to_proposers_payout_operations {
        ...
        fn test_payout_to_proposers() {
            ...
            unpaid_epoch_tree.add_init_current_operations(platform_version.fee_version.uses_version_fee_multiplier_permille.expect("expected a fee multiplier"), 1, 1, 1, &mut batch);
            ...
            next_epoch_tree.add_init_current_operations(
                platform_version.fee_version.uses_version_fee_multiplier_permille.expect("expected a fee multiplier"),
