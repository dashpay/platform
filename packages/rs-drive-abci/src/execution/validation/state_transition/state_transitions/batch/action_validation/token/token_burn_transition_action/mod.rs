...
use crate::execution::validation::state_transition::batch::action_validation::token::token_burn_transition_action::structure_v0::TokenBurnTransitionActionStructureValidationV0;
    ...
    fn validate_structure(
            ...
            .token_burn_transition_structure_validation
        {
            ...
            version => Err(Error::Execution(ExecutionError::UnknownVersionMismatch {
                method: "TokenBurnTransitionAction::validate_structure".to_string(),
