...
pub(in crate::execution::validation::state_transition::state_transitions::batch::action_validation) trait DocumentUpdatePriceTransitionActionStateValidationV0 {
...
impl DocumentUpdatePriceTransitionActionStateValidationV0 for DocumentUpdatePriceTransitionAction {
    fn validate_state_v0(
        ...
        // whose time to live has passed is no longer repriced.
