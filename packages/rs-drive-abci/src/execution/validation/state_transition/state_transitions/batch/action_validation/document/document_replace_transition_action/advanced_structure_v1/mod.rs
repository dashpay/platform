...
pub(in crate::execution::validation::state_transition::state_transitions::batch::action_validation) trait DocumentReplaceTransitionActionStructureValidationV1 {
...
impl DocumentReplaceTransitionActionStructureValidationV1 for DocumentReplaceTransitionAction {
    fn validate_structure_v1(
        &self,
        owner_id: Identifier,
        platform_version: &PlatformVersion,
