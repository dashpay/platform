...
use crate::execution::validation::state_transition::batch::action_validation::document::document_replace_transition_action::advanced_structure_v1::DocumentReplaceTransitionActionStructureValidationV1;
...
impl DocumentReplaceTransitionActionValidation for DocumentReplaceTransitionAction {
    fn validate_structure(
            ...
            .document_replace_transition_structure_validation
        {
            ...
            // V1 introduces the `distinctFrom` check: an identifier property equal to the
    ...
    fn validate_state(
            ...
            .document_replace_transition_state_validation
        {
            ...
            // V1 introduces document reference validation (`refersTo`) on top of V0,
            // limited to the fields changed by the replace transition
