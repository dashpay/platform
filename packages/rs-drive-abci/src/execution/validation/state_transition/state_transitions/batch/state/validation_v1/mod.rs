...
use crate::execution::validation::state_transition::batch::action_validation::document::document_erase_transition_action::DocumentEraseTransitionActionValidation;
...
impl DocumentsBatchStateTransitionValidationV1 for BatchTransition {
    fn validate_state_v1(
        &self,
        mut state_transition_action: BatchTransitionActionV1,
        platform: &PlatformStateRef,
        block_info: &BlockInfo,
        execution_context: &mut StateTransitionExecutionContext,
        ...
        for transition in state_transition_action.transitions_take() {
            ...
            if !transition_validation_result.is_valid() {
                ...
                validated_transitions.push(BatchedTransitionActionV1::Batched(
                    BatchedTransitionAction::BumpIdentityDataContractNonce(
                        BumpIdentityDataContractNonceAction::try_from_borrowed_batched_transition_action_v1(
                            &transition,
                            owner_id,
                ...
                // An erase has no data triggers: it carries no document values
                // and acts on a document that is already deleted.
                if let BatchedTransitionActionV1::Batched(
        ...
        validation_result.set_data(StateTransitionAction::BatchActionV1(
