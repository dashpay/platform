...
mod replacement_tests {
    ...
    async fn test_document_replace_on_document_type_that_is_mutable() {
        run_document_replace_on_document_type_that_is_mutable_at_protocol_version(
            ...
            // v14: replaced documents carry the contract-version stamp, and GroveDB
            // V4 prepares the batch through retained Merk nodes, which bills
            // slightly fewer reads than the V3 path
            1428320,
        )
        .await;
    }
