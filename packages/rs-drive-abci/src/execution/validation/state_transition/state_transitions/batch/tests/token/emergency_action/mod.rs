...
mod token_emergency_action_tests {
    ...
    fn test_token_emergency_pause() {
        ...
        let emergency_transition = BatchTransition::new_token_emergency_action_transition(
            token_id,
            identity.id(),
            contract.id(),
            0,
        ...
        let serialized = emergency_transition
            .serialize_to_bytes()
    ...
    #[test]
    fn test_token_emergency_pause_and_resume() {
        let platform_version = PlatformVersion::latest();
        let mut platform = TestPlatformBuilder::new()
            .with_latest_protocol_version()
            .build_with_mock_rpc()
    ...
    #[test]
    fn test_token_emergency_action_by_non_owner_should_fail() {
        let platform_version = PlatformVersion::latest();
        let mut platform = TestPlatformBuilder::new()
            .with_latest_protocol_version()
            .build_with_mock_rpc()
