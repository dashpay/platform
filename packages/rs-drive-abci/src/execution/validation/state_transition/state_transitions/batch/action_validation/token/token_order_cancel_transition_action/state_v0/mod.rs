...
use drive::state_transition_action::batch::batched_transition::token_transition::token_order_cancel_transition_action::TokenOrderCancelTransitionActionAccessorsV0;
...
pub(in crate::execution::validation::state_transition::state_transitions::batch::action_validation) trait TokenOrderCancelTransitionActionStateValidationV0 {
...
impl TokenOrderCancelTransitionActionStateValidationV0 for TokenOrderCancelTransitionAction {
    fn validate_state_v0(
        &self,
        platform: &PlatformStateRef,
        owner_id: Identifier,
