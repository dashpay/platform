...
pub(super) trait TokenIssuanceTransitionActionStateValidationV0 {
...
impl TokenIssuanceTransitionActionStateValidationV0 for TokenIssuanceTransitionAction {
    fn validate_state_v0(
        &self,
        platform: &PlatformStateRef,
        owner_id: Identifier,
        ...
        let document_type_name = self.base().to();
        ...
        if document_type.indexes().values().any(|index| index.unique) {
            let validation_result = platform
                .drive
                .validate_token_issuance_transition_action_uniqueness(
                    contract,
                    document_type,
                    self,
                    owner_id,
