...
use drive::state_transition_action::document::documents_batch::document_transition::token_issuance_transition_action::{TokenIssuanceTransitionAction, TokenIssuanceTransitionActionAccessorsV0};
...
impl TokenIssuanceTransitionActionStructureValidationV0 for TokenIssuanceTransitionAction {
    fn validate_structure_v0(
        &self,
        owner_id: Identifier,
        block_info: &BlockInfo,
