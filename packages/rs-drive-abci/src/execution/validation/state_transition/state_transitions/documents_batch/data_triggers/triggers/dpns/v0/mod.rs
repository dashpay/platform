...
use dpp::data_contracts::dpns_contract::v0::document_types::domain::properties::PARENT_DOMAIN_NAME;
...
use dpp::system_data_contracts::dpns_contract::v0::document_types::domain::properties::{ALLOW_SUBDOMAINS,
