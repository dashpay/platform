...
fn transform_document_transitions_within_document_type_v0(
    ...
    let replace_transitions = document_transitions.iter().filter(|transition| matches!(transition, DocumentTransition::Replace(_))).copied().collect::<Vec<_>>();
...
fn transform_transition_v0<'a>(
    ...
    match transition {
        ...
        DocumentTransition::Replace(document_replace_transition) => {
            ...
            let validation_result = Self::check_ownership_of_old_replaced_document_v0(document_replace_transition, original_document, &owner_id);
            ...
            let validation_result =
                Self::check_revision_is_bumped_by_one_during_replace_v0(document_replace_transition, original_document);
            ...
            let document_replace_action = DocumentReplaceTransitionAction::try_from_borrowed_document_replace_transition(
