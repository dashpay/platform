...
mod tests {
    ...
    fn test_identity_top_up_validation() {
        ...
        assert_eq!(processing_result.aggregated_fees().processing_fee, 12715000); // TODO: Readjust this test when FeeHashingVersion blake3_base, sha256_ripe_md160_base, blake3_per_block values are finalised
        ...
        assert_eq!(identity_balance, 149929235000); // about 0.5 Dash starting balance + 1 Dash asset lock top up // TODO: Readjust this test when FeeHashingVersion blake3_base, sha256_ripe_md160_base, blake3_per_block values are finalised
    }
}
