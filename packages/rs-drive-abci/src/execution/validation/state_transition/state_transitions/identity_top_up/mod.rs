...
mod tests {
    ...
    fn test_identity_top_up_validation() {
        ...
        assert_eq!(processing_result.aggregated_fees().processing_fee, 1213500);
        ...
        assert_eq!(identity_balance, 149992981500); // about 0.5 Dash starting balance + 1 Dash asset lock top up
    }
}
