...
mod tests {
    ...
    fn test_identity_top_up_validation_latest_version() {
        ...
        assert_eq!(processing_result.aggregated_fees().processing_fee, 592260);
        ...
        assert_eq!(identity_balance, 149993602740); // about 0.5 Dash starting balance + 1 Dash asset lock top up
    }
