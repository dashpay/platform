...
use crate::execution::validation::state_transition::identity_credit_transfer::nonce::v0::IdentityCreditTransferTransitionIdentityContractNonceV0;
    ...
    fn validate_nonces(
            ...
            .nonce
        {
            ...
            Some(version) => Err(Error::Execution(ExecutionError::UnknownVersionMismatch {
                method: "identity credit transfer transition: validate_nonces"
                    .to_string(),
