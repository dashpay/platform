...
mod tests {
    ...
    mod fee_regression {
        ...
        fn test_fee_simple_p2pkh_1_input_1_output_deduct_from_input() {
            ...
            assert_eq!(
                processing_fee, 457020,
                "Processing fee changed! Was 457020, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 6532020,
                "Total fee changed! Was 6532020, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_p2pkh_2_inputs_1_output() {
            ...
            assert_eq!(
                processing_fee, 587380,
                "Processing fee changed! Was 587380, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 6662380,
                "Total fee changed! Was 6662380, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_p2pkh_1_input_2_outputs() {
            ...
            assert_eq!(
                processing_fee, 559400,
                "Processing fee changed! Was 559400, now {}",
                processing_fee
            );
            assert_eq!(
            ...
            assert_eq!(
                total_fee, 12709400,
                "Total fee changed! Was 12709400, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_p2sh_2_of_3_multisig() {
            ...
            assert_eq!(
                processing_fee, 477020,
                "Processing fee changed! Was 477020, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 6552020,
                "Total fee changed! Was 6552020, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_p2sh_3_of_5_multisig() {
            ...
            assert_eq!(
                processing_fee, 492020,
                "Processing fee changed! Was 492020, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 6567020,
                "Total fee changed! Was 6567020, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_with_user_fee_increase() {
            ...
            // Base processing fee is 457020, with user_fee_increase=100 it should be higher
            ...
            // Assert exact values
            assert_eq!(
                processing_fee, 914040,
                "Processing fee changed! Was 914040, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 6989040,
                "Total fee changed! Was 6989040, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_maximum_16_inputs() {
            ...
            // Assert exact values
            assert_eq!(
                processing_fee, 2957780,
                "Processing fee changed! Was 2957780, now {}",
                processing_fee
            );
            assert_eq!(
                storage_fee, 6075000,
            ...
            assert_eq!(
                total_fee, 9032780,
                "Total fee changed! Was 9032780, now {}",
                total_fee
            );
        }
        ...
        fn test_fee_new_output_address_vs_existing() {
            ...
            assert_eq!(
                total_fee_new, 6532020,
                "Total fee to new address changed! Was 6532020, now {}",
                total_fee_new
            );

            // Assert exact values for existing address (much cheaper - only updates balance)
            assert_eq!(
                total_fee_existing, 445500,
                "Total fee to existing address changed! Was 445500, now {}",
                total_fee_existing
            );
        }
    }
