    ...
    for IdentityCreateFromAddressesTransition
{
    ...
    fn transform_into_action_v0<C: CoreRPCLike>(
        ...
        let required_balance = platform_version
            ...
            .identities
            .asset_locks
            .required_asset_lock_duff_balance_for_processing_start_for_identity_create_from_addresses
            * CREDITS_PER_DUFF;
        ...
        match IdentityCreateFromAddressesTransitionAction::try_from_borrowed(
            self,
