...
mod tests {
    ...
    #[test]
    fn test_identity_create_from_addresses_validation_first_protocol_version() {
        ...
        let identity_create_from_addresses_transition: StateTransition =
            ...
            .expect("expected an identity create from addresses transition");

        let identity_create_from_addresses_serialized_transition =
        ...
        let processing_result = platform
            ...
            .process_raw_state_transitions(
                &vec![identity_create_from_addresses_serialized_transition.clone()],
                &platform_state,
                &BlockInfo::default(),
                &transaction,
                platform_version,
    ...
    #[test]
    fn test_identity_create_from_addresses_validation_latest_protocol_version() {
        ...
        let identity_create_from_addresses_transition: StateTransition =
            IdentityCreateFromAddressesTransition::try_from_identity_with_signer(
                &identity,
                asset_lock_proof,
                pk.as_slice(),
                &signer,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_reuse_after_issue_first_protocol_version() {
        let platform_version = PlatformVersion::first();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_reuse_after_issue_latest_protocol_version() {
        let platform_version = PlatformVersion::latest();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_reuse_after_max_issues() {
        let platform_version = PlatformVersion::latest();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_use_all_funds() {
        let platform_version = PlatformVersion::latest();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_replay_attack_first_protocol_version() {
        let platform_version = PlatformVersion::first();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
    ...
    #[test]
    fn test_identity_create_from_addresses_asset_lock_replay_attack_latest_protocol_version() {
        let platform_version = PlatformVersion::latest();
        let platform_config = PlatformConfig {
            testing_configs: PlatformTestConfig {
                disable_instant_lock_signature_verification: true,
