...
pub(in crate::execution::validation::state_transition::state_transitions::data_contract_create) trait DataContractCreatedStateTransitionAdvancedStructureValidationV1 {
    fn validate_advanced_structure_v1(&self, execution_context: &mut StateTransitionExecutionContext) -> Result<ConsensusValidationResult<StateTransitionAction>, Error>;
}

impl DataContractCreatedStateTransitionAdvancedStructureValidationV1
    ...
    mod validate_advanced_structure {
        ...
        fn should_return_invalid_result_if_contract_id_is_not_valid() {
            ...
            let result = transition
                .validate_advanced_structure_v1(&mut execution_context)
