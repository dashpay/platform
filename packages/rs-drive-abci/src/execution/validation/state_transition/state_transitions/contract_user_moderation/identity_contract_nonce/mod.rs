...
use crate::execution::validation::state_transition::contract_user_moderation::identity_contract_nonce::v0::ContractUserModerationStateTransitionIdentityContractNonceV0;
...
impl StateTransitionIdentityNonceValidationV0 for ContractUserModerationTransition {
    fn validate_identity_nonces(
            ...
            .nonce
        {
            ...
            Some(version) => Err(Error::Execution(ExecutionError::UnknownVersionMismatch {
                method: "contract user moderation transition: validate_identity_contract_nonce"
                    .to_string(),
