...
pub(in crate::execution::validation::state_transition::state_transitions::identity_create_from_shielded_pool) trait IdentityCreateFromShieldedPoolStateTransitionStateValidationV1
{
...
impl IdentityCreateFromShieldedPoolStateTransitionStateValidationV1
    for IdentityCreateFromShieldedPoolTransition
{
    fn validate_state_v1<C>(
        ...
        if key_state_validation_result.is_valid() {
            ...
            // A key-state validation failure: finalize the spend and credit the fallback address minus a
            ...
            let failure_action = UnshieldTransitionAction::V0(UnshieldTransitionActionV0 {
                ...
                // execution event reads this flag to apply its ops despite the attached validation
