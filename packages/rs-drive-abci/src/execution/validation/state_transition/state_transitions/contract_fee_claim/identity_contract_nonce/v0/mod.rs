...
pub(in crate::execution::validation::state_transition::state_transitions) trait ContractFeeClaimStateTransitionIdentityContractNonceV0
{
...
impl ContractFeeClaimStateTransitionIdentityContractNonceV0 for ContractFeeClaimTransition {
    /// The claimant's nonce for the contract, as a contract update's: read with its fee and
