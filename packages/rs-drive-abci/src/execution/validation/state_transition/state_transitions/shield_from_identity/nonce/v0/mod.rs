...
pub(in crate::execution::validation::state_transition::state_transitions) trait ShieldFromIdentityTransitionIdentityNonceV0
{
...
impl ShieldFromIdentityTransitionIdentityNonceV0 for ShieldFromIdentityTransition {
    fn validate_nonce_v0(
        &self,
        platform: &PlatformStateRef,
        block_info: &BlockInfo,
