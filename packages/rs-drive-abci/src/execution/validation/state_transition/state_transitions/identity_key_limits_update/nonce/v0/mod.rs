...
pub(in crate::execution::validation::state_transition::state_transitions) trait IdentityKeyLimitsUpdateTransitionIdentityNonceV0
{
...
impl IdentityKeyLimitsUpdateTransitionIdentityNonceV0 for IdentityKeyLimitsUpdateTransition {
    fn validate_nonce_v0(
        &self,
        platform: &PlatformStateRef,
        block_info: &BlockInfo,
