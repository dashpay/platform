// v1: Fixes bug where DECRYPTION case was incorrectly calling
// requires_identity_encryption_bounded_key() instead of requires_identity_decryption_bounded_key()
// for SingleContractDocumentType bounds validation.
                        ...
                        match document_type {
                            ...
                            Some(document_type) => {
                                match purpose {
                                    ...
                                    DECRYPTION => {
                                        // v1 fix: Use requires_identity_decryption_bounded_key() for DECRYPTION
                                        let Some(requirements) = document_type
                                            .requires_identity_decryption_bounded_key()
                                        else {
                                            return Ok(SimpleConsensusValidationResult::new_with_error(
