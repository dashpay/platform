//! v1 fixes the DECRYPTION branch of `SingleContractDocumentType` bounds validation:
//! v0 mistakenly called `requires_identity_encryption_bounded_key()` there. The rest of
//! the file is intentionally kept structurally identical to v0 to keep the diff auditable.
                        ...
                        match document_type {
                            ...
                            Some(document_type) => {
                                match purpose {
                                    ...
                                    DECRYPTION => {
                                        // v1 fix: v0 called requires_identity_encryption_bounded_key() here.
                                        let Some(requirements) = document_type
                                            .requires_identity_decryption_bounded_key()
                                        else {
                                            return Ok(SimpleConsensusValidationResult::new_with_error(
