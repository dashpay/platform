...
mod tests {
    ...
    mod has_advanced_structure_validation_with_state {
        use super::*;

        #[test]
        fn should_return_true_for_batch_identity_create_masternode_vote_and_address_funding() {
            ...
            for (name, st) in transitions {
                assert!(
                    st.has_advanced_structure_validation_with_state(),
                    "expected true for {}",
                    name
                );
            }
    ...
    mod requires_advanced_structure_validation_with_state_on_check_tx {
        use super::*;
        ...
        fn should_return_false_for_non_batch_transitions() {
            ...
            for (name, st) in transitions {
                assert!(
                    !st.requires_advanced_structure_validation_with_state_on_check_tx(),
                    "expected false for {}",
                    name
                );
            }
