...
fn test_query_historical_latest_platform_version() {
    ...
    assert_eq!(
        root_hash.as_slice(),
        vec![
            198, 240, 42, 199, 134, 177, 186, 144, 191, 122, 14, 217, 209, 140, 131, 144, 63, 232,
            141, 193, 177, 136, 200, 150, 42, 110, 151, 216, 85, 161, 78, 44
        ]
    );
    ...
    assert_eq!(
        root_hash.as_slice(),
        vec![
            244, 221, 68, 246, 214, 152, 18, 222, 186, 119, 187, 173, 119, 184, 146, 5, 27, 145,
            125, 63, 233, 17, 138, 99, 99, 177, 83, 145, 4, 8, 124, 155
        ]
    );
}
