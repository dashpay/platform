...
fn test_query_historical_latest_platform_version() {
    ...
    assert_eq!(
        root_hash.as_slice(),
        vec![
            133, 44, 161, 89, 108, 253, 236, 16, 93, 4, 122, 187, 249, 226, 208, 148, 47, 201, 46, 129, 167, 114, 63, 221, 133, 12, 1, 136, 135, 208, 226, 213
        ]
    );
    ...
    assert_eq!(
        root_hash.as_slice(),
        vec![
            124, 248, 167, 74, 81, 40, 160, 183, 10, 34, 119, 221, 225, 7, 207, 42, 42, 205, 8, 149, 201, 22, 165, 217, 125, 191, 152, 223, 66, 102, 9, 180
        ]
    );
}
