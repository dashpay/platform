...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!(
        ...
        serde_json::to_string_pretty(&serde_json::json!({
            ...
            "rewritten_index_entries": stats.rewritten_index_entries,
            "maximum_type_index_entries": stats.maximum_type_index_entries,
            "maximum_type_index_buffer_bound": stats.maximum_type_index_buffer_bound,
