...
mod tests {
    ...
    #[test]
    fn test_verify_group_infos_in_contract_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .group
            .verify_group_infos_in_contract = 255;

        let result = Drive::verify_group_infos_in_contract::<Vec<(GroupContractPosition, Group)>>(
            &[],
