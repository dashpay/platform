...
mod tests {
    ...
    #[test]
    fn test_verify_address_funds_trunk_query_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .address_funds
            .verify_address_funds_trunk_query = 255;

        let result = Drive::verify_address_funds_trunk_query(&[], &platform_version);
