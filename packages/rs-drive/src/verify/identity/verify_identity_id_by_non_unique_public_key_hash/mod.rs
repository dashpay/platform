...
impl Drive {
    ...
    pub fn verify_identity_id_by_non_unique_public_key_hash(
        ...
        {
            0 => Self::verify_identity_id_by_non_unique_public_key_hash_v0(
                proof,
                is_proof_subset,
                public_key_hash,
                after,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "verify_identity_id_by_non_unique_public_key_hash".to_string(),
...
mod tests {
    ...
    #[test]
    fn test_verify_identity_id_by_non_unique_public_key_hash_unknown_version() {
        ...
        platform_version
            ...
            .verify
            .identity
            .verify_identity_id_by_non_unique_public_key_hash = 255;

        let result = Drive::verify_identity_id_by_non_unique_public_key_hash(
            &[],
            false,
            [0u8; 20],
            None,
        ...
        assert!(
            matches!(result, Err(Error::Drive(DriveError::UnknownVersionMismatch { method, known_versions, received }))
                if method == "verify_identity_id_by_non_unique_public_key_hash" && known_versions == vec![0] && received == 255
            )
        );
    }
}
