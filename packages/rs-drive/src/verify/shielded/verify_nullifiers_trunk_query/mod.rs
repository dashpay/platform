...
mod tests {
    ...
    #[test]
    fn test_verify_nullifiers_trunk_query_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .shielded
            .verify_nullifiers_trunk_query = 255;

        let result = Drive::verify_nullifiers_trunk_query(&[], 0, None, &platform_version);
