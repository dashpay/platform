...
mod tests {
    ...
    #[test]
    fn test_verify_shielded_nullifiers_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .shielded
            .verify_shielded_nullifiers = 255;

        let result = Drive::verify_shielded_nullifiers(&[], &[], false, &platform_version);
