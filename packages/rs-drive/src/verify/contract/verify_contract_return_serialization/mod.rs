...
impl Drive {
    ...
    /// # Returns
    ///
    /// Returns a `Result` with a tuple of `RootHash` and `Option<(DataContract, Vec<u8>)>`. The `Option<(DataContract, Vec<u8>)>`
    /// represents the verified contract, and it's serialization if it exists.
    ///
    /// # Errors
    ///
    /// Returns an `Error` if:
    ...
    pub fn verify_contract_return_serialization(
        proof: &[u8],
        ...
        match platform_version
            ...
            .verify
            .contract
            .verify_contract_return_serialization
        {
            0 => Drive::verify_contract_return_serialization_v0(
                proof,
...
mod tests {
    ...
    #[test]
    fn test_verify_contract_return_serialization_unknown_version() {
        ...
        platform_version
            ...
            .verify
            .contract
            .verify_contract_return_serialization = 255;

        let result = Drive::verify_contract_return_serialization(
            &[],
            None,
            false,
            false,
