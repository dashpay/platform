...
mod tests {
    ...
    #[test]
    fn test_verify_total_credits_in_system_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .system
            .verify_total_credits_in_system = 255;

        let result = Drive::verify_total_credits_in_system(&[], 0, || Ok(0), 0, &platform_version);
