...
mod tests {
    ...
    #[test]
    fn test_verify_finalized_epoch_infos_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .system
            .verify_finalized_epoch_infos = 255;

        let result =
            Drive::verify_finalized_epoch_infos(&[], 0, false, 0, false, &platform_version);
