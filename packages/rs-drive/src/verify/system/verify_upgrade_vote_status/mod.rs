...
mod tests {
    ...
    #[test]
    fn test_verify_upgrade_vote_status_unknown_version_mismatch() {
        ...
        platform_version
            ...
            .verify
            .system
            .verify_upgrade_vote_status = 255;

        let result = Drive::verify_upgrade_vote_status(&[], None, 0, &platform_version);
