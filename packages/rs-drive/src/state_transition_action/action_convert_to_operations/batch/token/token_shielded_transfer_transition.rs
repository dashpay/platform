...
impl DriveHighLevelBatchOperationConverter for TokenShieldedTransferTransitionAction {
    ...
    fn into_high_level_batch_drive_operations<'b>(
            ...
            .token_shielded_transfer_transition
        {
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method:
                    "TokenShieldedTransferTransitionAction::into_high_level_batch_drive_operations"
                        .to_string(),
