...
use crate::util::batch::DriveOperation::GroupOperation;
...
impl DriveHighLevelBatchOperationConverter for TokenMintToPoolTransitionAction {
    fn into_high_level_batch_drive_operations<'b>(
            ...
            .token_mint_to_pool_transition
        {
            0 => {
                ...
                {
                    let event = TokenEvent::MintToPool(
                        self.amount(),
                        serialized_actions_digest(self.actions()).into(),
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "TokenMintToPoolTransitionAction::into_high_level_batch_drive_operations"
                    .to_string(),
