...
impl DriveHighLevelBatchOperationConverter for TokenOrderBuyLimitTransitionAction {
    fn into_high_level_batch_drive_operations<'b>(
            ...
            .token_mint_transition
        {
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method:
                    "TokenOrderBuyLimitTransitionAction::into_high_level_document_drive_operations"
                        .to_string(),
