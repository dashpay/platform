...
impl DriveHighLevelBatchOperationConverter for TokenBurnFromPoolTransitionAction {
    fn into_high_level_batch_drive_operations<'b>(
        ...
        match platform_version
            ...
            .token_burn_from_pool_transition
        {
            0 => {
                ...
                {
                    let event = TokenEvent::BurnFromPool(
                        self.amount(),
                ...
                if self.base().perform_action() {
                    ops.push(TokenOperation(TokenOperationType::TokenBurnFromPool {
                        token_id,
                        amount: self.amount(),
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "TokenBurnFromPoolTransitionAction::into_high_level_batch_drive_operations"
                    .to_string(),
