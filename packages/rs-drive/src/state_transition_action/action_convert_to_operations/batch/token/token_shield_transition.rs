...
impl DriveHighLevelBatchOperationConverter for TokenShieldTransitionAction {
    ...
    fn into_high_level_batch_drive_operations<'b>(
            ...
            .token_shield_transition
        {
            0 => {
                ...
                ops.push(TokenOperation(TokenOperationType::TokenShield {
                    token_id,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "TokenShieldTransitionAction::into_high_level_batch_drive_operations"
                    .to_string(),
