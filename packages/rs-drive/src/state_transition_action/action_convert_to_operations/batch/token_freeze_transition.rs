...
impl DriveHighLevelBatchOperationConverter for TokenFreezeTransitionAction {
    fn into_high_level_batch_drive_operations<'b>(
            ...
            .token_freeze_transition
        {
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "TokenFreezeTransitionAction::into_high_level_document_drive_operations"
                    .to_string(),
