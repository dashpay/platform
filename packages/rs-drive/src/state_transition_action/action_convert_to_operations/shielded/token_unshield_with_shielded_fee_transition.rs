...
impl DriveHighLevelOperationConverter for TokenUnshieldWithShieldedFeeTransitionAction {
    ...
    fn into_high_level_drive_operations<'a>(
        ...
        match platform_version
            ...
            .token_unshield_with_shielded_fee_transition
        {
            0 => match self {
                TokenUnshieldWithShieldedFeeTransitionAction::V0(v0) => {
                    let mut ops: Vec<DriveOperation<'a>> = Vec::new();
                    ops.push(TokenOperation(TokenOperationType::TokenUnshield {
                        token_id: v0.token_id,
                        recipient_id: v0.recipient_id,
                        amount: v0.amount,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method:
                    "TokenUnshieldWithShieldedFeeTransitionAction::into_high_level_drive_operations"
                        .to_string(),
