...
use dpp::state_transition::batch_transition::batched_transition::token_order_sell_limit_transition::v0::transition::TokenOrderSellLimitTransitionV0;
...
impl TokenOrderSellLimitTransitionActionV0 {
    /// Converts a `TokenOrderSellLimitTransitionV0` into a `TokenOrderSellLimitTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `value` - The `TokenOrderSellLimitTransitionV0` struct containing the transition data, including token amount and recipient.
    ...
    /// # Returns
    ///
    /// * `Result<ConsensusValidationResult<TokenOrderSellLimitTransitionActionV0>, Error>` - Returns the constructed `TokenOrderSellLimitTransitionActionV0` if successful,
    ...
    pub fn try_from_token_order_sell_limit_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: TokenOrderSellLimitTransitionV0,
        ...
        Error,
    > {
        Self::try_from_borrowed_token_order_sell_limit_transition_with_contract_lookup(
            drive,
            owner_id,
            &value,
    ...
    /// Converts a borrowed `TokenOrderSellLimitTransitionV0` into a `TokenOrderSellLimitTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `owner_id` - The identifier of the owner initiating the releasing transition. This is typically the identity
    ///   performing the transaction, such as the user's ID.
    /// * `value` - A reference to the `TokenOrderSellLimitTransitionV0` struct containing the transition data, including token
    ...
    //// # Returns
    ///
    /// * `Result<(ConsensusValidationResult<TokenOrderSellLimitTransitionActionV0>, FeeResult), Error>` - Returns a tuple containing the constructed
    ///   `TokenOrderSellLimitTransitionActionV0` and a `FeeResult` if successful. If an error occurs (e.g., missing data or
    ...
    pub fn try_from_borrowed_token_order_sell_limit_transition_with_contract_lookup(
        ...
        Error,
    > {
        let TokenOrderSellLimitTransitionV0 {
            base,
            order_id_entropy,
            token_amount,
            token_min_price,
        ...
        Ok((
            BatchedTransitionAction::TokenAction(TokenTransitionAction::OrderSellLimitAction(
                Self {
                    base,
                    order_id_entropy: *order_id_entropy,
                    token_amount: *token_amount,
                    token_min_price: *token_min_price,
                }
                .into(),
            ))
            .into(),
