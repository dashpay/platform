...
use dpp::state_transition::batch_transition::token_burn_from_pool_transition::TokenBurnFromPoolTransition;
use dpp::ProtocolError;
use grovedb::TransactionArg;
use platform_version::version::PlatformVersion;
use std::sync::Arc;

impl TokenBurnFromPoolTransitionAction {
    ...
    pub fn try_from_borrowed_token_burn_from_pool_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: &TokenBurnFromPoolTransition,
    ...
    > {
        match value {
            TokenBurnFromPoolTransition::V0(v0) => {
                TokenBurnFromPoolTransitionActionV0::try_from_borrowed_token_burn_from_pool_transition_with_contract_lookup(
                    drive,
                    owner_id,
                    v0,
