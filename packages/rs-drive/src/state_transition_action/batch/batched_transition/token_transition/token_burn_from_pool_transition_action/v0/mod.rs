...
/// The resolved `TokenBurnFromPool` batched transition.
#[derive(Debug, Clone)]
pub struct TokenBurnFromPoolTransitionActionV0 {
...
pub trait TokenBurnFromPoolTransitionActionAccessorsV0 {
...
impl TokenBurnFromPoolTransitionActionAccessorsV0 for TokenBurnFromPoolTransitionActionV0 {
    fn base(&self) -> &TokenBaseTransitionAction {
        &self.base
    }
