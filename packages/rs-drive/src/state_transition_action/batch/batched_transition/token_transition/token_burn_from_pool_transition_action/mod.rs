...
/// Versioned `TokenBurnFromPool` action.
#[derive(Debug, Clone, From)]
pub enum TokenBurnFromPoolTransitionAction {
    /// Version 0
    V0(TokenBurnFromPoolTransitionActionV0),
}

impl TokenBurnFromPoolTransitionActionAccessorsV0 for TokenBurnFromPoolTransitionAction {
