...
use dpp::state_transition::batch_transition::batched_transition::token_order_buy_limit_transition::v0::accessors::TokenOrderBuyLimitTransitionV0Methods;
use dpp::state_transition::batch_transition::batched_transition::token_order_buy_limit_transition::v0::transition::TokenOrderBuyLimitTransitionV0;
use dpp::state_transition::batch_transition::token_base_transition::token_base_transition_accessors::TokenBaseTransitionAccessors;
use platform_version::version::PlatformVersion;
use crate::drive::Drive;
use crate::error::Error;
use crate::state_transition_action::batch::batched_transition::BatchedTransitionAction;
use crate::state_transition_action::batch::batched_transition::token_transition::token_order_buy_limit_transition_action::v0::action::TokenOrderBuyLimitTransitionActionV0;
use crate::state_transition_action::batch::batched_transition::token_transition::TokenTransitionAction;
use crate::state_transition_action::system::bump_identity_data_contract_nonce_action::BumpIdentityDataContractNonceAction;

impl TokenOrderBuyLimitTransitionActionV0 {
    /// Converts a `TokenOrderBuyLimitTransitionV0` into a `TokenOrderBuyLimitTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `value` - The `TokenOrderBuyLimitTransitionV0` struct containing the transition data, including token amount and recipient.
    ...
    /// # Returns
    ///
    /// * `Result<ConsensusValidationResult<TokenOrderBuyLimitTransitionActionV0>, Error>` - Returns the constructed `TokenOrderBuyLimitTransitionActionV0` if successful,
    ///   or an error if any issue arises, such as missing data or an invalid state transition.
    #[allow(clippy::too_many_arguments)]
    pub fn try_from_token_order_buy_limit_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: TokenOrderBuyLimitTransitionV0,
        ...
        Error,
    > {
        Self::try_from_borrowed_token_order_buy_limit_transition_with_contract_lookup(
            drive,
            owner_id,
            &value,
    ...
    /// Converts a borrowed `TokenOrderBuyLimitTransitionV0` into a `TokenOrderBuyLimitTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `owner_id` - The identifier of the owner initiating the releasing transition. This is typically the identity
    ///   performing the transaction, such as the user's ID.
    /// * `value` - A reference to the `TokenOrderBuyLimitTransitionV0` struct containing the transition data, including token
    ...
    //// # Returns
    ///
    /// * `Result<(ConsensusValidationResult<TokenOrderBuyLimitTransitionActionV0>, FeeResult), Error>` - Returns a tuple containing the constructed
    ///   `TokenOrderBuyLimitTransitionActionV0` and a `FeeResult` if successful. If an error occurs (e.g., missing data or
    ///   invalid state transition), it returns an `Error`.
    ///
    #[allow(clippy::too_many_arguments)]
    pub fn try_from_borrowed_token_order_buy_limit_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: &TokenOrderBuyLimitTransitionV0,
        approximate_without_state_for_costs: bool,
    ...
    > {
        ...
        Ok((
            BatchedTransitionAction::TokenAction(TokenTransitionAction::OrderBuyLimitAction(
                Self {
                    base,
                    order_id_entropy: value.order_id_entropy(),
                    token_amount: value.token_amount(),
                    token_max_price: value.token_max_price(),
                }
                .into(),
            ))
            .into(),
