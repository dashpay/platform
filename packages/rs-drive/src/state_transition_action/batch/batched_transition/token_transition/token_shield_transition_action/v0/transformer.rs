...
use dpp::state_transition::batch_transition::token_shield_transition::v0::TokenShieldTransitionV0;
use dpp::ProtocolError;
use grovedb::TransactionArg;
use platform_version::version::PlatformVersion;
use std::sync::Arc;

impl TokenShieldTransitionActionV0 {
    ...
    > {
        ...
        Ok((
            BatchedTransitionAction::TokenAction(TokenTransitionAction::from(
                TokenShieldTransitionAction::V0(TokenShieldTransitionActionV0 {
                    base: base_action,
                    amount: *amount,
