...
use dpp::state_transition::batch_transition::batched_transition::token_order_cancel_transition::v0::accessors::TokenOrderCancelTransitionV0Methods;
use dpp::state_transition::batch_transition::batched_transition::token_order_cancel_transition::v0::transition::TokenOrderCancelTransitionV0;
...
impl TokenOrderCancelTransitionActionV0 {
    /// Converts a `TokenOrderCancelTransitionV0` into a `TokenOrderCancelTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `value` - The `TokenOrderCancelTransitionV0` struct containing the transition data, including token amount and recipient.
    ...
    /// # Returns
    ///
    /// * `Result<ConsensusValidationResult<TokenOrderCancelTransitionActionV0>, Error>` - Returns the constructed `TokenOrderCancelTransitionActionV0` if successful,
    ///   or an error if any issue arises, such as missing data or an invalid state transition.
    #[allow(clippy::too_many_arguments)]
    pub fn try_from_token_order_cancel_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: TokenOrderCancelTransitionV0,
        ...
        Error,
    > {
        Self::try_from_borrowed_token_order_cancel_transition_with_contract_lookup(
            drive,
            owner_id,
            &value,
    ...
    /// Converts a borrowed `TokenOrderCancelTransitionV0` into a `TokenOrderCancelTransitionActionV0` using the provided contract lookup.
    ///
    ...
    /// * `owner_id` - The identifier of the owner initiating the releasing transition. This is typically the identity
    ///   performing the transaction, such as the user's ID.
    /// * `value` - A reference to the `TokenOrderCancelTransitionV0` struct containing the transition data, including token
    ...
    //// # Returns
    ///
    /// * `Result<(ConsensusValidationResult<TokenOrderCancelTransitionActionV0>, FeeResult), Error>` - Returns a tuple containing the constructed
    ///   `TokenOrderCancelTransitionActionV0` and a `FeeResult` if successful. If an error occurs (e.g., missing data or
    ...
    > {
        ...
        Ok((
            BatchedTransitionAction::TokenAction(TokenTransitionAction::OrderCancelAction(
                Self {
                    base,
