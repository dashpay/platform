...
use dpp::state_transition::batch_transition::token_claim_to_pool_transition::TokenClaimToPoolTransition;
use dpp::ProtocolError;
use grovedb::TransactionArg;
use platform_version::version::PlatformVersion;
use std::sync::Arc;

impl TokenClaimToPoolTransitionAction {
    ...
    pub fn try_from_borrowed_token_claim_to_pool_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: &TokenClaimToPoolTransition,
    ...
    > {
        match value {
            TokenClaimToPoolTransition::V0(v0) => {
                TokenClaimToPoolTransitionActionV0::try_from_borrowed_token_claim_to_pool_transition_with_contract_lookup(
                    drive,
                    owner_id,
                    v0,
