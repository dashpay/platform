...
/// Versioned `TokenClaimToPool` action.
#[derive(Debug, Clone, From)]
pub enum TokenClaimToPoolTransitionAction {
    /// Version 0
    V0(TokenClaimToPoolTransitionActionV0),
}

impl TokenClaimToPoolTransitionActionAccessorsV0 for TokenClaimToPoolTransitionAction {
    ...
    fn distribution_info(&self) -> &TokenDistributionInfo {
        match self {
            Self::V0(v0) => v0.distribution_info(),
        }
    }
