...
/// The resolved `TokenMintToPool` batched transition.
#[derive(Debug, Clone)]
pub struct TokenMintToPoolTransitionActionV0 {
...
pub trait TokenMintToPoolTransitionActionAccessorsV0 {
...
impl TokenMintToPoolTransitionActionAccessorsV0 for TokenMintToPoolTransitionActionV0 {
    fn base(&self) -> &TokenBaseTransitionAction {
        &self.base
    }
