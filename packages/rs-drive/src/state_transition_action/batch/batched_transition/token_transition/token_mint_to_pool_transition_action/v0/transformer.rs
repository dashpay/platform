...
use dpp::state_transition::batch_transition::token_mint_to_pool_transition::v0::TokenMintToPoolTransitionV0;
use dpp::ProtocolError;
use grovedb::TransactionArg;
use platform_version::version::PlatformVersion;
use std::sync::Arc;

impl TokenMintToPoolTransitionActionV0 {
    ...
    pub fn try_from_borrowed_token_mint_to_pool_transition_with_contract_lookup(
        drive: &Drive,
        owner_id: Identifier,
        value: &TokenMintToPoolTransitionV0,
        ...
        Error,
    > {
        let TokenMintToPoolTransitionV0 {
            base,
            amount,
            actions,
            anchor,
        ...
        Ok((
            BatchedTransitionAction::TokenAction(TokenTransitionAction::from(
                TokenMintToPoolTransitionAction::V0(TokenMintToPoolTransitionActionV0 {
                    base: base_action,
                    amount: *amount,
