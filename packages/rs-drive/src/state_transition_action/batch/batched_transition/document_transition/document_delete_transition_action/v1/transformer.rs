...
use dpp::state_transition::batch_transition::batched_transition::document_delete_transition::DocumentDeleteTransitionV1;
...
use crate::state_transition_action::batch::batched_transition::document_transition::document_delete_transition_action::v1::DocumentDeleteTransitionActionV1;
...
impl DocumentDeleteTransitionActionV1 {
    /// try from borrowed — the V1 (indexOnly) mirror of the V0
    ...
    pub fn try_from_borrowed_document_delete_transition_with_contract_lookup(
        value: &DocumentDeleteTransitionV1,
        owner_id: Identifier,
        ...
        Error,
    > {
        let DocumentDeleteTransitionV1 { base, data } = value;
        ...
        Ok((
            BatchedTransitionAction::DocumentAction(DocumentTransitionAction::DeleteAction(
                DocumentDeleteTransitionActionV1 {
                    base,
                    data: data.clone(),
                }
                .into(),
