    ...
    pub fn try_from(
        ...
        match value {
            IdentityCreateTransition::V0(v0) => {
                Ok(IdentityCreateTransitionActionV0::try_from(v0, asset_lock_value_to_be_consumed)?.into())
            }
        }
    }
    ...
    pub fn try_from_borrowed(
        ...
        match value {
            IdentityCreateTransition::V0(v0) => Ok(
                IdentityCreateTransitionActionV0::try_from_borrowed(v0, asset_lock_value_to_be_consumed)?
                    .into(),
            ),
        }
    }
