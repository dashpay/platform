...
use dpp::state_transition::state_transitions::shielded::token_shielded_transfer_with_shielded_fee_transition::v0::TokenShieldedTransferWithShieldedFeeTransitionV0;

impl TokenShieldedTransferWithShieldedFeeTransitionActionV0 {
    /// Builds the v0 action from the v0 transition, the flat fee and the credit pool total
    pub fn try_from_transition(
        value: &TokenShieldedTransferWithShieldedFeeTransitionV0,
        fee_amount: Credits,
        ...
        let fee_notes: Vec<ShieldedActionNote> = value
            ...
            .map(ShieldedActionNote::from)
            .collect();
        ConsensusValidationResult::new_with_data(
            TokenShieldedTransferWithShieldedFeeTransitionActionV0 {
