...
use dpp::state_transition::data_contract_update_transition::{DataContractUpdateTransitionV0, DataContractUpdateTransitionV1};
...
impl BumpIdentityDataContractNonceActionV0 {
    ...
    /// from data contract update action v1
    ...
    /// from borrowed data contract update action v1
