...
use dpp::state_transition::data_contract_update_transition::{
    DataContractUpdateTransitionV0, DataContractUpdateTransitionV1,
};
...
impl BumpIdentityDataContractNonceActionV0 {
    ...
    /// from a delta-based data contract update
    pub fn from_data_contract_update_v1(value: DataContractUpdateTransitionV1) -> Self {
        let DataContractUpdateTransitionV1 {
            data_contract_id,
            owner_id,
            identity_contract_nonce,
            user_fee_increase,
    ...
    /// from a borrowed delta-based data contract update
    pub fn from_borrowed_data_contract_update_v1(value: &DataContractUpdateTransitionV1) -> Self {
        BumpIdentityDataContractNonceActionV0 {
    ...
    /// from a delta-based data contract update action
    pub fn from_data_contract_update_action_v1(
        value: DataContractUpdateTransitionActionV1,
    ) -> Self {
        let DataContractUpdateTransitionActionV1 {
            data_contract,
            identity_contract_nonce,
            user_fee_increase,
            ..
    ...
    /// from a borrowed delta-based data contract update action
    pub fn from_borrowed_data_contract_update_action_v1(
        value: &DataContractUpdateTransitionActionV1,
    ) -> Self {
        BumpIdentityDataContractNonceActionV0 {
            identity_id: value.data_contract.owner_id(),
            data_contract_id: value.data_contract.id(),
            identity_contract_nonce: value.identity_contract_nonce,
            user_fee_increase: value.user_fee_increase,
        }
    }
