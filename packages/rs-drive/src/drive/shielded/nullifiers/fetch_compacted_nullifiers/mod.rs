...
impl Drive {
    ...
    /// Proves compacted nullifier changes starting from a given block height.
    ///
    /// # Arguments
    ...
    /// # Returns
    /// A grovedb proof
    pub fn prove_compacted_nullifier_changes(
        &self,
        start_block_height: u64,
        limit: Option<u16>,
        transaction: TransactionArg,
        ...
        match platform_version
            ...
            .fetch_nullifiers
        {
            0 => self.prove_compacted_nullifier_changes_v0(
                start_block_height,
                limit,
                transaction,
                platform_version,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "prove_compacted_nullifier_changes".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
