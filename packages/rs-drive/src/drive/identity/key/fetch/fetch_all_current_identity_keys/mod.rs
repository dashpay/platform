...
impl Drive {
    ...
    pub fn fetch_all_current_identity_keys(
        ...
        match drive_version.methods.identity.keys.fetch.fetch_all_current_identity_keys {
            0 => self.fetch_all_current_identity_keys_v0(identity_id, transaction, drive_version),
    ...
    pub(crate) fn fetch_all_current_identity_keys_operations(
        ...
        match drive_version.methods.identity.keys.fetch.fetch_all_current_identity_keys {
            0 => self.fetch_all_current_identity_keys_operations_v0(identity_id, transaction, drive_operations, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
