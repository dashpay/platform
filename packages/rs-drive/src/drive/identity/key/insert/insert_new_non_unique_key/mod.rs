...
impl Drive {
    ...
    pub fn insert_new_non_unique_key_operations(
        ...
        match drive_version.methods.identity.keys.insert.insert_new_non_unique_key {
            0 => self.insert_new_non_unique_key_operations_v0(identity_id, identity_key, with_references, estimated_costs_only_with_layer_info, transaction, drive_operations, drive_version),
