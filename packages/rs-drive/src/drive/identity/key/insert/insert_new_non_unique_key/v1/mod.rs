...
impl Drive {
    /// Insert a new non-unique key into an identity operations. v1 also writes the remaining
    /// budget of a budgeted key; everything else is v0.
    #[allow(clippy::too_many_arguments)]
    pub(super) fn insert_new_non_unique_key_operations_v1(
        &self,
        identity_id: [u8; 32],
        ...
        // if the key is budgeted its whole budget is what remains of it
        self.insert_identity_key_budget_operations(
            identity_id,
            &identity_key,
            estimated_costs_only_with_layer_info,
            transaction,
