...
impl Drive {
    /// Insert a new key into an identity operations. v1 also writes the remaining budget of a
    /// budgeted key; everything else is v0.
    #[inline(always)]
    #[allow(clippy::too_many_arguments)]
    pub(super) fn insert_new_unique_key_operations_v1(
        &self,
        identity_id: [u8; 32],
