...
impl Drive {
    ...
    pub fn prove_identity_id_by_unique_public_key_hash(
        ...
        match drive_version.methods.identity.prove.prove_identity_id_by_unique_public_key_hash {
            0 => self.prove_identity_id_by_unique_public_key_hash_v0(public_key_hash, transaction, drive_version),
