...
impl Drive {
    ...
    pub fn has_unique_public_key_hash(
        ...
        match drive_version.methods.identity.fetch.public_key_hashes.has_unique_public_key_hash {
    ...
    pub(crate) fn has_unique_public_key_hash_operations(
        ...
        match drive_version.methods.identity.fetch.public_key_hashes.has_unique_public_key_hash {
            0 => self.has_unique_public_key_hash_operations_v0(public_key_hash, transaction, drive_operations, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
