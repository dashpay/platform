...
impl Drive {
    ...
    pub(crate) fn has_non_unique_public_key_hash_already_for_identity_operations(
        ...
        match drive_version.methods.identity.fetch.public_key_hashes.has_non_unique_public_key_hash_already_for_identity {
            0 => self.has_non_unique_public_key_hash_already_for_identity_operations_v0(public_key_hash, identity_id, transaction, drive_operations, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "has_non_unique_public_key_hash_already_for_identity_operations".to_string(),
