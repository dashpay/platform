...
impl Drive {
    ...
    pub fn has_non_unique_public_key_hash(
        ...
        match drive_version.methods.identity.fetch.public_key_hashes.has_non_unique_public_key_hash {
            0 => self.has_non_unique_public_key_hash_v0(public_key_hash, transaction, drive_version),
    ...
    pub(crate) fn has_non_unique_public_key_hash_operations(
        ...
        match drive_version.methods.identity.fetch.public_key_hashes.has_non_unique_public_key_hash_operations {
            0 => self.has_non_unique_public_key_hash_operations_v0(public_key_hash, transaction, drive_operations, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
