...
impl Drive {
    ...
    pub(in crate::drive::identity::contract_info) fn add_potential_contract_info_for_contract_bounded_key_v1(
        &self,
        identity_id: [u8; 32],
        ...
        if let Some(contract_bounds) = &identity_key.contract_bounds() {
            ...
            self.add_contract_info_operations_v1(
                identity_id,
                epoch,
                contract_apply_info,
    ...
    fn add_contract_info_operations_v1(
        &self,
        identity_id: [u8; 32],
        epoch: &Epoch,
