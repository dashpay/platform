...
pub(crate) fn group_root_path() -> [&'static [u8]; 1] {
    [Into::<&[u8; 1]>::into(RootTree::GroupActions)]
}

/// Group root path vector
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_root_path_vec() -> Vec<Vec<u8>> {
    vec![vec![RootTree::GroupActions as u8]]
}

/// Group path
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_contract_path(contract_id: &[u8]) -> [&[u8]; 2] {
    [Into::<&[u8; 1]>::into(RootTree::GroupActions), contract_id]
}

/// Group path vector
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_contract_path_vec(contract_id: &[u8]) -> Vec<Vec<u8>> {
    vec![vec![RootTree::GroupActions as u8], contract_id.to_vec()]
}

/// Group path
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_path<'a>(
    contract_id: &'a [u8],
...
/// Group action path
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_root_path<'a>(
    contract_id: &'a [u8],
    group_contract_position_bytes: &'a [u8],
) -> [&'a [u8]; 4] {
    [
...
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_root_path_vec(
    contract_id: &[u8],
    group_contract_position: GroupContractPosition,
) -> Vec<Vec<u8>> {
    vec![
...
/// Group path
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_path<'a>(
    contract_id: &'a [u8],
    group_contract_position_bytes: &'a [u8],
    action_id: &'a [u8],
) -> [&'a [u8]; 5] {
...
/// Group path vector
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_path_vec(
    contract_id: &[u8],
    group_contract_position: GroupContractPosition,
    action_id: &[u8],
) -> Vec<Vec<u8>> {
...
/// Group path
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_signers_path<'a>(
    contract_id: &'a [u8],
    group_contract_position_bytes: &'a [u8],
    action_id: &'a [u8],
) -> [&'a [u8]; 6] {
...
/// Group path vector
#[cfg(any(feature = "server", feature = "verify"))]
pub(crate) fn group_action_signers_path_vec(
    contract_id: &[u8],
    group_contract_position: GroupContractPosition,
    action_id: &[u8],
) -> Vec<Vec<u8>> {
