...
impl Drive {
    /// The operation Deducts from a prefunded specialized balance it's entire amount
    ///
    /// # Arguments
    ///
    ...
    pub fn empty_prefunded_specialized_balance_operations(
        &self,
        ...
        {
            0 => self.empty_prefunded_specialized_balance_operations_v0(
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "empty_prefunded_specialized_balance_operations".to_string(),
