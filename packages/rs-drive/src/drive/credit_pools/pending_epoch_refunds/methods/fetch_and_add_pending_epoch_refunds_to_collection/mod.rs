...
impl Drive {
    ...
    pub fn fetch_and_add_pending_epoch_refunds_to_collection(
        ...
        match drive_version.methods.credit_pools.pending_epoch_refunds.fetch_and_add_pending_epoch_refunds_to_collection {
            0 => self.fetch_and_add_pending_epoch_refunds_to_collection_v0(refunds_per_epoch, transaction),
