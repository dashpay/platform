...
impl Drive {
    ...
    pub(super) fn add_contract_suspension_v1(
        &self,
        ...
        let batch_operations = self.add_contract_suspension_operations_v1(
            contract_id,
            identity_id,
            until,
            reason,
    ...
    #[inline(always)]
    #[allow(clippy::too_many_arguments)]
    pub(super) fn add_contract_suspension_operations_v1(
        &self,
        contract_id: Identifier,
        identity_id: Identifier,
        until: TimestampMillis,
