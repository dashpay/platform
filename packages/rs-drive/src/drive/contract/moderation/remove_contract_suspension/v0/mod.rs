...
impl Drive {
    ...
    pub(super) fn remove_contract_suspension_v0(
        &self,
        ...
        let batch_operations = self.remove_contract_suspension_operations_v0(
            contract_id,
            identity_id,
            block_info,
    ...
    #[inline(always)]
    #[allow(clippy::too_many_arguments)]
    pub(super) fn remove_contract_suspension_operations_v0(
        &self,
        contract_id: Identifier,
        identity_id: Identifier,
        ...
        let list = ContractModerationList::Suspensions;
