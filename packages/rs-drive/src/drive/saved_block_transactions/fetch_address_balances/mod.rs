...
impl Drive {
    /// Fetches recent address balance changes starting from a given block height.
    ///
    /// # Arguments
    ...
    pub fn fetch_recent_address_balance_changes(
        &self,
        start_height: u64,
        limit: Option<u16>,
        ...
        {
            0 => self.fetch_recent_address_balance_changes_v0(
                start_height,
                limit,
                transaction,
                platform_version,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "fetch_recent_address_balance_changes".to_string(),
    ...
    /// Proves recent address balance changes starting from a given block height.
    ///
    /// # Arguments
    ...
    pub fn prove_recent_address_balance_changes(
        ...
        match platform_version
            ...
            .fetch_address_balances
        {
            0 => self.prove_recent_address_balance_changes_v0(
                start_height,
                limit,
                transaction,
                platform_version,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "prove_recent_address_balance_changes".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
