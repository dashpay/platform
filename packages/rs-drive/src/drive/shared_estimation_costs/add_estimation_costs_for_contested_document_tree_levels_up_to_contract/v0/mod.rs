    ...
    pub(in crate::drive) fn add_estimation_costs_for_contested_document_tree_levels_up_to_contract_v0<'a>(
        ...
        estimated_costs_only_with_layer_info.insert(
            ...
            EstimatedLayerInformation {
                ...
                estimated_layer_sizes: AllSubtrees(1, SomeSumTrees { sum_trees_weight: 1, non_sum_trees_weight: 2 }, None), 
            },
        );
        ...
        estimated_costs_only_with_layer_info.insert(
            KeyInfoPath::from_known_path(vote_contested_resource_active_polls_contract_tree_path(contract.id_ref().as_bytes())),
            EstimatedLayerInformation {
                is_sum_tree: false,
