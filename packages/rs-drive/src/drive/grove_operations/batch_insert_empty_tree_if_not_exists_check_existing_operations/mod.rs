...
impl Drive {
    ...
    pub fn batch_insert_empty_tree_if_not_exists_check_existing_operations<const N: usize>(
        ...
        match drive_version.grove_methods.batch.batch_insert_empty_tree_if_not_exists_check_existing_operations {
            0 => self.batch_insert_empty_tree_if_not_exists_check_existing_operations_v0(path_key_info, storage_flags, apply_type, transaction, drive_operations, drive_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "batch_insert_empty_tree_if_not_exists_check_existing_operations".to_string(),
