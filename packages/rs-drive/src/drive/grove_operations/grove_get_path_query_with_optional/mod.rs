...
use grovedb::{PathQuery, PathKeyOptionalElementTrio};
...
impl Drive {
    ...
    pub fn grove_get_path_query_with_optional(
        ...
        match drive_version.grove_methods.basic.grove_get_path_query_with_optional {
            0 => self.grove_get_path_query_with_optional_v0(path_query, transaction, drive_operations),
