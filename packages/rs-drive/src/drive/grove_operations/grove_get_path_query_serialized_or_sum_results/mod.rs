...
impl Drive {
    ...
    pub fn grove_get_path_query_serialized_or_sum_results(
        &self,
        ...
        {
            0 => self.grove_get_path_query_serialized_or_sum_results_v0(
                path_query,
                transaction,
                drive_operations,
            ),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "grove_get_path_query_serialized_or_sum_results".to_string(),
