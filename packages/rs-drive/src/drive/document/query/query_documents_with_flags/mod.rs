...
#[derive(From, Debug)]
pub enum QueryDocumentsWithFlagsOutcome {
    ...
    V0(QueryDocumentsWithFlagsOutcomeV0),
}
...
impl QueryDocumentsWithFlagsOutcomeV0Methods for QueryDocumentsWithFlagsOutcome {
    ...
    fn skipped(&self) -> u16 {
        match self {
            QueryDocumentsWithFlagsOutcome::V0(outcome) => outcome.skipped(),
        }
    }

    fn cost(&self) -> u64 {
        match self {
            QueryDocumentsWithFlagsOutcome::V0(outcome) => outcome.cost(),
        }
    }
}
...
impl Drive {
    ...
    pub fn query_documents_with_flags(
        &self,
