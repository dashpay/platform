...
impl Drive {
    ...
    pub fn add_reference_for_index_level_for_contract_operations(
        ...
        match drive_version.methods.document.insert.add_reference_for_index_level_for_contract_operations {
            0 => {
                self.add_reference_for_index_level_for_contract_operations_v0(
