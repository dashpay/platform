...
impl Drive {
    ...
    #[inline]
    pub(super) fn add_contested_indices_for_index_level_for_contract_operations_v0(
        &self,
        ...
        if let Some(index_type) = index_level.has_index_with_type() {
            self.add_contested_reference_for_index_level_for_contract_operations(
        ...
        for (name, sub_level) in index_level.sub_levels() {
            ...
            self.add_contested_indices_for_index_level_for_contract_operations(
                document_and_contract_info,
