...
impl Drive {
    ...
    pub fn validate_document_uniqueness(
        ...
        match drive_version.methods.document.index_uniqueness.validate_document_uniqueness {
            0 => self.validate_document_uniqueness_v0(contract, document_type, document, owner_id, allow_original, transaction, drive_version),
