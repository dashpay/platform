...
impl Drive {
    ...
    pub fn validate_document_replace_transition_action_uniqueness(
        ...
        match drive_version.methods.document.index_uniqueness.validate_document_replace_transition_action_uniqueness {
            0 => self.validate_document_replace_transition_action_uniqueness_v0(contract, document_type, document_replace_transition, owner_id, transaction, drive_version),
