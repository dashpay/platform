...
use crate::state_transition_action::batch::batched_transition::document_transition::document_create_transition_action::DocumentCreateTransitionAction;
...
impl Drive {
    ...
    pub fn validate_document_create_transition_action_uniqueness(
            ...
            .validate_document_create_transition_action_uniqueness
        {
            ...
            1 => self.validate_document_create_transition_action_uniqueness_v1(
                contract,
                document_type,
                document_create_transition,
                owner_id,
