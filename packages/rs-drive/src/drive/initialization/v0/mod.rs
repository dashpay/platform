...
mod tests {
    ...
    #[test]
    fn test_create_initial_state_structure_in_protocol_version_10() {
    ...
    // arrives with protocol version 14 (structure v4). Pinned so v13 stays reproducible.
    #[test]
    fn test_create_initial_state_structure_in_protocol_version_13() {
    ...
    #[test]
    fn test_initial_state_structure_proper_heights_in_protocol_version_11() {
    ...
    fn test_initial_state_structure_proper_heights_in_latest_protocol_version() {
        ...
        let proof = drive
            ...
            .expect("expected to get root elements");
        assert_eq!(proof.len(), 319); // 285 before ContractGroups (124) became this node's child in protocol version 14
