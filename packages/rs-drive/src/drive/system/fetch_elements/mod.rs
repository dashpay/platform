...
impl Drive {
    /// This function calls the versioned `fetch_elements`
    ...
    pub fn fetch_elements(
        ...
        match platform_version.drive.methods.fetch.fetch_elements {
            0 => self.fetch_elements_v0(path, keys, transaction, platform_version),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "fetch_elements".to_string(),
