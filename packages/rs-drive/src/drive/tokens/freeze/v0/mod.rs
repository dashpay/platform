use crate::drive::tokens::{token_identity_infos_path, token_identity_infos_path_vec};
...
impl Drive {
    pub(super) fn token_freeze_v0(
        ...
        self.token_freeze_add_to_operations_v0(
            token_id,
            frozen_identity_id,
            apply,
            transaction,
    ...
    pub(super) fn token_freeze_add_to_operations_v0(
        &self,
        token_id: Identifier,
        frozen_identity_id: Identifier,
        apply: bool,
        ...
        let batch_operations = self.token_freeze_operations_v0(
            token_id,
            frozen_identity_id,
    ...
    pub(super) fn token_freeze_operations_v0(
        &self,
        token_id: Identifier,
        frozen_identity_id: Identifier,
            ...
            .transpose()?
        {
            None => {
                let identity_token_info_bytes =
                    IdentityTokenInfo::new(true, platform_version)?.serialize_consume_to_bytes()?;
