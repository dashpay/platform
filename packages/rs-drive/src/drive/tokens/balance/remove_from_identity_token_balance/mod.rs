...
impl Drive {
    ...
    pub fn remove_from_identity_token_balance(
        ...
        {
            0 => self.remove_from_identity_token_balance_v0(
                token_id,
                identity_id,
                balance_to_remove,
                block_info,
    ...
    pub(crate) fn remove_from_identity_token_balance_operations(
        &self,
        token_id: [u8; 32],
        identity_id: [u8; 32],
        balance_to_remove: Credits,
        ...
        match platform_version
            ...
            .remove_from_identity_token_balance
        {
            0 => self.remove_from_identity_token_balance_operations_v0(
                token_id,
                identity_id,
                balance_to_remove,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "remove_from_identity_token_balance_operations".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
