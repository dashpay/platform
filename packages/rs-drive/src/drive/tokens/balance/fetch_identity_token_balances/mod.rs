...
impl Drive {
    ...
    pub fn fetch_identity_token_balances(
        &self,
        token_ids: &[[u8; 32]],
        identity_id: [u8; 32],
        ...
        {
            0 => self.fetch_identity_token_balances_v0(
                token_ids,
                identity_id,
                transaction,
                platform_version,
    ...
    pub fn fetch_identity_token_balances_with_costs(
        &self,
        token_ids: &[[u8; 32]],
        identity_id: [u8; 32],
        ...
        let value = self.fetch_identity_token_balances_operations(
            token_ids,
            identity_id,
            transaction,
    ...
    ///
    /// * `DriveError::UnknownVersionMismatch` - If the platform version does not support the requested operation.
    pub fn fetch_identity_token_balances_operations(
        &self,
        token_ids: &[[u8; 32]],
        identity_id: [u8; 32],
        transaction: TransactionArg,
        ...
        match platform_version
            ...
            .identity_token_balances
        {
            0 => self.fetch_identity_token_balances_operations_v0(
                token_ids,
                identity_id,
                transaction,
                drive_operations,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "fetch_identity_token_balances_operations".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
