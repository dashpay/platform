...
impl Drive {
    ...
    ///    - Depth: 2 levels deep.
    ///
    /// 3. **Token Direct Selling Root Path (`/0/0` or `/tokens/prices`)**:
    ...
    pub(super) fn add_estimation_costs_for_token_selling_prices_v0(
        ...
        estimated_costs_only_with_layer_info.insert(
            ...
            EstimatedLayerInformation {
                ...
                estimated_layer_sizes: AllItems(DEFAULT_HASH_SIZE_U8, 8, None),
            },
        );
    }
}
