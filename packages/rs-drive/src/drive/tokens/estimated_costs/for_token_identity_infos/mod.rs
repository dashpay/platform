...
impl Drive {
    /// Adds estimation costs for token identity infos changes based on the provided drive version.
    ///
    ...
    pub(crate) fn add_estimation_costs_for_token_identity_infos(
        token_id: [u8; 32],
        ...
        {
            0 => {
                Self::add_estimation_costs_for_token_identity_infos_v0(
                    token_id,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "add_estimation_costs_for_token_identity_infos".to_string(),
