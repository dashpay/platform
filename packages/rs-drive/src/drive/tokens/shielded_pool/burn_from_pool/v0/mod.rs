...
impl Drive {
    /// Version 0: record the nullifiers, append the change notes, debit the pool balance, then
    /// lower the total supply by the same amount.
    #[allow(clippy::too_many_arguments)]
    pub(super) fn token_burn_from_pool_operations_v0(
        &self,
        token_id: [u8; 32],
        amount: TokenAmount,
        nullifiers: &[[u8; 32]],
