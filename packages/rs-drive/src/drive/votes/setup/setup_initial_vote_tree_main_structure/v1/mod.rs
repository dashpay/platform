use crate::drive::votes::paths::{
    vote_contested_resource_tree_path_vec, vote_decisions_tree_path_vec, vote_root_path_vec,
    ACTIVE_POLLS_TREE_KEY, CONTESTED_RESOURCE_TREE_KEY, END_DATE_QUERIES_TREE_KEY,
    IDENTITY_VOTES_TREE_KEY, VOTE_DECISIONS_TREE_KEY,
};
...
impl Drive {
    /// Version 1 (protocol version 14) also creates the active polls and identity votes trees
    /// of the decisions branch, where yes/no vote polls live.
