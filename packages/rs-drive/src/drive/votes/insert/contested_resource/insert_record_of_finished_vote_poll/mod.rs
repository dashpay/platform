...
impl Drive {
    ...
    pub fn insert_record_of_finished_vote_poll(
        ...
        {
            0 => self.insert_record_of_finished_vote_poll_v0(
                vote_poll,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "insert_record_of_finished_vote_poll".to_string(),
    ...
    pub fn insert_record_of_finished_vote_poll_operations(
        &self,
        vote_poll: &ContestedDocumentResourceVotePollWithContractInfo,
        finalized_contested_document_vote_poll_stored_info: FinalizedContestedDocumentVotePollStoredInfo,
        platform_version: &PlatformVersion,
        ...
        match platform_version
            ...
            .insert_record_of_finished_vote_poll
        {
            0 => self.insert_record_of_finished_vote_poll_operations_v0(
                vote_poll,
                finalized_contested_document_vote_poll_stored_info,
                platform_version,
            ),
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "insert_record_of_finished_vote_poll_operations".to_string(),
                known_versions: vec![0],
                received: version,
            })),
        }
