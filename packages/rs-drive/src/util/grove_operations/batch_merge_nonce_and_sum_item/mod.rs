...
impl Drive {
    ...
    pub fn batch_merge_nonce_and_sum_item(
        &self,
        ...
        match drive_version
            .grove_methods
            .batch
            .batch_merge_nonce_and_sum_item
        {
            0 => self.batch_merge_nonce_and_sum_item_v0(
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "batch_merge_nonce_and_sum_item".to_string(),
