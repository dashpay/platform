...
impl Drive {
    ...
    pub fn grove_get_raw_item<B: AsRef<[u8]>>(
        &self,
        ...
        match drive_version.grove_methods.basic.grove_get_raw_item {
            0 => self.grove_get_raw_item_v0(
                path,
                key,
                direct_query_type,
                transaction,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "grove_get_raw_item".to_string(),
