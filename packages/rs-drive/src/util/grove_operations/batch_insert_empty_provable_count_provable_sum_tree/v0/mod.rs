...
impl Drive {
    ...
    pub(super) fn batch_insert_empty_provable_count_provable_sum_tree_v0<'a, 'c, P>(
        &'a self,
        path: P,
        ...
        match key_info {
            KeyRef(key) => {
                ...
                drive_operations.push(
                    LowLevelDriveOperation::for_known_path_key_empty_provable_count_provable_sum_tree(
                        path_items,
                        key.to_vec(),
                        storage_flags,
                    ),
            ...
            KeySize(key) => {
                drive_operations.push(
                    LowLevelDriveOperation::for_estimated_path_key_empty_provable_count_provable_sum_tree(
