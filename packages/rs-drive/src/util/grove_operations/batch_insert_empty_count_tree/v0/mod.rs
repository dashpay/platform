...
impl Drive {
    ...
    pub(super) fn batch_insert_empty_count_tree_v0<'a, 'c, P>(
        &'a self,
        path: P,
        ...
        match key_info {
            ...
            KeySize(key) => {
                drive_operations.push(
                    LowLevelDriveOperation::for_estimated_path_key_empty_count_tree(
...
mod tests {
    ...
    #[test]
    fn test_batch_insert_empty_count_tree_key_ref() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
            .batch_insert_empty_count_tree_v0(
                path.iter().copied(),
    ...
    #[test]
    fn test_batch_insert_empty_count_tree_key_size() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
    ...
    #[test]
    fn test_batch_insert_empty_count_tree_key() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
