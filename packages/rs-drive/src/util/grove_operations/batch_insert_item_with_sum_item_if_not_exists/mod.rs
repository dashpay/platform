...
impl Drive {
    ...
    /// This method dispatches to the appropriate version of the `batch_insert_item_with_sum_item_if_not_exists` function
    ...
    /// `batch_insert_item_with_sum_item_if_not_exists`. Currently, only version `0` is supported, which delegates to the function
    /// `batch_insert_item_with_sum_item_if_not_exists_v0`. If the drive version is not supported, an error is returned.
    ///
    ...
    pub fn batch_insert_item_with_sum_item_if_not_exists<const N: usize>(
        &self,
        ...
        {
            0 => self.batch_insert_item_with_sum_item_if_not_exists_v0(
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "batch_insert_item_with_sum_item_if_not_exists".to_string(),
