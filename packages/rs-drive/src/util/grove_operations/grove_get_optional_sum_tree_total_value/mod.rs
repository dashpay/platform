...
impl Drive {
    ...
    ///
    /// # Returns
    /// * `Ok(Option<i64>)` if the operation was successful, returning the total value of the sum tree if it exists.
    ...
    pub fn grove_get_optional_sum_tree_total_value<B: AsRef<[u8]>>(
        &self,
        ...
        {
            0 => self.grove_get_optional_sum_tree_total_value_v0(
                path,
                key,
                query_type,
                transaction,
            ...
            version => Err(Error::Drive(DriveError::UnknownVersionMismatch {
                method: "grove_get_optional_sum_tree_total_value".to_string(),
