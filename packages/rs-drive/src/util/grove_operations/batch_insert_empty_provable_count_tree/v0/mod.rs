...
impl Drive {
    ...
    pub(super) fn batch_insert_empty_provable_count_tree_v0<'a, 'c, P>(
        &'a self,
        path: P,
...
mod tests {
    ...
    #[test]
    fn test_batch_insert_empty_provable_count_tree_key_ref() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
            .batch_insert_empty_provable_count_tree_v0(
                path.iter().copied(),
    ...
    #[test]
    fn test_batch_insert_empty_provable_count_tree_key_size() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
    ...
    #[test]
    fn test_batch_insert_empty_provable_count_tree_key() {
        let drive = setup_drive(None);
        let mut ops = vec![];
        let path: &[&[u8]] = &[b"root"];
        drive
