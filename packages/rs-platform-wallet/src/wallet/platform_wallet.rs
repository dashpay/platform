...
pub struct PlatformWalletInfo {
    ...
    /// public key indices. Restored at load so a restore-from-Keychain
    /// doesn't strand a discovered contact. See
    /// [`PendingContactCrypto`](crate::changeset::PendingContactCrypto).
