...
impl CoreWallet {
    ...
    ///
    /// Derives the funding key at the DIP-13 registration path:
    ...
    ///
    /// Derives the funding key at the DIP-13 top-up path:
    ...
    /// Build an asset lock transaction using the given DIP-13 funding key path.
    ///
