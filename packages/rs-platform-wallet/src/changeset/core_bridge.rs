    ...
    P: PlatformWalletPersistence + ?Sized,
{
    ...
    } = wallet_batch;
    {
        ...
        // A returned result, success or failure, settles this wallet's outcome.
        // A panic never reaches this line, leaving the caller to freeze the
        // exact unknown-outcome set.
                ...
                if fault_and_freeze(
                    ...
                    log::error!(
                        "SYNC WATERMARK FROZEN: persister for wallet {} does not advertise \
                         ...
                         it, so the sync watermark is held back.",
