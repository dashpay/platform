...
<!-- Found-bug pin accounting is reconciled by the summary line below (28 Found-NNN matrix entries; 27 live after Found-006 retirement). Per-edit running tallies live in git history, not here. -->
Counts by priority: **P0: 10**, **P1: 32** (incl. CR-004 passing-as-regression + ID-002b + AL-001 + Found-024 + Found-025 + Found-031 + Found-032 + Found-033), **P2: 65** (incl. 25 P2 Found-bug pins), **DEFERRED: 1** (108 total index entries; 77 baseline + 30 Found-bug pins + 1 deferred placeholder).
