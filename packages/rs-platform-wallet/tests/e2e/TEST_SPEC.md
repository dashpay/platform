...
- **Priority**: P2
- **Status**: compile-only / not yet live-verified. The case is implemented and included in the e2e compile target, but no live network run has been performed against this code.
