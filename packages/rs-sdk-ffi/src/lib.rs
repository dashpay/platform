...
pub use platform_wallet_ffi::{
    // Core functions
    platform_wallet_ffi_init, platform_wallet_ffi_version,
    // PlatformWalletInfo functions
    platform_wallet_info_create_from_seed, platform_wallet_info_create_from_mnemonic,
    platform_wallet_info_get_identity_manager, platform_wallet_info_set_identity_manager,
    platform_wallet_info_destroy,
    // IdentityManager functions
    identity_manager_create, identity_manager_add_identity, identity_manager_remove_identity,
    identity_manager_get_identity, identity_manager_get_all_identity_ids,
    identity_manager_get_primary_identity_id, identity_manager_set_primary_identity,
    identity_manager_get_identity_count, identity_manager_destroy,
    // ManagedIdentity functions
    managed_identity_create_from_identity_bytes, managed_identity_get_id,
    managed_identity_get_balance, managed_identity_get_label, managed_identity_set_label,
    managed_identity_get_last_updated_balance_block_time,
    managed_identity_set_last_updated_balance_block_time,
    managed_identity_get_last_synced_keys_block_time, managed_identity_destroy,
    // Contact request functions
    contact_request_create, contact_request_get_sender_id, contact_request_get_recipient_id,
    contact_request_get_sender_key_index, contact_request_get_recipient_key_index,
    contact_request_get_account_reference, contact_request_get_encrypted_public_key,
    contact_request_get_created_at, contact_request_destroy,
    managed_identity_get_sent_contact_request, managed_identity_get_incoming_contact_request,
    ...
    established_contact_get_contact_identity_id, established_contact_get_alias,
    established_contact_set_alias, established_contact_clear_alias,
    established_contact_get_note, established_contact_set_note, established_contact_clear_note,
    established_contact_is_hidden, established_contact_hide, established_contact_unhide,
    established_contact_destroy, managed_identity_get_established_contact,
    // Utility functions
    platform_wallet_generate_random_identifier, platform_wallet_identifier_to_hex,
    platform_wallet_identifier_from_hex, platform_wallet_identifier_array_free,
    platform_wallet_string_free, platform_wallet_bytes_free, platform_wallet_ffi_error_free,
    // Types
    Handle, NULL_HANDLE, IdentifierBytes, IdentifierArray, NetworkType, BlockTime,
    PlatformWalletFFIResult, PlatformWalletFFIError,
};
