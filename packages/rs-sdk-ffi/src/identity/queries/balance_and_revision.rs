//! Identity balance and revision query operations

use dash_sdk::dpp::platform_value::string_encoding::Encoding;
use dash_sdk::dpp::prelude::Identifier;
use dash_sdk::platform::Fetch;
use dash_sdk::query_types::IdentityBalanceAndRevision;
...
#[no_mangle]
pub unsafe extern "C" fn dash_sdk_identity_fetch_balance_and_revision(
    ...
    let result: Result<String, FFIError> = wrapper.runtime.block_on(async {
        // Fetch identity balance and revision
        let balance_and_revision = IdentityBalanceAndRevision::fetch(&wrapper.sdk, id)
            .await
            .map_err(FFIError::from)?
            .ok_or_else(|| {
                FFIError::InternalError("Identity balance and revision not found".to_string())
            })?;

        // Return as JSON string
        Ok(format!(
            "{{\"balance\":{},\"revision\":{}}}",
            balance_and_revision.0, // balance
