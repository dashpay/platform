...
/**
 * Type aliases for Core SDK compatibility
 */
typedef FFIClientConfig CoreSDKConfig;
typedef FFIDashSpvClient CoreSDKClient;
...
int32_t dash_core_sdk_get_quorum_public_key(CoreSDKClient *client,
                                            uint32_t quorum_type,
                                            const uint8_t *quorum_hash,
                                            uint32_t core_chain_locked_height,
                                            uint8_t *public_key,
