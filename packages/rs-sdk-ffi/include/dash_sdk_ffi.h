...
// === Extracted Core SDK Type Definitions ===
...
typedef struct CoreSDKClient {
  uint8_t _placeholder[0];
} CoreSDKClient;

typedef struct CoreSDKConfig {
  uint8_t _placeholder[0];
} CoreSDKConfig;
...
typedef struct UnifiedSDKHandle {
  struct CoreSDKClient *core_client;
  void *_core_placeholder;
...
typedef struct UnifiedSDKConfig {
  ...
  struct CoreSDKConfig core_config;
...
struct CoreSDKClient *dash_core_sdk_create_client_testnet(void);

// Create a Core SDK client with mainnet config
//
// # Safety
// - Returns null on failure
struct CoreSDKClient *dash_core_sdk_create_client_mainnet(void);
...
// - Returns null on failure
struct CoreSDKClient *dash_core_sdk_create_client(const struct CoreSDKConfig *config);

// Destroy a Core SDK client
//
// # Safety
// - `client` must be a valid Core SDK client handle or null
void dash_core_sdk_destroy_client(struct CoreSDKClient *client);

// Start the Core SDK client (begin sync)
//
// # Safety
// - `client` must be a valid Core SDK client handle
int32_t dash_core_sdk_start(struct CoreSDKClient *client);

// Stop the Core SDK client
//
// # Safety
// - `client` must be a valid Core SDK client handle
int32_t dash_core_sdk_stop(struct CoreSDKClient *client);

// Sync Core SDK client to tip
//
// # Safety
// - `client` must be a valid Core SDK client handle
int32_t dash_core_sdk_sync_to_tip(struct CoreSDKClient *client);
...
FFISyncProgress *dash_core_sdk_get_sync_progress(struct CoreSDKClient *client);
...
FFISpvStats *dash_core_sdk_get_stats(struct CoreSDKClient *client);
...
int32_t dash_core_sdk_get_block_height(struct CoreSDKClient *client, uint32_t *height);
...
int32_t dash_core_sdk_watch_address(struct CoreSDKClient *client, const char *address);
...
// - `client` must be a valid Core SDK client handle
// - `address` must be a valid null-terminated C string
int32_t dash_core_sdk_unwatch_address(struct CoreSDKClient *client, const char *address);
...
FFIBalance *dash_core_sdk_get_total_balance(struct CoreSDKClient *client);
...
// - `client` must be a valid Core SDK client handle
// - `height` must point to a valid u32
int32_t dash_core_sdk_get_platform_activation_height(struct CoreSDKClient *client,
                                                     uint32_t *height);
...
int32_t dash_core_sdk_get_quorum_public_key(struct CoreSDKClient *client,
                                            uint32_t quorum_type,
                                            const uint8_t *quorum_hash,
                                            uint32_t core_chain_locked_height,
                                            uint8_t *public_key,
...
// # Safety
// - `client` must be a valid Core SDK client handle
struct CoreSDKHandle *dash_core_sdk_get_core_handle(struct CoreSDKClient *client);
...
int32_t dash_core_sdk_broadcast_transaction(struct CoreSDKClient *client,
...
// Get Core SDK version (when feature disabled)
const char *dash_core_sdk_version(void);
...
struct CoreSDKClient *dash_core_sdk_create_client(const struct CoreSDKConfig *_config);

void dash_core_sdk_destroy_client(struct CoreSDKClient *_client);

int32_t dash_core_sdk_start(struct CoreSDKClient *_client);

int32_t dash_core_sdk_stop(struct CoreSDKClient *_client);

int32_t dash_core_sdk_sync_to_tip(struct CoreSDKClient *_client);

int32_t dash_core_sdk_get_block_height(struct CoreSDKClient *_client, uint32_t *_height);

int32_t dash_core_sdk_watch_address(struct CoreSDKClient *_client, const char *_address);

int32_t dash_core_sdk_unwatch_address(struct CoreSDKClient *_client, const char *_address);

int32_t dash_core_sdk_get_platform_activation_height(struct CoreSDKClient *_client,
                                                     uint32_t *_height);

int32_t dash_core_sdk_get_quorum_public_key(struct CoreSDKClient *_client,
                                            uint32_t _quorum_type,
                                            const uint8_t *_quorum_hash,
                                            uint32_t _core_chain_locked_height,
                                            uint8_t *_public_key,
                                            uintptr_t _public_key_size);

int32_t dash_core_sdk_broadcast_transaction(struct CoreSDKClient *_client,
                                            const char *_transaction_hex);
...
// # Safety
// - `handle` must be a valid unified SDK handle
struct CoreSDKClient *dash_unified_sdk_get_core_client(struct UnifiedSDKHandle *handle);
