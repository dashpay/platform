...
describe('IdentityTopUpTransition', () => {
  ...
  describe('getters', () => {
    ...
    it('should allow to return identityIdentifier', () => {
      ...
      expect(transition.identityIdentifier.toBase58()).to.deep.equal('B7kcE1juMBWEWkuYRJhVdAE2e6RaevrGxRsa1DrLCpQH');
    });
  ...
  describe('setters', () => {
    ...
    it('should allow to set identityIdentifier', () => {
      ...
      expect(transition.identityIdentifier.toBase58()).to.deep.equal('777cE1juMBWEWkuYRJhVdAE2e6RaevrGxRsa1DrLCpQH');
    });
