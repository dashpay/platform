...
describe('Group', () => {
  ...
  describe('constructor', () => {
    ...
    it('should create Group with multiple members', () => {
      ...
      const members = {
        [memberId1.toBase58()]: 100,
        [memberId2.toBase58()]: 50,
      };
  ...
  describe('getters and setters', () => {
    it('should get and set members', () => {
      ...
      expect(fetchedMembers).to.be.an('object');
      expect(fetchedMembers[memberId.toBase58()]).to.equal(100);
    });
    ...
    it('should set member required power', () => {
      ...
      expect(updatedMembers[memberId.toBase58()]).to.equal(200);
    });
  });
