...
describe('ContestedDocumentVotePollWinnerInfo', () => {
  ...
  describe('toJSON()', () => {
    ...
    it('should serialize WonByIdentity to JSON matching fixture', () => {
      ...
      const json = info.toJSON();
      expect(json).to.deep.equal({ WonByIdentity: identityIdBase58 });
    });
  ...
  describe('fromJSON()', () => {
    it('should create NoWinner from JSON fixture and verify getters', () => {
      const restored = wasm.ContestedDocumentVotePollWinnerInfo.fromJSON('NoWinner');
    ...
    it('should create WonByIdentity from JSON fixture and verify getters', () => {
      ...
      const fixture = { WonByIdentity: identityIdBase58 };
    ...
    it('should create Locked from JSON fixture and verify getters', () => {
      const restored = wasm.ContestedDocumentVotePollWinnerInfo.fromJSON('Locked');
  ...
  describe('toObject()', () => {
    ...
    it('should serialize WonByIdentity to Object with Uint8Array', () => {
      ...
      expect(obj.WonByIdentity).to.be.instanceOf(Uint8Array);
      expect(Buffer.from(obj.WonByIdentity).toString('hex')).to.equal(identityIdHex);
    });
  ...
  describe('fromObject()', () => {
    it('should create NoWinner from Object fixture and verify getters', () => {
      const restored = wasm.ContestedDocumentVotePollWinnerInfo.fromObject('NoWinner');
    ...
    it('should create WonByIdentity from Object fixture and verify getters', () => {
      ...
      const fixture = { WonByIdentity: identityIdBytes };
