...
impl DocumentWasm {
    ...
    pub fn from_object(value: JsValue) -> WasmDppResult<DocumentWasm> {
    ...
    pub fn from_json(value: JsValue) -> WasmDppResult<DocumentWasm> {
    ...
    pub fn to_hex(
        ...
        Ok(encode(
            self.to_bytes(data_contract, platform_version)?
                .as_slice(),
            Hex,
        ))
    }
