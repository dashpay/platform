...
impl IdentityUpdateTransitionWasm {
    ...
    pub fn from_json(js_value: JsValue) -> WasmDppResult<IdentityUpdateTransitionWasm> {
        let json_value: JsonValue = serde_wasm_bindgen::from_value(js_value)
            .map_err(|e| WasmDppError::serialization(e.to_string()))?;
        let transition: IdentityUpdateTransition = serde_json::from_value(json_value)
            .map_err(|e| WasmDppError::serialization(e.to_string()))?;
        Ok(IdentityUpdateTransitionWasm(transition))
    }
    ...
    pub fn from_object(js_value: JsValue) -> WasmDppResult<IdentityUpdateTransitionWasm> {
        let transition: IdentityUpdateTransition = serde_wasm_bindgen::from_value(js_value)
            .map_err(|e| WasmDppError::serialization(e.to_string()))?;
        Ok(IdentityUpdateTransitionWasm(transition))
    }
}
