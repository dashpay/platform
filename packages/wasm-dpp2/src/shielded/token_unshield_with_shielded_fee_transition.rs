...
/**
 * Options for constructing a TokenUnshieldWithShieldedFeeTransition (identity-less unshield). Two Orchard
 * bundles: the token pool bundle and the credit pool fee bundle. There is no platform signature.
 */
export interface TokenUnshieldWithShieldedFeeTransitionOptions {
...
export interface TokenUnshieldWithShieldedFeeTransitionObject {
...
export interface TokenUnshieldWithShieldedFeeTransitionJSON {
    $formatVersion: string;
...
#[wasm_bindgen]
extern "C" {
    #[wasm_bindgen(typescript_type = "TokenUnshieldWithShieldedFeeTransitionOptions")]
    pub type TokenUnshieldWithShieldedFeeTransitionOptionsJs;

    #[wasm_bindgen(typescript_type = "TokenUnshieldWithShieldedFeeTransitionObject")]
    pub type TokenUnshieldWithShieldedFeeTransitionObjectJs;

    #[wasm_bindgen(typescript_type = "TokenUnshieldWithShieldedFeeTransitionJSON")]
    pub type TokenUnshieldWithShieldedFeeTransitionJSONJs;
}

/// Non-WASM-instance fields extracted from the constructor options via serde.
#[derive(Deserialize)]
#[serde(rename_all = "camelCase")]
struct TokenUnshieldWithShieldedFeeTransitionSimpleFields {
...
#[serde(transparent)]
#[wasm_bindgen(js_name = TokenUnshieldWithShieldedFeeTransition)]
pub struct TokenUnshieldWithShieldedFeeTransitionWasm(TokenUnshieldWithShieldedFeeTransition);

impl From<TokenUnshieldWithShieldedFeeTransition> for TokenUnshieldWithShieldedFeeTransitionWasm {
    fn from(v: TokenUnshieldWithShieldedFeeTransition) -> Self {
        TokenUnshieldWithShieldedFeeTransitionWasm(v)
    }
}

impl From<TokenUnshieldWithShieldedFeeTransitionWasm> for TokenUnshieldWithShieldedFeeTransition {
    fn from(v: TokenUnshieldWithShieldedFeeTransitionWasm) -> Self {
        v.0
    }
}

#[wasm_bindgen(js_class = TokenUnshieldWithShieldedFeeTransition)]
impl TokenUnshieldWithShieldedFeeTransitionWasm {
    #[wasm_bindgen(constructor)]
    pub fn new(
        options: TokenUnshieldWithShieldedFeeTransitionOptionsJs,
    ) -> WasmDppResult<TokenUnshieldWithShieldedFeeTransitionWasm> {
        ...
        let fields: TokenUnshieldWithShieldedFeeTransitionSimpleFields =
        ...
        Ok(TokenUnshieldWithShieldedFeeTransitionWasm(
    ...
    pub fn to_bytes(&self) -> WasmDppResult<Vec<u8>> {
        Ok(PlatformSerializable::serialize_to_bytes(
            &StateTransition::TokenUnshieldWithShieldedFee(self.0.clone()),
        )?)
    }
    ...
    pub fn from_bytes(bytes: Vec<u8>) -> WasmDppResult<TokenUnshieldWithShieldedFeeTransitionWasm> {
        let st = StateTransition::deserialize_from_bytes_untrusted(&bytes)?;
        match st {
            StateTransition::TokenUnshieldWithShieldedFee(inner) => Ok(inner.into()),
            _ => Err(WasmDppError::invalid_argument(
                "Invalid state transition type: expected TokenUnshieldWithShieldedFee",
            )),
        }
    }

    #[wasm_bindgen(js_name = "fromHex")]
    pub fn from_hex(hex: String) -> WasmDppResult<TokenUnshieldWithShieldedFeeTransitionWasm> {
        let bytes =
            decode(hex.as_str(), Hex).map_err(|e| WasmDppError::serialization(e.to_string()))?;
        TokenUnshieldWithShieldedFeeTransitionWasm::from_bytes(bytes)
    }
    ...
    pub fn to_state_transition(&self) -> StateTransitionWasm {
        StateTransition::TokenUnshieldWithShieldedFee(self.0.clone()).into()
    }
...
impl_wasm_conversions_inner!(
    TokenUnshieldWithShieldedFeeTransitionWasm,
    TokenUnshieldWithShieldedFeeTransition,
    TokenUnshieldWithShieldedFeeTransition,
    TokenUnshieldWithShieldedFeeTransitionObjectJs,
    TokenUnshieldWithShieldedFeeTransitionJSONJs
);
impl_wasm_type_info!(
    TokenUnshieldWithShieldedFeeTransitionWasm,
    TokenUnshieldWithShieldedFeeTransition
