...
//! - client-side proof verifiers (client side — they rebuild the
//!   rich query from the wire request so a proved response can be
//!   verified against exactly what was asked).
//!
