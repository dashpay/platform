...
describe('GroveDBStore', () => {
  ...
  describe('#put', () => {
    it('should store value', () => {
      ...
      const actualValue = groveDB.getSync(key);
    ...
    it('should store value in transaction', async () => {
      ...
      expect(transaction).to.be.instanceOf(GroveDBTransaction);
      ...
      const storedValue = groveDB.getSync(key);
  ...
  describe('#get', () => {
    ...
    it('should return stored value', () => {
      groveDB.batch().put(key, value).commitSync();
  ...
  describe('#createTransaction', () => {
    it('should create a transaction', () => {
      ...
      expect(result).to.be.instanceOf(GroveDBTransaction);
    });
  });
