...
describe('MerkDbInMemoryDecorator', () => {
  ...
  describe('#getSync', () => {
    ...
    it('should throw "key not found" if value was deleted in transaction', () => {
      ...
      merkDbInMemoryDecorator.deleted.set(key.toString(MerkDbInMemoryDecorator.KEY_ENCODING), key);
  ...
  describe('#put', () => {
    it('should put value into transaction', () => {
      ...
      merkDbInMemoryDecorator.deleted.set(keyString, key);
  ...
  describe('#persist', () => {
    it('should persist in memory data to merk db', () => {
      ...
      keysToRemove.forEach((keyToRemove) => {
        merkDbInMemoryDecorator.deleted.set(keyToRemove.toString('hex'), keyToRemove);
      });
