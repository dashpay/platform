...
//! that Burn / Mint use, decoded by `super::group_info::decode_group_info`.
//! Unlike Burn there is no `amount` — the action freezes the full
//! balance of `frozen_identity_id`.
...
pub unsafe extern "C" fn platform_wallet_token_freeze(
