...
// `PersistentDashpayIgnoredSender` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDashpayIgnoredSender {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV5.PersistentDashpayIgnoredSender> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV5.PersistentDashpayIgnoredSender> { row in
