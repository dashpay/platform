...
// `PersistentTokenBalance` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentTokenBalance {
...
extension DashSchemaV2.PersistentTokenBalance {
    static func predicate(tokenId: String, identityId: Data) -> Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId && balance.identityId == identityId
        }
    }

    static func predicate(identityId: Data) -> Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
            balance.identityId == identityId
        }
    }

    static func predicate(tokenId: String) -> Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
            balance.balance != 0
        }
    }

    static var frozenBalancesPredicate: Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
            balance.frozen == true
        }
    }

    static func needsSyncPredicate(olderThan date: Date) -> Predicate<DashSchemaV2.PersistentTokenBalance> {
        #Predicate<DashSchemaV2.PersistentTokenBalance> { balance in
