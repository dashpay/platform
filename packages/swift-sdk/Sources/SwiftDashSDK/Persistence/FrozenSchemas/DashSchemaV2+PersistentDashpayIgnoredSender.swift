...
// `PersistentDashpayIgnoredSender` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDashpayIgnoredSender {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV2.PersistentDashpayIgnoredSender> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV2.PersistentDashpayIgnoredSender> { row in
