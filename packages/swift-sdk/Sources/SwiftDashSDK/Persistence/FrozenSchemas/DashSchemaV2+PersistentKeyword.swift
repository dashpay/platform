...
// `PersistentKeyword` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentKeyword {
    static func predicate(keyword: String) -> Predicate<DashSchemaV2.PersistentKeyword> {
        #Predicate<DashSchemaV2.PersistentKeyword> { item in
            item.keyword.localizedStandardContains(keyword)
        }
    }

    static func predicate(contractId: String) -> Predicate<DashSchemaV2.PersistentKeyword> {
        #Predicate<DashSchemaV2.PersistentKeyword> { item in
