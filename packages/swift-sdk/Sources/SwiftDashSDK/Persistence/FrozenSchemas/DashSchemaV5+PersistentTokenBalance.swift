...
// `PersistentTokenBalance` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentTokenBalance {
...
extension DashSchemaV5.PersistentTokenBalance {
    static func predicate(tokenId: String, identityId: Data) -> Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId && balance.identityId == identityId
        }
    }

    static func predicate(identityId: Data) -> Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
            balance.identityId == identityId
        }
    }

    static func predicate(tokenId: String) -> Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
            balance.balance != 0
        }
    }

    static var frozenBalancesPredicate: Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
            balance.frozen == true
        }
    }

    static func needsSyncPredicate(olderThan date: Date) -> Predicate<DashSchemaV5.PersistentTokenBalance> {
        #Predicate<DashSchemaV5.PersistentTokenBalance> { balance in
