...
// `PersistentInvitation` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentInvitation {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV5.PersistentInvitation> {
        #Predicate<DashSchemaV5.PersistentInvitation> { entry in
