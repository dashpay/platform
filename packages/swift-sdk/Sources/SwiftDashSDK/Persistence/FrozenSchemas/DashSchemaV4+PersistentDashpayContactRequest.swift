...
// `PersistentDashpayContactRequest` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDashpayContactRequest {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV4.PersistentDashpayContactRequest> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV4.PersistentDashpayContactRequest> { row in
