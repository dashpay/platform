...
// `PersistentDPNSName` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDPNSName {
...
extension DashSchemaV4.PersistentDPNSName {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV4.PersistentDPNSName> {
        let target = identityId
        return #Predicate<DashSchemaV4.PersistentDPNSName> { name in
