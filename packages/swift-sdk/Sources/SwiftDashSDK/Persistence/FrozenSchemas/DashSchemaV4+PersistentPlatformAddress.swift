...
// `PersistentPlatformAddress` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentPlatformAddress {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV4.PersistentPlatformAddress> {
        #Predicate<DashSchemaV4.PersistentPlatformAddress> { entry in
            entry.walletId == walletId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV4.PersistentPlatformAddress> {
        #Predicate<DashSchemaV4.PersistentPlatformAddress> { entry in
            entry.balance > 0
        }
    }
