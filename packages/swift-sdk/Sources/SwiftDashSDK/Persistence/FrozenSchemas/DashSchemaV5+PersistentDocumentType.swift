...
// `PersistentDocumentType` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDocumentType {
    ...
    var persistentProperties: [DashSchemaV5.PersistentProperty]? {
