...
// `PersistentToken` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentToken {
...
extension DashSchemaV4.PersistentToken {
    func setLocalization(languageCode: String, singularForm: String, pluralForm: String, description: String? = nil) {
        ...
        localizations?[languageCode] = DashSchemaV4.TokenLocalization(
...
extension DashSchemaV4.PersistentToken {
    func getChangeControlRules(for type: ChangeControlRuleType) -> DashSchemaV4.ChangeControlRules? {
        switch type {
    ...
    func setChangeControlRules(_ rules: DashSchemaV4.ChangeControlRules, for type: ChangeControlRuleType) {
        switch type {
...
extension DashSchemaV4.PersistentToken {
    static func mintableTokensPredicate() -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.manualMintingRules != nil
        }
    }

    static func burnableTokensPredicate() -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.manualBurningRules != nil
        }
    }

    static func freezableTokensPredicate() -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.freezeRules != nil
        }
    }

    static func distributionTokensPredicate() -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.perpetualDistribution != nil || token.preProgrammedDistribution != nil
        }
    }

    static func pausedTokensPredicate() -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.isPaused == true
        }
    }

    static func tokensByContractPredicate(contractId: Data) -> Predicate<DashSchemaV4.PersistentToken> {
        #Predicate<DashSchemaV4.PersistentToken> { token in
            token.contractId == contractId
        }
    }

    static func tokensWithControlRulePredicate(rule: ControlRuleType) -> Predicate<DashSchemaV4.PersistentToken> {
        switch rule {
        case .manualMinting:
            return #Predicate<DashSchemaV4.PersistentToken> { token in
                token.manualMintingRules != nil
            }
        case .manualBurning:
            return #Predicate<DashSchemaV4.PersistentToken> { token in
