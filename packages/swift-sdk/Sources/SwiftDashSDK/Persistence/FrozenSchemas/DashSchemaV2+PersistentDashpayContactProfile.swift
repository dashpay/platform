...
// `PersistentDashpayContactProfile` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDashpayContactProfile {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV2.PersistentDashpayContactProfile> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV2.PersistentDashpayContactProfile> { row in
