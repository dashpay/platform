...
// `PersistentInvitation` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentInvitation {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV2.PersistentInvitation> {
        #Predicate<DashSchemaV2.PersistentInvitation> { entry in
