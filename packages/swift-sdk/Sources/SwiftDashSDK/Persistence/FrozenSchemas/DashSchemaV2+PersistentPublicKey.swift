...
// `PersistentPublicKey` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentPublicKey {
    ...
    static func from(_ publicKey: IdentityPublicKey, identityId: String) -> DashSchemaV2.PersistentPublicKey? {
        let boundsIds: [Data]?
        ...
        return DashSchemaV2.PersistentPublicKey(
