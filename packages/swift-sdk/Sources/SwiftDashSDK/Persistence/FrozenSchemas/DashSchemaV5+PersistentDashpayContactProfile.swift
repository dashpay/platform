...
// `PersistentDashpayContactProfile` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDashpayContactProfile {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV5.PersistentDashpayContactProfile> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV5.PersistentDashpayContactProfile> { row in
