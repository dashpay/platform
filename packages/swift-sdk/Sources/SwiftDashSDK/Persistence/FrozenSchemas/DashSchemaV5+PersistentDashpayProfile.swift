...
// `PersistentDashpayProfile` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDashpayProfile {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV5.PersistentDashpayProfile> {
        let target = identityId
        return #Predicate<DashSchemaV5.PersistentDashpayProfile> { profile in
