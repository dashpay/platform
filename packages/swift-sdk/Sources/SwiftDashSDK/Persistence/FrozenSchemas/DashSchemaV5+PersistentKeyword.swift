...
// `PersistentKeyword` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentKeyword {
    static func predicate(keyword: String) -> Predicate<DashSchemaV5.PersistentKeyword> {
        #Predicate<DashSchemaV5.PersistentKeyword> { item in
            item.keyword.localizedStandardContains(keyword)
        }
    }

    static func predicate(contractId: String) -> Predicate<DashSchemaV5.PersistentKeyword> {
        #Predicate<DashSchemaV5.PersistentKeyword> { item in
