...
// `PersistentPublicKey` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentPublicKey {
    ...
    static func from(_ publicKey: IdentityPublicKey, identityId: String) -> DashSchemaV5.PersistentPublicKey? {
        let boundsIds: [Data]?
        ...
        return DashSchemaV5.PersistentPublicKey(
