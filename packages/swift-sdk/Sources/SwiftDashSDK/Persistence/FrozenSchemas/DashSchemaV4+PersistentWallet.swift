...
// `PersistentWallet` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentWallet {
    var label: String {
...
extension DashSchemaV4.PersistentWallet {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV4.PersistentWallet> {
        #Predicate<DashSchemaV4.PersistentWallet> { $0.walletId == walletId }
    }

    static func predicate(
        walletGroupId: Data
    ) -> Predicate<DashSchemaV4.PersistentWallet> {
        #Predicate<DashSchemaV4.PersistentWallet> { $0.walletGroupId == walletGroupId }
    }
}
