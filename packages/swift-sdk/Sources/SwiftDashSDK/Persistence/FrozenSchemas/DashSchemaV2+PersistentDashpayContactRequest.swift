...
// `PersistentDashpayContactRequest` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDashpayContactRequest {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV2.PersistentDashpayContactRequest> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV2.PersistentDashpayContactRequest> { row in
