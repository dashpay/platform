...
// `PersistentDashpayContactProfile` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDashpayContactProfile {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV4.PersistentDashpayContactProfile> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV4.PersistentDashpayContactProfile> { row in
