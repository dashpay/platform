...
// `PersistentDocumentType` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDocumentType {
    ...
    var persistentProperties: [DashSchemaV4.PersistentProperty]? {
