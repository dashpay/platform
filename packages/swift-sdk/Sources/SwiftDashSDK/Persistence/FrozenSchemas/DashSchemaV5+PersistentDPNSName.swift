...
// `PersistentDPNSName` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDPNSName {
...
extension DashSchemaV5.PersistentDPNSName {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV5.PersistentDPNSName> {
        let target = identityId
        return #Predicate<DashSchemaV5.PersistentDPNSName> { name in
