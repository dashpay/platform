...
// `PersistentWallet` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentWallet {
    var label: String {
...
extension DashSchemaV2.PersistentWallet {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV2.PersistentWallet> {
        #Predicate<DashSchemaV2.PersistentWallet> { $0.walletId == walletId }
    }

    static func predicate(
        walletGroupId: Data
    ) -> Predicate<DashSchemaV2.PersistentWallet> {
        #Predicate<DashSchemaV2.PersistentWallet> { $0.walletGroupId == walletGroupId }
    }
}
