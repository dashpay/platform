...
// `PersistentToken` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentToken {
...
extension DashSchemaV2.PersistentToken {
    func setLocalization(languageCode: String, singularForm: String, pluralForm: String, description: String? = nil) {
        ...
        localizations?[languageCode] = DashSchemaV2.TokenLocalization(
...
extension DashSchemaV2.PersistentToken {
    func getChangeControlRules(for type: ChangeControlRuleType) -> DashSchemaV2.ChangeControlRules? {
        switch type {
...
extension DashSchemaV2.PersistentToken {
    static func mintableTokensPredicate() -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.manualMintingRules != nil
        }
    }

    static func burnableTokensPredicate() -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.manualBurningRules != nil
        }
    }

    static func freezableTokensPredicate() -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.freezeRules != nil
        }
    }

    static func distributionTokensPredicate() -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.perpetualDistribution != nil || token.preProgrammedDistribution != nil
        }
    }

    static func pausedTokensPredicate() -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.isPaused == true
        }
    }

    static func tokensByContractPredicate(contractId: Data) -> Predicate<DashSchemaV2.PersistentToken> {
        #Predicate<DashSchemaV2.PersistentToken> { token in
            token.contractId == contractId
        }
    }

    static func tokensWithControlRulePredicate(rule: ControlRuleType) -> Predicate<DashSchemaV2.PersistentToken> {
        switch rule {
        case .manualMinting:
            return #Predicate<DashSchemaV2.PersistentToken> { token in
                token.manualMintingRules != nil
            }
        case .manualBurning:
            return #Predicate<DashSchemaV2.PersistentToken> { token in
