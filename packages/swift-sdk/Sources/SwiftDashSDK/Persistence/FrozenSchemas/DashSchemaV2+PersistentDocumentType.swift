...
// `PersistentDocumentType` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDocumentType {
    ...
    var persistentProperties: [DashSchemaV2.PersistentProperty]? {
