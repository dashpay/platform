...
// `PersistentAssetLock` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentAssetLock {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV4.PersistentAssetLock> {
        #Predicate<DashSchemaV4.PersistentAssetLock> { entry in
    ...
    ) -> Predicate<DashSchemaV4.PersistentAssetLock> {
        let identityIndexRaw = Int32(bitPattern: identityIndex)
        return #Predicate<DashSchemaV4.PersistentAssetLock> { entry in
