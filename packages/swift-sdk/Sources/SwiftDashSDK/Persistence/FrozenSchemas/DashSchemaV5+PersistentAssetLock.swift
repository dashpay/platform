...
// `PersistentAssetLock` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentAssetLock {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV5.PersistentAssetLock> {
        #Predicate<DashSchemaV5.PersistentAssetLock> { entry in
    ...
    ) -> Predicate<DashSchemaV5.PersistentAssetLock> {
        let identityIndexRaw = Int32(bitPattern: identityIndex)
        return #Predicate<DashSchemaV5.PersistentAssetLock> { entry in
