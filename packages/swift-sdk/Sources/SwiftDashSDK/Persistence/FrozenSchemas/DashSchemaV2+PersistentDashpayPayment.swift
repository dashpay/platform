...
// `PersistentDashpayPayment` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDashpayPayment {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV2.PersistentDashpayPayment> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV2.PersistentDashpayPayment> { row in
