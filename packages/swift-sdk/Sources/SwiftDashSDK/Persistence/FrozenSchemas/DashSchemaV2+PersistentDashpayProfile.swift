...
// `PersistentDashpayProfile` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDashpayProfile {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV2.PersistentDashpayProfile> {
        let target = identityId
        return #Predicate<DashSchemaV2.PersistentDashpayProfile> { profile in
