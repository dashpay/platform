...
// `PersistentPublicKey` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentPublicKey {
    ...
    static func from(_ publicKey: IdentityPublicKey, identityId: String) -> DashSchemaV4.PersistentPublicKey? {
        let boundsIds: [Data]?
        ...
        return DashSchemaV4.PersistentPublicKey(
