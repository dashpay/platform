...
// `PersistentPlatformAddress` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentPlatformAddress {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV5.PersistentPlatformAddress> {
        #Predicate<DashSchemaV5.PersistentPlatformAddress> { entry in
            entry.walletId == walletId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV5.PersistentPlatformAddress> {
        #Predicate<DashSchemaV5.PersistentPlatformAddress> { entry in
            entry.balance > 0
        }
    }
