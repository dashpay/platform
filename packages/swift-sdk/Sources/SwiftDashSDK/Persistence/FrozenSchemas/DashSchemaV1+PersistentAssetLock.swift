...
// `PersistentAssetLock` exactly as schema DashSchemaV1 registered it, generated by
// scripts/freeze_schema_models.py from the live model at commit 7127c38566.
...
extension DashSchemaV1.PersistentAssetLock {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV1.PersistentAssetLock> {
        #Predicate<DashSchemaV1.PersistentAssetLock> { entry in
    ...
    ) -> Predicate<DashSchemaV1.PersistentAssetLock> {
        let identityIndexRaw = Int32(bitPattern: identityIndex)
        return #Predicate<DashSchemaV1.PersistentAssetLock> { entry in
