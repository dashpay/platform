...
// `PersistentDPNSName` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentDPNSName {
...
extension DashSchemaV2.PersistentDPNSName {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV2.PersistentDPNSName> {
        let target = identityId
        return #Predicate<DashSchemaV2.PersistentDPNSName> { name in
