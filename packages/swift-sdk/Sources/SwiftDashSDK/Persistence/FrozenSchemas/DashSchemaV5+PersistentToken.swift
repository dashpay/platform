...
// `PersistentToken` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentToken {
...
extension DashSchemaV5.PersistentToken {
    func setLocalization(languageCode: String, singularForm: String, pluralForm: String, description: String? = nil) {
        ...
        localizations?[languageCode] = DashSchemaV5.TokenLocalization(
...
extension DashSchemaV5.PersistentToken {
    func getChangeControlRules(for type: ChangeControlRuleType) -> DashSchemaV5.ChangeControlRules? {
        switch type {
    ...
    func setChangeControlRules(_ rules: DashSchemaV5.ChangeControlRules, for type: ChangeControlRuleType) {
        switch type {
...
extension DashSchemaV5.PersistentToken {
    static func mintableTokensPredicate() -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.manualMintingRules != nil
        }
    }

    static func burnableTokensPredicate() -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.manualBurningRules != nil
        }
    }

    static func freezableTokensPredicate() -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.freezeRules != nil
        }
    }

    static func distributionTokensPredicate() -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.perpetualDistribution != nil || token.preProgrammedDistribution != nil
        }
    }

    static func pausedTokensPredicate() -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.isPaused == true
        }
    }

    static func tokensByContractPredicate(contractId: Data) -> Predicate<DashSchemaV5.PersistentToken> {
        #Predicate<DashSchemaV5.PersistentToken> { token in
            token.contractId == contractId
        }
    }

    static func tokensWithControlRulePredicate(rule: ControlRuleType) -> Predicate<DashSchemaV5.PersistentToken> {
        switch rule {
        case .manualMinting:
            return #Predicate<DashSchemaV5.PersistentToken> { token in
                token.manualMintingRules != nil
            }
        case .manualBurning:
            return #Predicate<DashSchemaV5.PersistentToken> { token in
