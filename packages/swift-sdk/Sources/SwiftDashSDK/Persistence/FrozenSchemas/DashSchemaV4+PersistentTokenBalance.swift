...
// `PersistentTokenBalance` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentTokenBalance {
...
extension DashSchemaV4.PersistentTokenBalance {
    static func predicate(tokenId: String, identityId: Data) -> Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId && balance.identityId == identityId
        }
    }

    static func predicate(identityId: Data) -> Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
            balance.identityId == identityId
        }
    }

    static func predicate(tokenId: String) -> Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
            balance.tokenId == tokenId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
            balance.balance != 0
        }
    }

    static var frozenBalancesPredicate: Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
            balance.frozen == true
        }
    }

    static func needsSyncPredicate(olderThan date: Date) -> Predicate<DashSchemaV4.PersistentTokenBalance> {
        #Predicate<DashSchemaV4.PersistentTokenBalance> { balance in
