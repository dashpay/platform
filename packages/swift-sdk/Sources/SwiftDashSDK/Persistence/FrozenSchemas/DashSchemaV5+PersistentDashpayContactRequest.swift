...
// `PersistentDashpayContactRequest` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDashpayContactRequest {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV5.PersistentDashpayContactRequest> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV5.PersistentDashpayContactRequest> { row in
