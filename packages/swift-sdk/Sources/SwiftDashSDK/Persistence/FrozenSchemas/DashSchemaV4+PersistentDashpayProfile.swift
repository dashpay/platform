...
// `PersistentDashpayProfile` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDashpayProfile {
    static func predicate(identityId: Data) -> Predicate<DashSchemaV4.PersistentDashpayProfile> {
        let target = identityId
        return #Predicate<DashSchemaV4.PersistentDashpayProfile> { profile in
