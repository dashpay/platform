...
// `PersistentDashpayPayment` exactly as schema DashSchemaV5 registered it, generated by
...
extension DashSchemaV5.PersistentDashpayPayment {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV5.PersistentDashpayPayment> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV5.PersistentDashpayPayment> { row in
