...
// `PersistentPlatformAddress` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentPlatformAddress {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV2.PersistentPlatformAddress> {
        #Predicate<DashSchemaV2.PersistentPlatformAddress> { entry in
            entry.walletId == walletId
        }
    }

    static var nonZeroBalancesPredicate: Predicate<DashSchemaV2.PersistentPlatformAddress> {
        #Predicate<DashSchemaV2.PersistentPlatformAddress> { entry in
            entry.balance > 0
        }
    }
