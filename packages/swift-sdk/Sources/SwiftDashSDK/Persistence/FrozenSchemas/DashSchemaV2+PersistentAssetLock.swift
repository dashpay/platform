...
// `PersistentAssetLock` exactly as schema DashSchemaV2 registered it, generated by
...
extension DashSchemaV2.PersistentAssetLock {
    static func predicate(walletId: Data) -> Predicate<DashSchemaV2.PersistentAssetLock> {
        #Predicate<DashSchemaV2.PersistentAssetLock> { entry in
    ...
    ) -> Predicate<DashSchemaV2.PersistentAssetLock> {
        let identityIndexRaw = Int32(bitPattern: identityIndex)
        return #Predicate<DashSchemaV2.PersistentAssetLock> { entry in
