...
// `PersistentDashpayPayment` exactly as schema DashSchemaV4 registered it, generated by
...
extension DashSchemaV4.PersistentDashpayPayment {
    static func predicate(
        ownerIdentityId: Data
    ) -> Predicate<DashSchemaV4.PersistentDashpayPayment> {
        let target = ownerIdentityId
        return #Predicate<DashSchemaV4.PersistentDashpayPayment> { row in
