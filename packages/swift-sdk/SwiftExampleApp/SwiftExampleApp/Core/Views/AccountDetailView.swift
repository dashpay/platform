...
struct AccountDetailView: View {
    ...
    private var shouldShowPrivateKeyButton: Bool {
        ...
        case FFI_ACCOUNT_TYPE_STANDARD_BIP44, FFI_ACCOUNT_TYPE_STANDARD_BIP32, FFI_ACCOUNT_TYPE_COIN_JOIN:
            ...
            return false
        case FFI_ACCOUNT_TYPE_IDENTITY_REGISTRATION, FFI_ACCOUNT_TYPE_IDENTITY_TOP_UP, FFI_ACCOUNT_TYPE_IDENTITY_TOP_UP_NOT_BOUND_TO_IDENTITY, FFI_ACCOUNT_TYPE_IDENTITY_INVITATION,
             FFI_ACCOUNT_TYPE_PROVIDER_VOTING_KEYS, FFI_ACCOUNT_TYPE_PROVIDER_OWNER_KEYS, FFI_ACCOUNT_TYPE_PROVIDER_OPERATOR_KEYS, FFI_ACCOUNT_TYPE_PROVIDER_PLATFORM_KEYS:
