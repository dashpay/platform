...
@class PlatformFilterV0_AllEvents;
@class PlatformFilterV0_BlockCommitted;
@class PlatformFilterV0_StateTransitionResultFilter;
...
/**
 * Criteria that must be met by platform event to be propagated to the user.
 **/
...
@property(nonatomic, readwrite, strong, null_resettable) PlatformFilterV0_AllEvents *all;

/** subscribe to BlockCommitted events only */
@property(nonatomic, readwrite, strong, null_resettable) PlatformFilterV0_BlockCommitted *blockCommitted;

/** subscribe to StateTransitionResult events (optionally filtered by */
@property(nonatomic, readwrite, strong, null_resettable) PlatformFilterV0_StateTransitionResultFilter *stateTransitionResult;
...
/**
 * Include all events generated by the Platform; experimental
 **/
GPB_FINAL @interface PlatformFilterV0_AllEvents : GPBMessage
...
typedef GPB_ENUM(PlatformFilterV0_StateTransitionResultFilter_FieldNumber) {
  PlatformFilterV0_StateTransitionResultFilter_FieldNumber_TxHash = 1,
};

/**
 * Filter for StateTransitionResult events, by state transition hash
 **/
GPB_FINAL @interface PlatformFilterV0_StateTransitionResultFilter : GPBMessage
