...
pub struct GetEvonodesProposedEpochBlocksByIdsRequest {
    ...
    pub version: ::core::option::Option<
        get_evonodes_proposed_epoch_blocks_by_ids_request::Version,
    >,
}
...
pub struct GetEvonodesProposedEpochBlocksResponse {
    ...
    pub version: ::core::option::Option<
        get_evonodes_proposed_epoch_blocks_response::Version,
    >,
}
...
pub mod get_evonodes_proposed_epoch_blocks_response {
    ...
    pub struct GetEvonodesProposedEpochBlocksResponseV0 {
        ...
        pub result: ::core::option::Option<
            get_evonodes_proposed_epoch_blocks_response_v0::Result,
        >,
    }
    ...
    pub mod get_evonodes_proposed_epoch_blocks_response_v0 {
        ...
        pub struct EvonodesProposedBlocks {
            #[prost(message, repeated, tag = "1")]
            pub evonodes_proposed_block_counts: ::prost::alloc::vec::Vec<
                EvonodeProposedBlocks,
            >,
        }
        #[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
        #[cfg_attr(feature = "serde", serde(rename_all = "snake_case"))]
...
pub struct GetEvonodesProposedEpochBlocksByRangeRequest {
    ...
    pub version: ::core::option::Option<
        get_evonodes_proposed_epoch_blocks_by_range_request::Version,
    >,
}
...
pub struct GetIdentityByNonUniquePublicKeyHashRequest {
    #[prost(
        oneof = "get_identity_by_non_unique_public_key_hash_request::Version",
        tags = "1"
    )]
    pub version: ::core::option::Option<
        get_identity_by_non_unique_public_key_hash_request::Version,
    >,
}
/// Nested message and enum types in `GetIdentityByNonUniquePublicKeyHashRequest`.
pub mod get_identity_by_non_unique_public_key_hash_request {
    ...
    pub struct GetIdentityByNonUniquePublicKeyHashRequestV0 {
        ...
        pub start_after: ::core::option::Option<::prost::alloc::vec::Vec<u8>>,
        #[prost(bool, tag = "3")]
        pub prove: bool,
    }
    #[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
...
pub struct GetIdentityByNonUniquePublicKeyHashResponse {
    #[prost(
        oneof = "get_identity_by_non_unique_public_key_hash_response::Version",
        tags = "1"
    )]
    pub version: ::core::option::Option<
        get_identity_by_non_unique_public_key_hash_response::Version,
    >,
}
/// Nested message and enum types in `GetIdentityByNonUniquePublicKeyHashResponse`.
pub mod get_identity_by_non_unique_public_key_hash_response {
    ...
    pub struct GetIdentityByNonUniquePublicKeyHashResponseV0 {
        ...
        pub metadata: ::core::option::Option<super::ResponseMetadata>,
        #[prost(
            oneof = "get_identity_by_non_unique_public_key_hash_response_v0::Result",
            tags = "1, 2"
        )]
        pub result: ::core::option::Option<
            get_identity_by_non_unique_public_key_hash_response_v0::Result,
        >,
    }
    /// Nested message and enum types in `GetIdentityByNonUniquePublicKeyHashResponseV0`.
    pub mod get_identity_by_non_unique_public_key_hash_response_v0 {
        ...
        pub struct IdentityProvedResponse {
            ...
            pub grovedb_identity_public_key_hash_proof: ::core::option::Option<
                super::super::Proof,
            >,
            /// A hack, we return 2 proofs
            #[prost(bytes = "vec", optional, tag = "2")]
            pub identity_proof_bytes: ::core::option::Option<
    ...
    pub enum Version {
        #[prost(message, tag = "1")]
        V0(GetIdentityByNonUniquePublicKeyHashResponseV0),
    }
}
#[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "snake_case"))]
...
pub mod get_identities_token_balances_response {
    ...
    pub struct GetIdentitiesTokenBalancesResponseV0 {
        ...
        pub result: ::core::option::Option<
            get_identities_token_balances_response_v0::Result,
        >,
    }
    ...
    pub mod get_identities_token_balances_response_v0 {
        ...
        pub struct IdentityTokenBalances {
            ...
            #[prost(message, repeated, tag = "1")]
            pub identity_token_balances: ::prost::alloc::vec::Vec<
...
pub mod get_identities_token_infos_response {
    ...
    pub struct GetIdentitiesTokenInfosResponseV0 {
        #[prost(message, optional, tag = "3")]
        pub metadata: ::core::option::Option<super::ResponseMetadata>,
        #[prost(oneof = "get_identities_token_infos_response_v0::Result", tags = "1, 2")]
        pub result: ::core::option::Option<
            get_identities_token_infos_response_v0::Result,
        >,
    }
...
pub struct GetTokenDirectPurchasePricesResponse {
    ...
    pub version: ::core::option::Option<
        get_token_direct_purchase_prices_response::Version,
    >,
}
...
pub mod get_token_direct_purchase_prices_response {
    ...
    pub struct GetTokenDirectPurchasePricesResponseV0 {
        ...
        pub result: ::core::option::Option<
            get_token_direct_purchase_prices_response_v0::Result,
        >,
    }
    ...
    pub mod get_token_direct_purchase_prices_response_v0 {
        ...
        pub struct TokenDirectPurchasePriceEntry {
            ...
            #[prost(oneof = "token_direct_purchase_price_entry::Price", tags = "2, 3")]
            pub price: ::core::option::Option<token_direct_purchase_price_entry::Price>,
        }
        /// Nested message and enum types in `TokenDirectPurchasePriceEntry`.
        pub mod token_direct_purchase_price_entry {
            /// Price of the token; optional
            #[cfg_attr(
                feature = "serde",
                derive(::serde::Serialize, ::serde::Deserialize)
        ...
        pub struct TokenDirectPurchasePrices {
            #[prost(message, repeated, tag = "1")]
            pub token_direct_purchase_price: ::prost::alloc::vec::Vec<
...
pub struct GetTokenDirectPurchasePricesRequest {
    ...
    pub version: ::core::option::Option<
        get_token_direct_purchase_prices_request::Version,
    >,
}
...
pub struct GetTokenPreProgrammedDistributionsRequest {
    ...
    pub version: ::core::option::Option<
        get_token_pre_programmed_distributions_request::Version,
    >,
}
...
pub mod get_token_pre_programmed_distributions_request {
    ...
    pub struct GetTokenPreProgrammedDistributionsRequestV0 {
        ...
        pub token_id: ::prost::alloc::vec::Vec<u8>,
        #[prost(message, optional, tag = "2")]
        pub start_at_info: ::core::option::Option<
...
pub struct GetTokenPreProgrammedDistributionsResponse {
    ...
    pub version: ::core::option::Option<
        get_token_pre_programmed_distributions_response::Version,
    >,
}
...
pub mod get_token_pre_programmed_distributions_response {
    ...
    pub struct GetTokenPreProgrammedDistributionsResponseV0 {
        ...
        pub result: ::core::option::Option<
            get_token_pre_programmed_distributions_response_v0::Result,
        >,
    }
    ...
    pub mod get_token_pre_programmed_distributions_response_v0 {
        ...
        pub struct TokenDistributions {
            #[prost(message, repeated, tag = "1")]
            pub token_distributions: ::prost::alloc::vec::Vec<
...
pub struct GetTokenPerpetualDistributionLastClaimRequest {
    #[prost(
        oneof = "get_token_perpetual_distribution_last_claim_request::Version",
        tags = "1"
    )]
    pub version: ::core::option::Option<
...
/// Nested message and enum types in `GetTokenPerpetualDistributionLastClaimRequest`.
pub mod get_token_perpetual_distribution_last_claim_request {
    ...
    pub struct ContractTokenInfo {
        ...
        #[prost(uint32, tag = "2")]
        pub token_contract_position: u32,
    }
    #[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
    #[cfg_attr(feature = "serde", serde(rename_all = "snake_case"))]
    #[derive(::dapi_grpc_macros::Mockable)]
    ...
    pub enum Version {
        #[prost(message, tag = "1")]
        V0(GetTokenPerpetualDistributionLastClaimRequestV0),
    }
}
#[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "snake_case"))]
...
pub struct GetTokenPerpetualDistributionLastClaimResponse {
    #[prost(
        oneof = "get_token_perpetual_distribution_last_claim_response::Version",
        tags = "1"
    )]
    pub version: ::core::option::Option<
        get_token_perpetual_distribution_last_claim_response::Version,
    >,
}
/// Nested message and enum types in `GetTokenPerpetualDistributionLastClaimResponse`.
pub mod get_token_perpetual_distribution_last_claim_response {
    ...
    pub struct GetTokenPerpetualDistributionLastClaimResponseV0 {
        ...
        pub metadata: ::core::option::Option<super::ResponseMetadata>,
        #[prost(
            oneof = "get_token_perpetual_distribution_last_claim_response_v0::Result",
            tags = "1, 2"
        )]
        pub result: ::core::option::Option<
            get_token_perpetual_distribution_last_claim_response_v0::Result,
        >,
    }
    /// Nested message and enum types in `GetTokenPerpetualDistributionLastClaimResponseV0`.
    pub mod get_token_perpetual_distribution_last_claim_response_v0 {
        ...
        pub struct LastClaimInfo {
            ...
            pub paid_at: ::core::option::Option<last_claim_info::PaidAt>,
        }
        /// Nested message and enum types in `LastClaimInfo`.
        pub mod last_claim_info {
            #[cfg_attr(
                feature = "serde",
                derive(::serde::Serialize, ::serde::Deserialize)
            )]
    ...
    pub enum Version {
        #[prost(message, tag = "1")]
        V0(GetTokenPerpetualDistributionLastClaimResponseV0),
    }
}
#[cfg_attr(feature = "serde", derive(::serde::Serialize, ::serde::Deserialize))]
#[cfg_attr(feature = "serde", serde(rename_all = "snake_case"))]
...
pub mod get_group_infos_request {
    ...
    pub struct GetGroupInfosRequestV0 {
        ...
        pub contract_id: ::prost::alloc::vec::Vec<u8>,
        #[prost(message, optional, tag = "2")]
        pub start_at_group_contract_position: ::core::option::Option<
...
pub mod get_group_actions_response {
    ...
    pub mod get_group_actions_response_v0 {
        ...
        pub struct BurnEvent {
            ...
            #[prost(bytes = "vec", tag = "2")]
            pub burn_from_id: ::prost::alloc::vec::Vec<u8>,
            /// Public note
            #[prost(string, optional, tag = "3")]
            pub public_note: ::core::option::Option<::prost::alloc::string::String>,
        }
...
pub mod platform_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_identities_balances(
            ...
            tonic::Response<super::GetIdentitiesBalancesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_evonodes_proposed_epoch_blocks_by_ids(
            ...
            request: impl tonic::IntoRequest<
                super::GetEvonodesProposedEpochBlocksByIdsRequest,
            >,
        ) -> std::result::Result<
        ...
        pub async fn get_evonodes_proposed_epoch_blocks_by_range(
            &mut self,
            request: impl tonic::IntoRequest<
                super::GetEvonodesProposedEpochBlocksByRangeRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::GetEvonodesProposedEpochBlocksResponse>,
            tonic::Status,
        ...
        pub async fn get_identity_by_non_unique_public_key_hash(
            &mut self,
            request: impl tonic::IntoRequest<
                super::GetIdentityByNonUniquePublicKeyHashRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentityByNonUniquePublicKeyHashResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("org.dash.platform.dapi.v0.Platform", "getStatus"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_current_quorums_info(
            ...
            tonic::Response<super::GetCurrentQuorumsInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_identity_token_infos(
            ...
            tonic::Response<super::GetIdentityTokenInfosResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_token_statuses(
            ...
            tonic::Response<super::GetTokenStatusesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_token_pre_programmed_distributions(
            &mut self,
            request: impl tonic::IntoRequest<
                super::GetTokenPreProgrammedDistributionsRequest,
            >,
        ) -> std::result::Result<
        ...
        pub async fn get_token_perpetual_distribution_last_claim(
            &mut self,
            request: impl tonic::IntoRequest<
                super::GetTokenPerpetualDistributionLastClaimRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::GetTokenPerpetualDistributionLastClaimResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_token_total_supply(
            ...
            tonic::Response<super::GetTokenTotalSupplyResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_group_info(
            ...
            tonic::Response<super::GetGroupInfoResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("org.dash.platform.dapi.v0.Platform", "getGroupInfo"),
                );
            self.inner.unary(req, path, codec).await
        }
        pub async fn get_group_infos(
            ...
            tonic::Response<super::GetGroupInfosResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_group_actions(
            ...
            tonic::Response<super::GetGroupActionsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_group_action_signers(
            ...
            tonic::Response<super::GetGroupActionSignersResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod platform_server {
    ...
    pub trait Platform: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_identities_balances(
            &self,
            request: tonic::Request<super::GetIdentitiesBalancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentitiesBalancesResponse>,
            tonic::Status,
        >;
        ...
        async fn get_evonodes_proposed_epoch_blocks_by_ids(
            &self,
            request: tonic::Request<super::GetEvonodesProposedEpochBlocksByIdsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetEvonodesProposedEpochBlocksResponse>,
            tonic::Status,
        >;
        async fn get_evonodes_proposed_epoch_blocks_by_range(
            &self,
            request: tonic::Request<super::GetEvonodesProposedEpochBlocksByRangeRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetEvonodesProposedEpochBlocksResponse>,
            tonic::Status,
        >;
        ...
        async fn get_identity_by_non_unique_public_key_hash(
            &self,
            request: tonic::Request<super::GetIdentityByNonUniquePublicKeyHashRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentityByNonUniquePublicKeyHashResponse>,
            tonic::Status,
        >;
        ...
        async fn get_current_quorums_info(
            &self,
            request: tonic::Request<super::GetCurrentQuorumsInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetCurrentQuorumsInfoResponse>,
            tonic::Status,
        >;
        async fn get_identity_token_balances(
            &self,
            request: tonic::Request<super::GetIdentityTokenBalancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentityTokenBalancesResponse>,
            tonic::Status,
        >;
        async fn get_identities_token_balances(
            &self,
            request: tonic::Request<super::GetIdentitiesTokenBalancesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentitiesTokenBalancesResponse>,
            tonic::Status,
        >;
        async fn get_identity_token_infos(
            &self,
            request: tonic::Request<super::GetIdentityTokenInfosRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentityTokenInfosResponse>,
            tonic::Status,
        >;
        async fn get_identities_token_infos(
            &self,
            request: tonic::Request<super::GetIdentitiesTokenInfosRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetIdentitiesTokenInfosResponse>,
            tonic::Status,
        >;
        ...
        async fn get_token_perpetual_distribution_last_claim(
            &self,
            request: tonic::Request<super::GetTokenPerpetualDistributionLastClaimRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTokenPerpetualDistributionLastClaimResponse>,
            tonic::Status,
        >;
        async fn get_token_total_supply(
            &self,
            request: tonic::Request<super::GetTokenTotalSupplyRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetTokenTotalSupplyResponse>,
            tonic::Status,
        >;
        async fn get_group_info(
            &self,
            request: tonic::Request<super::GetGroupInfoRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetGroupInfoResponse>,
            tonic::Status,
        >;
        async fn get_group_infos(
            &self,
            request: tonic::Request<super::GetGroupInfosRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetGroupInfosResponse>,
            tonic::Status,
        >;
        async fn get_group_actions(
            &self,
            request: tonic::Request<super::GetGroupActionsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetGroupActionsResponse>,
            tonic::Status,
        >;
        async fn get_group_action_signers(
            &self,
            request: tonic::Request<super::GetGroupActionSignersRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetGroupActionSignersResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/org.dash.platform.dapi.v0.Platform/broadcastStateTransition" => {
                    ...
                    for broadcastStateTransitionSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Platform>::broadcast_state_transition(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentity" => {
                    ...
                    for getIdentitySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityKeys" => {
                    ...
                    for getIdentityKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_keys(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentitiesContractKeys" => {
                    ...
                    > for getIdentitiesContractKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identities_contract_keys(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityNonce" => {
                    ...
                    for getIdentityNonceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_nonce(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityContractNonce" => {
                    ...
                    for getIdentityContractNonceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_contract_nonce(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityBalance" => {
                    ...
                    for getIdentityBalanceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_balance(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentitiesBalances" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentitiesBalancesSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetIdentitiesBalancesRequest>
                    for getIdentitiesBalancesSvc<T> {
                        type Response = super::GetIdentitiesBalancesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identities_balances(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentitiesBalancesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityBalanceAndRevision" => {
                    ...
                    > for getIdentityBalanceAndRevisionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_balance_and_revision(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getEvonodesProposedEpochBlocksByIds" => {
                    #[allow(non_camel_case_types)]
                    struct getEvonodesProposedEpochBlocksByIdsSvc<T: Platform>(
                        pub Arc<T>,
                    );
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetEvonodesProposedEpochBlocksByIdsRequest,
                    > for getEvonodesProposedEpochBlocksByIdsSvc<T> {
                        type Response = super::GetEvonodesProposedEpochBlocksResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_evonodes_proposed_epoch_blocks_by_ids(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getEvonodesProposedEpochBlocksByIdsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getEvonodesProposedEpochBlocksByRange" => {
                    #[allow(non_camel_case_types)]
                    struct getEvonodesProposedEpochBlocksByRangeSvc<T: Platform>(
                        pub Arc<T>,
                    );
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetEvonodesProposedEpochBlocksByRangeRequest,
                    > for getEvonodesProposedEpochBlocksByRangeSvc<T> {
                        type Response = super::GetEvonodesProposedEpochBlocksResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_evonodes_proposed_epoch_blocks_by_range(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getEvonodesProposedEpochBlocksByRangeSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getDataContract" => {
                    ...
                    for getDataContractSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_data_contract(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getDataContractHistory" => {
                    ...
                    for getDataContractHistorySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_data_contract_history(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/org.dash.platform.dapi.v0.Platform/getDataContracts" => {
                    ...
                    for getDataContractsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_data_contracts(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getDocuments" => {
                    ...
                    for getDocumentsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_documents(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityByPublicKeyHash" => {
                    ...
                    > for getIdentityByPublicKeyHashSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_by_public_key_hash(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityByNonUniquePublicKeyHash" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentityByNonUniquePublicKeyHashSvc<T: Platform>(
                        pub Arc<T>,
                    );
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetIdentityByNonUniquePublicKeyHashRequest,
                    > for getIdentityByNonUniquePublicKeyHashSvc<T> {
                        type Response = super::GetIdentityByNonUniquePublicKeyHashResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_by_non_unique_public_key_hash(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentityByNonUniquePublicKeyHashSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/waitForStateTransitionResult" => {
                    ...
                    > for waitForStateTransitionResultSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::wait_for_state_transition_result(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getConsensusParams" => {
                    ...
                    for getConsensusParamsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_consensus_params(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getProtocolVersionUpgradeState" => {
                    ...
                    > for getProtocolVersionUpgradeStateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_protocol_version_upgrade_state(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getProtocolVersionUpgradeVoteStatus" => {
                    ...
                    > for getProtocolVersionUpgradeVoteStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_protocol_version_upgrade_vote_status(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getEpochsInfo" => {
                    ...
                    for getEpochsInfoSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_epochs_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getContestedResources" => {
                    ...
                    for getContestedResourcesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_contested_resources(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/org.dash.platform.dapi.v0.Platform/getContestedResourceVoteState" => {
                    ...
                    > for getContestedResourceVoteStateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_contested_resource_vote_state(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getContestedResourceVotersForIdentity" => {
                    ...
                    > for getContestedResourceVotersForIdentitySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_contested_resource_voters_for_identity(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getContestedResourceIdentityVotes" => {
                    ...
                    > for getContestedResourceIdentityVotesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_contested_resource_identity_votes(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getVotePollsByEndDate" => {
                    ...
                    for getVotePollsByEndDateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_vote_polls_by_end_date(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/org.dash.platform.dapi.v0.Platform/getPrefundedSpecializedBalance" => {
                    ...
                    > for getPrefundedSpecializedBalanceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_prefunded_specialized_balance(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getTotalCreditsInPlatform" => {
                    ...
                    > for getTotalCreditsInPlatformSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_total_credits_in_platform(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getPathElements" => {
                    ...
                    for getPathElementsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_path_elements(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getStatus" => {
                    #[allow(non_camel_case_types)]
                    struct getStatusSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    ...
                    for getStatusSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_status(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getCurrentQuorumsInfo" => {
                    #[allow(non_camel_case_types)]
                    struct getCurrentQuorumsInfoSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetCurrentQuorumsInfoRequest>
                    for getCurrentQuorumsInfoSvc<T> {
                        type Response = super::GetCurrentQuorumsInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_current_quorums_info(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getCurrentQuorumsInfoSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityTokenBalances" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentityTokenBalancesSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetIdentityTokenBalancesRequest>
                    for getIdentityTokenBalancesSvc<T> {
                        type Response = super::GetIdentityTokenBalancesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::GetIdentityTokenBalancesRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_token_balances(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentityTokenBalancesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentitiesTokenBalances" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentitiesTokenBalancesSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetIdentitiesTokenBalancesRequest,
                    > for getIdentitiesTokenBalancesSvc<T> {
                        type Response = super::GetIdentitiesTokenBalancesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identities_token_balances(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentitiesTokenBalancesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentityTokenInfos" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentityTokenInfosSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetIdentityTokenInfosRequest>
                    for getIdentityTokenInfosSvc<T> {
                        type Response = super::GetIdentityTokenInfosResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identity_token_infos(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentityTokenInfosSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getIdentitiesTokenInfos" => {
                    #[allow(non_camel_case_types)]
                    struct getIdentitiesTokenInfosSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetIdentitiesTokenInfosRequest>
                    for getIdentitiesTokenInfosSvc<T> {
                        type Response = super::GetIdentitiesTokenInfosResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::GetIdentitiesTokenInfosRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_identities_token_infos(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getIdentitiesTokenInfosSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getTokenStatuses" => {
                    #[allow(non_camel_case_types)]
                    struct getTokenStatusesSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetTokenStatusesRequest>
                    for getTokenStatusesSvc<T> {
                        type Response = super::GetTokenStatusesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_token_statuses(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getTokenStatusesSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getTokenDirectPurchasePrices" => {
                    ...
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetTokenDirectPurchasePricesRequest,
                    > for getTokenDirectPurchasePricesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_token_direct_purchase_prices(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/org.dash.platform.dapi.v0.Platform/getTokenPreProgrammedDistributions" => {
                    #[allow(non_camel_case_types)]
                    struct getTokenPreProgrammedDistributionsSvc<T: Platform>(
                        pub Arc<T>,
                    );
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetTokenPreProgrammedDistributionsRequest,
                    > for getTokenPreProgrammedDistributionsSvc<T> {
                        type Response = super::GetTokenPreProgrammedDistributionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_token_pre_programmed_distributions(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getTokenPreProgrammedDistributionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getTokenPerpetualDistributionLastClaim" => {
                    #[allow(non_camel_case_types)]
                    struct getTokenPerpetualDistributionLastClaimSvc<T: Platform>(
                        pub Arc<T>,
                    );
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<
                        super::GetTokenPerpetualDistributionLastClaimRequest,
                    > for getTokenPerpetualDistributionLastClaimSvc<T> {
                        type Response = super::GetTokenPerpetualDistributionLastClaimResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_token_perpetual_distribution_last_claim(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getTokenPerpetualDistributionLastClaimSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getTokenTotalSupply" => {
                    #[allow(non_camel_case_types)]
                    struct getTokenTotalSupplySvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetTokenTotalSupplyRequest>
                    for getTokenTotalSupplySvc<T> {
                        type Response = super::GetTokenTotalSupplyResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_token_total_supply(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getTokenTotalSupplySvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getGroupInfo" => {
                    #[allow(non_camel_case_types)]
                    struct getGroupInfoSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetGroupInfoRequest>
                    for getGroupInfoSvc<T> {
                        type Response = super::GetGroupInfoResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_group_info(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/org.dash.platform.dapi.v0.Platform/getGroupInfos" => {
                    #[allow(non_camel_case_types)]
                    struct getGroupInfosSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetGroupInfosRequest>
                    for getGroupInfosSvc<T> {
                        type Response = super::GetGroupInfosResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_group_infos(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getGroupInfosSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getGroupActions" => {
                    #[allow(non_camel_case_types)]
                    struct getGroupActionsSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetGroupActionsRequest>
                    for getGroupActionsSvc<T> {
                        type Response = super::GetGroupActionsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_group_actions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getGroupActionsSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/org.dash.platform.dapi.v0.Platform/getGroupActionSigners" => {
                    #[allow(non_camel_case_types)]
                    struct getGroupActionSignersSvc<T: Platform>(pub Arc<T>);
                    impl<
                        T: Platform,
                    > tonic::server::UnaryService<super::GetGroupActionSignersRequest>
                    for getGroupActionSignersSvc<T> {
                        type Response = super::GetGroupActionSignersResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Platform>::get_group_action_signers(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = getGroupActionSignersSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "org.dash.platform.dapi.v0.Platform";
