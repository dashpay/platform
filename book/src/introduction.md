...
The workspace currently targets Rust 1.92 and protocol version 14 (the 4.2
development line). The workspace `Cargo.toml` lists 47 member crates, but the
core platform logic lives in the first eight listed above.
