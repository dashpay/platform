...
- [Block Failure Classes](architecture/block-failure-classes.md)

# Versioning

- [Platform Version](versioning/platform-version.md)
- [Feature Versions](versioning/feature-versions.md)
- [Versioned Dispatch](versioning/versioned-dispatch.md)

# State Transitions

- [Lifecycle](state-transitions/lifecycle.md)
