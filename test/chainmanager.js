...
const getNewBlock = function (prev, bits) {
...
const getMerkleTestHeaders = function (startHeight) {
  // When available....
...
module.exports = {
  fetchHeaders(path = '/data/testchain.dat') {
