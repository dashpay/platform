...
* **release:** update changelog and bump version to 4.0.0-rc.2 ([#3864](https://github.com/dashpay/platform/issues/3864))
...
* **release:** update changelog and bump version to 4.0.0-rc.1 ([#3846](https://github.com/dashpay/platform/issues/3846))

## [4.0.0-beta.4](https://github.com/dashpay/platform/compare/v4.0.0-beta.3...v4.0.0-beta.4) (2026-06-09)
...
* add IdentityCreateFromShieldedPool state transition (shielded-pool-funded identity creation) ([#3816](https://github.com/dashpay/platform/issues/3816))
* **drive:** shielded fees for Shield/ShieldFromAssetLock + shield credit conservation ([#3793](https://github.com/dashpay/platform/issues/3793))
* **platform-wallet:** add platform-wallet-storage crate (sqlite persister) ([#3625](https://github.com/dashpay/platform/issues/3625))
* shielded scan-based spend detection and OVK outgoing-note history ([#3819](https://github.com/dashpay/platform/issues/3819))
* **swift-sdk:** iOS simluator writes logs to disk ([#3785](https://github.com/dashpay/platform/issues/3785))


### Bug Fixes

* **dpp:** return error instead of panicking on storage-fee refund div-by-zero ([#3799](https://github.com/dashpay/platform/issues/3799))
* **drive:** charge fees for unshield and shielded withdrawal ([#3800](https://github.com/dashpay/platform/issues/3800))
* **drive:** correct fee/credit accounting on the address-funding asset-lock penalty path ([#3818](https://github.com/dashpay/platform/issues/3818))
* **drive:** strict merged-query verification for unshield & shielded withdrawal proofs ([#3814](https://github.com/dashpay/platform/issues/3814))
* **drive:** unify shielded pool genesis/upgrade construction to prevent state divergence ([#3801](https://github.com/dashpay/platform/issues/3801))
* **platform-wallet:** zeroize private keys when freeing preview rows ([#3797](https://github.com/dashpay/platform/issues/3797))
* **rs-sdk-ffi:** shrink signature allocation to len before leaking (capacity UB) ([#3798](https://github.com/dashpay/platform/issues/3798))


### Miscellaneous Chores

* **release:** update changelog and bump version to 4.0.0-beta.4 ([#3822](https://github.com/dashpay/platform/issues/3822))
* tidy follow-ups from the shielded withdrawal fee review ([#3802](https://github.com/dashpay/platform/issues/3802))
...
* **release:** update changelog and bump version to 4.0.0-beta.3 ([#3795](https://github.com/dashpay/platform/issues/3795))
...
* **release:** update changelog and bump version to 4.0.0-beta.2 ([#3783](https://github.com/dashpay/platform/issues/3783))
...
* **release:** update changelog and bump version to 4.0.0-beta.1 ([#3779](https://github.com/dashpay/platform/issues/3779))
...
* **release:** update changelog and bump version to 3.1.0-dev.8 ([#3768](https://github.com/dashpay/platform/issues/3768))
...
* **release:** update changelog and bump version to 3.1.0-dev.7 ([#3760](https://github.com/dashpay/platform/issues/3760))

## [3.1.0-dev.6](https://github.com/dashpay/platform/compare/v3.1.0-dev.5...v3.1.0-dev.6) (2026-05-27)
...
* **release:** update changelog and bump version to 3.1.0-dev.6 ([#3746](https://github.com/dashpay/platform/issues/3746))
...
* **release:** update changelog and bump version to 3.1.0-dev.5 ([#3718](https://github.com/dashpay/platform/issues/3718))
...
* **release:** update changelog and bump version to 3.1.0-dev.4 ([#3710](https://github.com/dashpay/platform/issues/3710))
...
* **release:** drop redundant second Setup Node.JS in release-npm ([#3702](https://github.com/dashpay/platform/issues/3702))


### Miscellaneous Chores

* **release:** update changelog and bump version to 3.1.0-dev.3 ([#3708](https://github.com/dashpay/platform/issues/3708))
...
* **release:** update changelog and bump version to 3.1.0-dev.2 ([#3698](https://github.com/dashpay/platform/issues/3698))
...
* **release:** update changelog and bump version to 3.1.0-dev.1 ([#3097](https://github.com/dashpay/platform/issues/3097))
