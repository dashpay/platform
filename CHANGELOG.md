...
* **release:** update changelog and bump version to 0.23.0-dev.9 ([#520](https://github.com/dashevo/platform/issues/520))
...
* **release:** update changelog and version to 0.23.0-dev.8 ([#503](https://github.com/dashevo/platform/issues/503))
...
* **release:** update changelog and version to 0.23.0-dev.7 ([#495](https://github.com/dashevo/platform/issues/495))
...
* **release:** update changelog and bump version to 0.23.0-dev.6 ([#478](https://github.com/dashevo/platform/issues/478))
...
* **release:** update changelog and bump version to 0.23.0-dev.5 ([#473](https://github.com/dashevo/platform/issues/473))
...
* **release:** update changelog and version to 0.23.0-dev.4 ([#462](https://github.com/dashevo/platform/issues/462))
...
* disable SML payout addresses ([#443](https://github.com/dashevo/platform/issues/443))
...
* fix master to v0.23 merge issues
* **release:** update changelog and bump version to 0.23.0-dev.3 ([#454](https://github.com/dashevo/platform/issues/454))
* simplified public key to identity structure ([#437](https://github.com/dashevo/platform/issues/437))
* switch dashcore-lib to `payout-address` branch ([#412](https://github.com/dashevo/platform/issues/412))

## [0.23.0-dev.2](https://github.com/dashevo/platform/compare/v0.22.7...v0.23.0-dev.2) (2022-05-20)
...
* adds balance and metadata information from registered identity ([#337](https://github.com/dashevo/platform/issues/337))
...
* provide transaction history item as a date object ([#336](https://github.com/dashevo/platform/issues/336))
...
* **release:** update changelog and bump version to 0.23.0-dev.2 ([#399](https://github.com/dashevo/platform/issues/399))

## [0.23.0-dev.1](https://github.com/dashevo/platform/compare/v0.22.1...v0.23.0-dev.1) (2022-04-08)
...
### [0.22.16](https://github.com/dashevo/platform/compare/v0.23.0-dev.9...v0.22.16) (2022-09-09)
...
* **release:** update changelog and version to 0.22.16 ([#524](https://github.com/dashevo/platform/issues/524))
