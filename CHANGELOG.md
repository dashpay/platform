...
* **release:** update changelog and bump version to 4.1.0-beta.2 ([#4217](https://github.com/dashpay/platform/issues/4217))
...
* **release:** update changelog and bump version to 4.1.0-beta.1 ([#4210](https://github.com/dashpay/platform/issues/4210))
