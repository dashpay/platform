...
yarn dashmate config set --config=${CONFIG_NAME} platform.drive.abci.buildFromSource "true"
yarn dashmate config set --config=${CONFIG_NAME} platform.dapi.api.buildFromSource "true"
yarn dashmate config set --config=${CONFIG_NAME} platform.dapi.txFilterStream.buildFromSource "true"
yarn dashmate config set --config=${CONFIG_NAME} platform.dapi.envoy.buildFromSource "true"
yarn dashmate config set --config=${CONFIG_NAME} dashmate.helper.buildFromSource "true"
