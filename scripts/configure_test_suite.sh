...
DPNS_CONTRACT_OWNER_PRIVATE_KEY=$(yarn dashmate config get --config="${CONFIG}_1" platform.dpns.contract.ownerPrivateKey)
FEATURE_FLAGS_OWNER_PRIVATE_KEY=$(yarn dashmate config get --config="${CONFIG}_1" platform.featureFlags.contract.ownerPrivateKey)
...
DPNS_CONTRACT_OWNER_PRIVATE_KEY=${DPNS_CONTRACT_OWNER_PRIVATE_KEY}
FEATURE_FLAGS_CONTRACT_OWNER_PRIVATE_KEY=${FEATURE_FLAGS_OWNER_PRIVATE_KEY}
